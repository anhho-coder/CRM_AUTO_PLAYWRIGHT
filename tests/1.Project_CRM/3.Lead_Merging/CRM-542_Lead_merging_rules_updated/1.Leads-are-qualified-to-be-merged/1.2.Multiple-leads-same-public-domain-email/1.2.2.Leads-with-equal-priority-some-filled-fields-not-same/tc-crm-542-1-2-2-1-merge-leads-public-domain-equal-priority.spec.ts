...
/**
 * Lead Merging Test - Same Public Domain Email with Equal Priority
 * Test Case ID: CRM-542_1.2.2.1
 * 
...
test.describe('CRM-542_1.2.2.1 - Lead Merging: Same Public Domain Email with Equal Priority', () => {
  ...
  test('Verify merging lead happens successfully when leads from same public domain email with equal priority', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Trial download - equal priority)
    await test.step('Condition #1: Create Lead #1 with Trial download form', async () => {
      ...
      await leadPage.fillLeadForm('Trial download');
      console.log(`  - Lead Form: Trial download`);
    ...
    // CONDITION #2: Create Lead #2 (Download Free Trial - equal priority)
    await test.step('Condition #2: Create Lead #2 with Download Free Trial form', async () => {
      console.log('=== CREATING LEAD #2 (Download Free Trial - Equal Priority) ===');
    ...
    await test.step('Step 4: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      await test.step('Step 4.1: Verify Lead form textbox = Trial download', async () => {
        ...
        expect(leadFormValue).toBe('Trial download');
    ...
    await test.step('Final Summary', async () => {
      ...
      console.log(`   Lead #1: Active=TRUE, Is Won=Pending, Tags: Trial download`);
      console.log(`   Lead #2 (${lead2Id}): Download Free Trial (equal priority)`);
      ...
      console.log(`   Contact Name transferred from Lead #2 to Lead #1`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">✅</span>LEAD MERGING TEST - CRM-542_1.2.2.1</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Trial download (Equal Priority)</div>
    ...
    <div class="checkpoint">
      ...
      <div class="checkpoint-detail"><span class="label">Tags:</span> <span class="result-pass">✓ Trial download only (equal priority)</span></div>
      ...
      <div class="checkpoint-detail"><span class="label">CRM Developer:</span> <span class="result-pass">✓ Trial download, Active=TRUE, Is Won=Pending</span></div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        <strong>EQUAL PRIORITY:</strong> Trial download merged with Download Free Trial<br>
        <strong>Key Difference:</strong> Lead #2 keeps its own Company Name (not inherited)<br>
        Contact Name transferred from Lead #2 to Lead #1<br>
