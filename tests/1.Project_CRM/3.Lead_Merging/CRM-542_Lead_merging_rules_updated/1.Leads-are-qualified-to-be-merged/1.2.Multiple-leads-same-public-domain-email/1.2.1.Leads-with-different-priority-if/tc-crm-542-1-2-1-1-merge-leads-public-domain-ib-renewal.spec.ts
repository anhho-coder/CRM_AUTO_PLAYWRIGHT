 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-542_1.2.1.1" --project=chromium
 * 
 * Pre-condition:
...
test.describe('CRM-542_1.2.1.1 - Lead Merging: Same Public Domain Email with Different Priority (IB Renewal Lead) [FIXME: CRM-8929]', () => {
  ...
  test('Verify merging lead happens successfully when leads from same public domain email with different priority (IB renewal lead)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (IB NC Leads - high priority)
    await test.step('Condition #1: Create Lead #1 with IB NC Leads form', async () => {
      console.log('\n=== CREATING LEAD #1 (IB NC Leads - High Priority) ===');
    ...
    await test.step('Final Summary', async () => {
      ...
      console.log(`   Lead #1 (${lead1Id}): IB NC Leads (high priority)`);
      console.log(`   Lead #1: Active=TRUE, Is Won=Pending, Tags: Renewal, Trial download`);
      ...
      console.log(`   All 27 verification points passed`);
      console.log('==================================================\n');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">✅</span>LEAD MERGING TEST - CRM-542_1.2.1.1</h2>
    </div>
    
    <div class="lead-section">
      <div class="lead-title">📋 Lead #1 - IB NC Leads (Target Lead)</div>
      ...
      <div class="info-row"><span class="label">Lead Form:</span> IB NC Leads (High Priority)</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        IB NC Leads (high priority) merged with Download Free Trial (low priority)<br>
        <strong>Key Difference:</strong> Lead #2 keeps its own Company Name (not inherited)<br>
        All 27 verification points passed
      </div>
    </div>
  </div>
</body>
