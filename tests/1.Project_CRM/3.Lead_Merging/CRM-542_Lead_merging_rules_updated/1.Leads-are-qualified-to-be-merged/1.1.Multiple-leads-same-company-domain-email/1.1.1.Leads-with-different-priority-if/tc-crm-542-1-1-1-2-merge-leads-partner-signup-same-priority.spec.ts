...
test.describe('CRM-542_1.1.1.2 - Lead Merging: Same Company Domain Email with Different Priority (Partner Sign Up Lead)', () => {
  ...
  test('Verify merging lead happens successfully when leads from same company domain email with different priority (Partner sign up lead)', async ({ page }, testInfo) => {
    ...
    await test.step('Final Summary', async () => {
      ...
      console.log(`   Lead #1 (${lead1Id}): Partner Sign Up → IB NC Leads (merged)`);
      console.log(`   Lead #1: Active=TRUE, Is Won=Pending, Tags: Partner signup, Trial download`);
      console.log(`   Lead #2 (${lead2Id}): Download Free Trial`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">✅</span>LEAD MERGING TEST - CRM-542_1.1.1.2</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Initial Form:</span> Partner Sign Up</div>
      <div class="info-row"><span class="label">After Merge:</span> IB NC Leads</div>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Partner Sign Up lead (Lead #1) successfully merged with Download Free Trial lead (Lead #2)<br>
        Result: Lead #1 upgraded to IB NC Leads with combined tags<br>
