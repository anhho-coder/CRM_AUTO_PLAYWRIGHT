...
test.describe('CRM-542_3.1.1 - Lead Merging: Existing Merged Leads Verification', () => {
  ...
  test('Verify that Leads with Active = False, Is won = Pending, One of the messages contains "This lead has been merged into"', async ({ page }, testInfo) => {
