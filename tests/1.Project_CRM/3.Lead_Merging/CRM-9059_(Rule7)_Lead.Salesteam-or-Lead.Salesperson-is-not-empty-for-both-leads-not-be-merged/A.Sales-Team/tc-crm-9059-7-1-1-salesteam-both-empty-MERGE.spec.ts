...
/**
 * Lead Merging (Rule 7) - matrix ST-1: Sales Team + Salesperson EMPTY on both (MERGE)
...
test.describe('CRM-9059_7.1.1 - Lead Merging Rule 7: Sales Team + Salesperson empty on both (MERGE)', () => {
  ...
  test('CRM-9059_7.1.1: Verify leads MERGE with same company email and empty Sales Team + Salesperson', async ({ page }, testInfo) => {
