...
/**
 * Lead Merging (Rule 7) - matrix C-4: same Sales Team + same Salesperson on both (MERGE)
 ...
 * leads have the SAME Sales Team and SAME Salesperson (Rule 7 does not block - positive control).
...
test.describe('CRM-9059_7.3.4 - Lead Merging Rule 7: same Sales Team + same Salesperson on both (MERGE)', () => {
  ...
  test('CRM-9059_7.3.4: Verify leads MERGE with same company email, same Sales Team and same Salesperson on both', async ({ page }, testInfo) => {
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, no tag, Sales Team = BDEU, Salesperson = Thomas Semerich)
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging verified (same Sales Team + Salesperson - Rule 7 does not block)');
