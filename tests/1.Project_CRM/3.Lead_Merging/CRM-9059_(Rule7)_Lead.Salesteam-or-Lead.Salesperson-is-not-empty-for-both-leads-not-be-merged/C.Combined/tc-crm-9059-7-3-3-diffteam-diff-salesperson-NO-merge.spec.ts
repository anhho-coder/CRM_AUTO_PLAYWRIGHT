...
/**
 * Lead Merging (Rule 7) - matrix C-3: DIFFERENT non-empty Sales Team AND DIFFERENT non-empty Salesperson -> NO merge
 ...
 * lead has a DIFFERENT non-empty Sales Team (Lead#1 = BDEU, Lead#2 = CMR) and DIFFERENT non-empty Salesperson (Lead#1 = Thomas Semerich, Lead#2 = Mark Jawad).
 ...
 * different non-empty Sales Team and different non-empty Salesperson currently still merge). Un-skip once CRM-9059 is fixed.
 */

test.describe('CRM-9059_7.3.3 - Lead Merging Rule 7: different Sales Team, different Salesperson (NO merge)', () => {
  ...
  // SKIPPED due to known defect CRM-9059 (Rule 7 merge-guard broken - leads with different Sales Team and Salesperson still merge)
  test.skip('CRM-9059_7.3.3 [CRM-9059]: Verify leads do NOT merge with DIFFERENT Sales Team and DIFFERENT Salesperson', async ({ page }, testInfo) => {
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, no tag, Sales Team = CMR - DIFFERENT, Salesperson = Mark Jawad - DIFFERENT)
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Sales Team = CMR, Salesperson = Mark Jawad)', async () => {
      console.log('=== CONDITION #2: CREATING LEAD #2 (Created Manually = FALSE, Sales Team = CMR, Salesperson = Mark Jawad) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Leads did NOT merge (different Sales Team and Salesperson - Rule 7 blocks)');
      console.log(`   Lead #1 (${lead1Id}): Active=TRUE, Is Won=Pending, Sales Team=BDEU, Salesperson=Thomas Semerich`);
      console.log(`   Lead #2 (${lead2Id}): Active=TRUE, Is Won=Pending, Sales Team=CMR, Salesperson=Mark Jawad (NOT merged)`);
