...
/**
 * Opp Merging to Opp Test - IB Renewal Opp Created Later
 * Test Case ID: LeadMerging-Exploratory_3.1
 * 
...
test.describe('LeadMerging-Exploratory_3.1 - Opp Merging to Opp: IB Renewal Opp Created Later', () => {
  ...
  test('Verify merging opp to opp when target has IB renewal lead form but created later', async ({ page }, testInfo) => {
    ...
    const tcId = 'LeadMerging-Exploratory_3.1';
    ...
    await test.step('Step 1: Wait for 1 minute for Lead Merging happened', async () => {
      ...
      // Wait for lead merging to happen (stays at Target Opp page - Opp #2)
      // Using polling to check for merge notification
      let mergeNotificationFound = false;
      const maxAttempts = 6;
      const waitBetweenAttempts = 30000;
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        ...
        await page.waitForTimeout(CommonUtils.waitTimes.checkingChatterLog || 30000);
        ...
        if (hasMergeMessage) {
          console.log(`✓ Merge message found: "${opp1Name}, has been merged into this lead"`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">✅</span>OPP MERGING TO OPP TEST - LeadMerging-Exploratory_3.1</h2>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Opp merging to Opp with IB renewal opp created later verified successfully<br>
        Opp #1 merged into Opp #2<br>
