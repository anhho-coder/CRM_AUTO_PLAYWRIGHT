 ...
 * 
 * Command to run:
 * npx playwright test --grep "LeadMerging-Exploratory_1\.1 -" --project=chromium
 * 
 * Pre-condition:
...
test.describe('LeadMerging-Exploratory_1.1 - Lead Merging to Opp: IB Renewal Lead', () => {
  ...
  test('Verify merging lead to opp when same company domain with IB renewal lead', async ({ page }, testInfo) => {
    ...
    const tcId = 'LeadMerging-Exploratory_1.1';
    ...
    if (!mergeNotificationFound) {
      test.skip(true, mergeDeferSkipReason('LeadMerging-Exploratory_1.1'));
    }
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">✅</span>LEAD MERGING TO OPP TEST - LeadMerging-Exploratory_1.1</h2>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging to Opp with IB renewal lead verified successfully<br>
        Lead #2 merged into Opp #1<br>
...
`;
      ...
      await testInfo.attach('📋 Lead Merging to Opp - Test Summary', {
