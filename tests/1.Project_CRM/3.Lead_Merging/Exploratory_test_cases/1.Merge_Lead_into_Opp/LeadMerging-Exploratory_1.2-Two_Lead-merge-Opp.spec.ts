 ...
 * Test Case ID: LeadMerging-Exploratory_1.2
 * Automation-Type: refactored
 * Automation-Date: 2026-08-05
 *
 * Summary: Verify that the merging 2 lead to opp happens successfully when the lead from the same
...
test.describe('LeadMerging-Exploratory_1.2 - Two Leads Merging to Opp: IB Renewal Lead', () => {
  ...
  test('Verify merging 2 leads to opp when same company domain with IB renewal lead', async ({ page }, testInfo) => {
    ...
    const tcId = 'LeadMerging-Exploratory_1.2';
    ...
    if (!mergeNotificationFound) {
      test.skip(true, mergeDeferSkipReason('LeadMerging-Exploratory_1.2'));
    }
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">✅</span>TWO LEADS MERGING TO OPP TEST - LeadMerging-Exploratory_1.2</h2>
    </div>
    ...
    <div class="entity-section">
      <div class="entity-title">📋 Lead #2 - Source Lead (Merged)</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Two leads merging to Opp with IB renewal lead verified successfully<br>
        Lead #2 and Lead #3 merged into Opp #1<br>
