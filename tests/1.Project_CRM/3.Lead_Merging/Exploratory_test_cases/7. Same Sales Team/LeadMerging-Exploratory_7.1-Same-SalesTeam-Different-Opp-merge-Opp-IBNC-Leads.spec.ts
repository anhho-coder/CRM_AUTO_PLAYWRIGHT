 ...
 * 
 * Command to run:
 * npx playwright test --grep "LeadMerging-Exploratory_7\.1 -" --project=chromium
 * 
 * Pre-condition:
 ...
 *    - Salesperson dropdown list is "Thomas Semerich"
...
test.describe('LeadMerging-Exploratory_7.1 - Opp Merging to Opp: Same Sales Team Different Salesperson', () => {
  ...
  test('Verify merging lead when leads have same sales Team but different salesperson', async ({ page }, testInfo) => {
    ...
    const tcId = 'LeadMerging-Exploratory_7.1';
    ...
    await test.step('Condition #1: Create Opp#1 (Created Manually = FALSE, Lead Form = Download Free Trial)', async () => {
      ...
      // Set Salesperson to Thomas Semerich
    ...
    if (!mergeNotificationFound) {
      test.skip(true, mergeDeferSkipReason('LeadMerging-Exploratory_7.1'));
    }
