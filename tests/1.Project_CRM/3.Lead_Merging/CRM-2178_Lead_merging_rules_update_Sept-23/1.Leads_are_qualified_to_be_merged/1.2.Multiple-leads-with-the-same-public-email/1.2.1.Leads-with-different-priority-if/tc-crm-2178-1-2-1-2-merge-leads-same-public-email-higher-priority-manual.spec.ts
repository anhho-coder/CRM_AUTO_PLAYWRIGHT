 ...
 * Test Case ID: CRM-2178_1.2.1.2
 * 
 * Summary: Verify that the merging lead happens successfully when the leads with the same 
 * public email but different priority if a higher priority lead is created manually and has tag "can_merge"
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2178_1.2.1.2" --project=chromium
 * 
 * Pre-condition:
...
test.describe('CRM-2178_1.2.1.2 - Lead Merging: Same Public Email with Different Priority (Deal Registration)', () => {
  ...
  // FIXME: Test disabled due to bug CRM-8929
  test.skip('Verify merging leads with same public email and different priority', async ({ page }, testInfo) => {
