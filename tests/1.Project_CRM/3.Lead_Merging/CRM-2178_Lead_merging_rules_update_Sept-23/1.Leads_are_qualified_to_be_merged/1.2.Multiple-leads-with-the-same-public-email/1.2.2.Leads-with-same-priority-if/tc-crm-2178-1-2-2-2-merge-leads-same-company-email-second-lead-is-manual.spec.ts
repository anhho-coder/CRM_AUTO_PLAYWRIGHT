 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2178_1.2.2.2" --project=chromium
 * 
 * Pre-condition:
...
test.describe('CRM-2178_1.2.2.2 - Lead Merging: Same Public Email with Same Priority', () => {
