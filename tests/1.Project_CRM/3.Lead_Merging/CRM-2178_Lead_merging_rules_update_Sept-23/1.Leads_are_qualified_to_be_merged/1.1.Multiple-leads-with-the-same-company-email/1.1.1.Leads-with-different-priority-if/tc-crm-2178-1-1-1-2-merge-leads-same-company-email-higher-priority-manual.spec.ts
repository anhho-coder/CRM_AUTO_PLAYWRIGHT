 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2178_1.1.1.2" --project=chromium
 * 
 * Pre-condition:
...
test.describe('CRM-2178_1.1.1.2 - Lead Merging: Same Company Email with Different Priority', () => {
  ...
  test('Verify merging leads with same company email and different priority', async ({ page }, testInfo) => {
