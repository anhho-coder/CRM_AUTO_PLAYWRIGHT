...
/**
 * Lead Merging Test - Same Company Domain but Different Email (WITH Contact Created)
 * Test Case ID: CRM-2178_2.1.1.2
 * 
 ...
 * 
 * II. Condition#1 to create Lead#1:
 * 1. On "Leads" page, click at "CREATE" button
 * 2. Enter the following information:
 *    - Lead name textbox = TEST Lead 1 + current TC ID
 *    - Email textbox = Company email (with template Lead1@company + current date + current time + millisecond.com)
 ...
 * 
 * III. Condition#2 to create Lead#2:
 * 1. On "Leads" page, click at "CREATE" button
 * 2. Enter the following information:
...
test.describe('CRM-2178_2.1.1.2 - Lead Merging: Same Company Domain but Different Email WITH Contact (NO Merging)', () => {
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>NO LEAD MERGING TEST - PASSED (Contact Created First)</h2>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Contact and both leads share same email domain<br>
        Both leads have different emails from Contact<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb NO Lead Merging (Contact Created First) - Test Summary', {
