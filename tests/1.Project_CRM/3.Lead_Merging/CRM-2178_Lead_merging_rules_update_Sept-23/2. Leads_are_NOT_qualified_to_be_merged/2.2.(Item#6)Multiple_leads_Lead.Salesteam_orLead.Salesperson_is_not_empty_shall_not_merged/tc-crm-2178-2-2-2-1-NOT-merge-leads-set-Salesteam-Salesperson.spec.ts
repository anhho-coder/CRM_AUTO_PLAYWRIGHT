...
/**
 * Lead Merging Test - Different Sales Team and Salesperson
 * Test Case ID: CRM-2178_2.2.2.1
 * 
 * Summary: Verify that the merging lead will NOT happen when the leads having different 
 ...
 *    - Salesperson dropdown list is "Sergio Yalovik"
 ...
 *    3.6. Sales Team dropdown list has a value is "BDEU"
 ...
 *    2.6. Sales Team dropdown list has a value is "CMR"
...
test.describe('CRM-2178_2.2.2.1 - Lead Merging: Different Sales Team and Salesperson (NO Merging)', () => {
  ...
  test('Verify merging leads will NOT happen with different Sales Team and Salesperson', async ({ page }, testInfo) => {
    ...
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Lead Form = License)', async () => {
      ...
      // Set Salesperson to Sergio Yalovik
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.6: Verify Sales Team is BDEU
    ...
    await test.step('Step 6: Verify the following fields on Lead #2', async () => {
      ...
      // Step 6.6: Verify Sales Team is CMR
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: NO Lead merging verified - different Sales Team and Salesperson');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>NO LEAD MERGING TEST - PASSED (Different Sales Team & Salesperson)</h2>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead #1 Email: ${email1} | Sales Team: BDEU | Salesperson: Thomas Semerich<br>
        Lead #2 Email: ${email2} | Sales Team: CMR | Salesperson: Sergio Yalovik<br>
        Both leads have different Sales Team and Salesperson<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb NO Lead Merging (Different Sales Team & Salesperson) - Test Summary', {
