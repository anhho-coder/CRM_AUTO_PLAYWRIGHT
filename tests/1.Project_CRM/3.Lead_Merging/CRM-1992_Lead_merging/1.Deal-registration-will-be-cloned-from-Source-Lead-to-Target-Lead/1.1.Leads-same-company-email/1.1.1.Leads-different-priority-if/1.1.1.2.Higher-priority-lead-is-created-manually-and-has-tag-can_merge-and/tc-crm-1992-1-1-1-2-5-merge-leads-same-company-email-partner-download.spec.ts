...
test.describe('CRM-1992_1.1.1.2.5 - Lead Merging: Same Company Email with Deal Registration (Partner Download)', () => {
  ...
  test('CRM-1992_1.1.1.2.5 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, Partner Download)', async ({ page }, testInfo) => {
