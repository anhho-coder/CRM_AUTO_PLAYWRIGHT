...
test.describe('CRM-1992_1.1.1.2.4 - Lead Merging: Same Company Email with Deal Registration (Free NFR License)', () => {
  ...
  test('CRM-1992_1.1.1.2.4 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, Free NFR License)', async ({ page }, testInfo) => {
