...
test.describe('CRM-1992_1.1.1.2.3 - Lead Merging: Same Company Email with Deal Registration (VCP-DCV vSphere 7 Community Study Guide*)', () => {
  ...
  test('CRM-1992_1.1.1.2.3 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, VCP-DCV vSphere 7 Community Study Guide*)', async ({ page }, testInfo) => {
