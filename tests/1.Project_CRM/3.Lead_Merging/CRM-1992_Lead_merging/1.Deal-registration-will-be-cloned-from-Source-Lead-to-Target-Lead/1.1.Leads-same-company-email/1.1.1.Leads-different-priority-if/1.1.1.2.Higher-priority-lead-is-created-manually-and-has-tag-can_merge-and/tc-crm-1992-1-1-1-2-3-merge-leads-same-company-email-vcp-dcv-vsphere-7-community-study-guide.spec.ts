 ...
 * Test Case ID: CRM-1992_1.1.1.2.3
 * 
 ...
 * and the higher priority lead has Lead form = VCP-DCV vSphere 7 Community Study Guide*
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.2\.3 -" --project=chromium
 ...
 *    8.1. Lead form textbox = VCP-DCV vSphere 7 Community Study Guide*
...
test.describe('CRM-1992_1.1.1.2.3 - Lead Merging: Same Company Email with Deal Registration (VCP-DCV vSphere 7 Community Study Guide*)', () => {
  ...
  test.skip('CRM-1992_1.1.1.2.3 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, VCP-DCV vSphere 7 Community Study Guide*)', async ({ page }, testInfo) => {
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, Lead Form = VCP-DCV vSphere 7 Community Study Guide*, Deal Registration)
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Lead Form = VCP-DCV vSphere 7 Community Study Guide*, Deal Registration)', async () => {
      console.log('=== CONDITION #2: CREATING LEAD #2 (Created Manually = FALSE, Lead Form = VCP-DCV vSphere 7 Community Study Guide*, Deal Registration) ===');
      ...
      // Fill Lead Form = VCP-DCV vSphere 7 Community Study Guide*
      await leadPage.fillLeadForm('VCP-DCV vSphere 7 Community Study Guide*');
      console.log(`  - Lead Form: VCP-DCV vSphere 7 Community Study Guide*`);
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.1: Verify Tags contain "Can_Merge", "White paper" (2 values)
    ...
    await test.step('Step 8: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      // Step 8.1: Verify Lead form = VCP-DCV vSphere 7 Community Study Guide*
      await test.step('Step 8.1: Lead form textbox = VCP-DCV vSphere 7 Community Study Guide*', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('VCP-DCV vSphere 7 Community Study Guide*');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (VCP-DCV vSphere 7 Community Study Guide*) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (VCP-DCV vSphere 7 Community Study Guide*)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> VCP-DCV vSphere 7 Community Study Guide*</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (VCP-DCV vSphere 7 Community Study Guide*) verified successfully<br>
        Lead #2 (VCP-DCV vSphere 7 Community Study Guide*) merged into Lead #1 (Tag: Can_Merge)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (VCP-DCV vSphere 7 Community Study Guide*) - Test Summary', {
