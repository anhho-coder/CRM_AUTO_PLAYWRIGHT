 ...
 * Test Case ID: CRM-1992_1.1.1.2.9
 * 
 ...
 * and the higher priority lead has Lead form = Storage Certification
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.2\.9 -" --project=chromium
 ...
 * 3. Click at "CRM Developer" tab at the bottom of page
 *    - Lead form textbox = Storage Certification
 * 4. Press "SAVE" button
 ...
 *    8.1. Lead form textbox = Storage Certification
...
test.describe('CRM-1992_1.1.1.2.9 - Lead Merging: Same Company Email with Deal Registration (Storage Certification)', () => {
  ...
  test.skip('CRM-1992_1.1.1.2.9 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, Storage Certification)', async ({ page }, testInfo) => {
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, Lead Form = Storage Certification, Deal Registration)
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Lead Form = Storage Certification, Deal Registration)', async () => {
      console.log('=== CONDITION #2: CREATING LEAD #2 (Created Manually = FALSE, Lead Form = Storage Certification, Deal Registration) ===');
      ...
      // Fill Lead Form = Storage Certification
      await leadPage.fillLeadForm('Storage Certification');
      console.log(`  - Lead Form: Storage Certification`);
    ...
    await test.step('Step 8: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      // Step 8.1: Verify Lead form = Storage Certification
      await test.step('Step 8.1: Lead form textbox = Storage Certification', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('Storage Certification');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Storage Certification) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Storage Certification)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Storage Certification</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Storage Certification) verified successfully<br>
        Lead #2 (Storage Certification) merged into Lead #1 (Tag: Can_Merge)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Storage Certification) - Test Summary', {
