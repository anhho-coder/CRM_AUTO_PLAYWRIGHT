...
test.describe('CRM-1992_1.1.1.2.9 - Lead Merging: Same Company Email with Deal Registration (Storage Certification)', () => {
  ...
  test('CRM-1992_1.1.1.2.9 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, Storage Certification)', async ({ page }, testInfo) => {
