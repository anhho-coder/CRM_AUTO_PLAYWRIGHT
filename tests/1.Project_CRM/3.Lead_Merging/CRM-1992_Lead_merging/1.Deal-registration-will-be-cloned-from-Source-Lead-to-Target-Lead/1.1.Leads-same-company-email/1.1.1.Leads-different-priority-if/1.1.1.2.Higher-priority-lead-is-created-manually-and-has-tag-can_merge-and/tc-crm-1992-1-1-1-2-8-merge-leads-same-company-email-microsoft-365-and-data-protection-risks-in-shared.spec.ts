 ...
 * Test Case ID: CRM-1992_1.1.1.2.8
 * 
 * Summary: Verify that the merging lead happens successfully when the leads with the same 
 * company email but different priority if a higher priority lead is created manually and has tag "can_merge" 
 * and the higher priority lead has Lead form = Microsoft 365 and Data Protection Risks in Shared
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.2\.8 -" --project=chromium
 ...
 * 3. Click at "CRM Developer" tab at the bottom of page
 *    - Lead form textbox = Microsoft 365 and Data Protection Risks in Shared
 * 4. Press "SAVE" button
 ...
 *    3.1. Tag field contains 2 values: "Can_Merge", "White paper"
 ...
 *    7.1. Tag field contains "White paper"
 ...
 *    8.1. Lead form textbox = Microsoft 365 and Data Protection Risks in Shared
...
test.describe('CRM-1992_1.1.1.2.8 - Lead Merging: Same Company Email with Deal Registration (Microsoft 365 and Data Protection Risks in Shared)', () => {
  ...
  test.skip('CRM-1992_1.1.1.2.8 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, Microsoft 365 and Data Protection Risks in Shared)', async ({ page }, testInfo) => {
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, Lead Form = Microsoft 365 and Data Protection Risks in Shared, Deal Registration)
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Lead Form = Microsoft 365 and Data Protection Risks in Shared, Deal Registration)', async () => {
      console.log('=== CONDITION #2: CREATING LEAD #2 (Created Manually = FALSE, Lead Form = Microsoft 365 and Data Protection Risks in Shared, Deal Registration) ===');
      ...
      // Fill Lead Form = Microsoft 365 and Data Protection Risks in Shared
      await leadPage.fillLeadForm('Microsoft 365 and Data Protection Risks in Shared');
      console.log(`  - Lead Form: Microsoft 365 and Data Protection Risks in Shared`);
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.1: Verify Tags contain "Can_Merge" and "White paper" (2 values)
      await test.step('Step 3.1: Tag field contains 2 values: "Can_Merge", "White paper"', async () => {
        const tagsText = await leadPage.getTagsText();
        
        expect(tagsText).toContain('Can_Merge');
        expect(tagsText).toContain('White paper');
        console.log(`  ✓ Step 3.1: Tags contain "Can_Merge" and "White paper" (2 values)`);
      });
    ...
    await test.step('Step 7: Verify the following fields on Lead #2', async () => {
      ...
      // Step 7.1: Verify Tags field contains "White paper"
      await test.step('Step 7.1: Tag field contains "White paper"', async () => {
        const tagsText = await leadPage.getTagsText();
        
        expect(tagsText).toContain('White paper');
        console.log(`  ✓ Step 7.1: Tags contain "White paper"`);
      });
    ...
    await test.step('Step 8: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      // Step 8.1: Verify Lead form = Microsoft 365 and Data Protection Risks in Shared
      await test.step('Step 8.1: Lead form textbox = Microsoft 365 and Data Protection Risks in Shared', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('Microsoft 365 and Data Protection Risks in Shared');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Microsoft 365 and Data Protection Risks in Shared) verified successfully');
      console.log(`   Lead #1 (${lead1Id}): Active=TRUE, Is Won=Pending, Tags: Can_Merge, White paper (2 values)`);
      console.log(`   - Created Manually: TRUE`);
      console.log(`   - Lead Form: BLANK`);
      console.log(`   - Deal Registration: TRUE (cloned from Lead#2)`);
      console.log(`   Lead #2 (${lead2Id}): Active=FALSE, Is Won=Lost, Lost Reason=Duplicate, Tags: White paper`);
      console.log(`   - Created Manually: FALSE`);
      console.log(`   - Lead Form: Microsoft 365 and Data Protection Risks in Shared`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Microsoft 365 and Data Protection Risks in Shared)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Tags:</span> Can_Merge, White paper (2 values)</div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Email:</span> ${sharedEmail}</div>
      <div class="info-row"><span class="label">Tags:</span> White paper</div>
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Microsoft 365 and Data Protection Risks in Shared</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Microsoft 365 and Data Protection Risks in Shared) verified successfully<br>
        Lead #2 (Microsoft 365 and Data Protection Risks in Shared) merged into Lead #1 (Tag: Can_Merge)<br>
        "White paper" tag transferred from Lead #2 to Lead #1<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Microsoft 365 and Data Protection Risks in Shared) - Test Summary', {
