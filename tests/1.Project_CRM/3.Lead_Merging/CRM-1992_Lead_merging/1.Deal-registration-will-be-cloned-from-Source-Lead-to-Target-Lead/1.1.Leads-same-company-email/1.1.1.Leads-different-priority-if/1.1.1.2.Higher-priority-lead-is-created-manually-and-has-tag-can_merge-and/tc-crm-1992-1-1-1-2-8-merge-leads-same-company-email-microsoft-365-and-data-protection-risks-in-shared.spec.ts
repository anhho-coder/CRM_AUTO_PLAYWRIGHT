...
test.describe('CRM-1992_1.1.1.2.8 - Lead Merging: Same Company Email with Deal Registration (Microsoft 365 and Data Protection Risks in Shared)', () => {
  ...
  test('CRM-1992_1.1.1.2.8 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, Microsoft 365 and Data Protection Risks in Shared)', async ({ page }, testInfo) => {
