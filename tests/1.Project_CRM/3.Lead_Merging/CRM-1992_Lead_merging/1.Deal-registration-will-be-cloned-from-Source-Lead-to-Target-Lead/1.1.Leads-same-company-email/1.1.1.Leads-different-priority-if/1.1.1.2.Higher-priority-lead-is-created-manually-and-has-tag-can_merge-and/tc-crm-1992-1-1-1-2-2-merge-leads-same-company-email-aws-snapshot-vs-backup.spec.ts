...
test.describe('CRM-1992_1.1.1.2.2 - Lead Merging: Same Company Email with Deal Registration (AWS Snapshot vs. Backup)', () => {
  ...
  test('CRM-1992_1.1.1.2.2 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, AWS Snapshot vs. Backup)', async ({ page }, testInfo) => {
