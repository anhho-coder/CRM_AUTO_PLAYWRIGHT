...
test.describe('CRM-1992_1.1.1.2.7 - Lead Merging: Same Company Email with Deal Registration (VCP6.7-DCV Study Guide)', () => {
  ...
  test('CRM-1992_1.1.1.2.7 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, VCP6.7-DCV Study Guide)', async ({ page }, testInfo) => {
