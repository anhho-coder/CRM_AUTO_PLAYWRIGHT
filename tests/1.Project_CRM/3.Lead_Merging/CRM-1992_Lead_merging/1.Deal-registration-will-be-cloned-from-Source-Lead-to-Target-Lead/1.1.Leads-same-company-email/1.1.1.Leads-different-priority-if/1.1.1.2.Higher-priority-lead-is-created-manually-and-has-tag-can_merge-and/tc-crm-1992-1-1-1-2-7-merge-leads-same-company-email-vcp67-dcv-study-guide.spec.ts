 ...
 * Test Case ID: CRM-1992_1.1.1.2.7
 * 
 ...
 * and the higher priority lead has Lead form = VCP6.7-DCV Study Guide
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.2\.7 -" --project=chromium
 ...
 * 3. Click at "CRM Developer" tab at the bottom of page
 *    - Lead form textbox = VCP6.7-DCV Study Guide
 * 4. Press "SAVE" button
 ...
 *    8.1. Lead form textbox = VCP6.7-DCV Study Guide
...
test.describe('CRM-1992_1.1.1.2.7 - Lead Merging: Same Company Email with Deal Registration (VCP6.7-DCV Study Guide)', () => {
  ...
  test.skip('CRM-1992_1.1.1.2.7 [CRM-10787]: Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, VCP6.7-DCV Study Guide)', async ({ page }, testInfo) => {
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, Lead Form = VCP6.7-DCV Study Guide, Deal Registration)
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Lead Form = VCP6.7-DCV Study Guide, Deal Registration)', async () => {
      console.log('=== CONDITION #2: CREATING LEAD #2 (Created Manually = FALSE, Lead Form = VCP6.7-DCV Study Guide, Deal Registration) ===');
      ...
      // Fill Lead Form = VCP6.7-DCV Study Guide
      await leadPage.fillLeadForm('VCP6.7-DCV Study Guide');
      console.log(`  - Lead Form: VCP6.7-DCV Study Guide`);
    ...
    await test.step('Step 8: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      // Step 8.1: Verify Lead form = VCP6.7-DCV Study Guide
      await test.step('Step 8.1: Lead form textbox = VCP6.7-DCV Study Guide', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('VCP6.7-DCV Study Guide');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (VCP6.7-DCV Study Guide) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (VCP6.7-DCV Study Guide)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> VCP6.7-DCV Study Guide</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (VCP6.7-DCV Study Guide) verified successfully<br>
        Lead #2 (VCP6.7-DCV Study Guide) merged into Lead #1 (Tag: Can_Merge)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (VCP6.7-DCV Study Guide) - Test Summary', {
