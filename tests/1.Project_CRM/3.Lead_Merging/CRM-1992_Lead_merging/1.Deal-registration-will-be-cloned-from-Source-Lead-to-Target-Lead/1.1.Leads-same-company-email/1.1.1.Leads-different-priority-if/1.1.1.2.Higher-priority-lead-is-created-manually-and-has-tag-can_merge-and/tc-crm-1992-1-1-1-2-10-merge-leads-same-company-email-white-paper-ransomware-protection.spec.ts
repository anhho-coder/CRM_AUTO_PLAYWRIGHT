 ...
 * Test Case ID: CRM-1992_1.1.1.2.10
 * 
 ...
 * and the higher priority lead has Lead form = WHITE PAPER: Ransomware Protection
 * 
 * Command to run:
 ...
 * 3. Click at "CRM Developer" tab at the bottom of page
 *    - Lead form textbox = WHITE PAPER: Ransomware Protection
 * 4. Press "SAVE" button
 ...
 *    8.1. Lead form textbox = WHITE PAPER: Ransomware Protection
...
test.describe('CRM-1992_1.1.1.2.10 - Lead Merging: Same Company Email with Deal Registration (WHITE PAPER: Ransomware Protection)', () => {
  ...
  test('Verify merging leads with same company email (Created Manually = TRUE, Tag = Can_Merge, WHITE PAPER: Ransomware Protection)', async ({ page }, testInfo) => {
    ...
    const tcId = 'CRM-1992_1.1.1.2.10';
    ...
    // CONDITION #2: Create Lead #2 (Created Manually = FALSE, Lead Form = WHITE PAPER: Ransomware Protection, Deal Registration)
    await test.step('Condition #2: Create Lead #2 (Created Manually = FALSE, Lead Form = WHITE PAPER: Ransomware Protection, Deal Registration)', async () => {
      console.log('=== CONDITION #2: CREATING LEAD #2 (Created Manually = FALSE, Lead Form = WHITE PAPER: Ransomware Protection, Deal Registration) ===');
      ...
      // Fill Lead Form = WHITE PAPER: Ransomware Protection
      await leadPage.fillLeadForm('WHITE PAPER: Ransomware Protection');
      console.log(`  - Lead Form: WHITE PAPER: Ransomware Protection`);
    ...
    await test.step('Step 8: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      // Step 8.1: Verify Lead form = WHITE PAPER: Ransomware Protection
      await test.step('Step 8.1: Lead form textbox = WHITE PAPER: Ransomware Protection', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('WHITE PAPER: Ransomware Protection');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (WHITE PAPER: Ransomware Protection) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (WHITE PAPER: Ransomware Protection)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> WHITE PAPER: Ransomware Protection</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (WHITE PAPER: Ransomware Protection) verified successfully<br>
        Lead #2 (WHITE PAPER: Ransomware Protection) merged into Lead #1 (Tag: Can_Merge)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (WHITE PAPER: Ransomware Protection) - Test Summary', {
