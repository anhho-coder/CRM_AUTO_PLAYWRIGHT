 ...
 * Test Case ID: CRM-1992_1.1.1.1.9
 * 
 ...
 * and the higher priority lead has Lead form = Contact Us
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.9 -" --project=chromium
 ...
 *    4.1. Lead form textbox = Contact Us
...
test.describe('CRM-1992_1.1.1.1.9 - Lead Merging: Same Company Email with Deal Registration (Contact Us)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.9 [CRM-10787]: Verify merging leads with same company email (Contact Us, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, Contact Us)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, Contact Us)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, Contact Us) ===');
      ...
      // Fill Lead Form = Contact Us
      await leadPage.fillLeadForm('Contact Us');
      console.log(`  - Lead Form: Contact Us`);
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.1: Verify Tags contain only "Can_Merge" (Contact Us does not add additional tag)
      await test.step('Step 3.1: Tag field contains 1 value: "Can_Merge"', async () => {
        ...
        console.log(`  ✓ Step 3.1: Tags contain "Can_Merge" only`);
      });
    ...
    await test.step('Step 4: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      await test.step('Step 4.1: Lead form textbox = Contact Us', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('Contact Us');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Contact Us) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Contact Us)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Contact Us</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Contact Us) verified successfully<br>
        Lead #2 (Deal Registration) merged into Lead #1 (Contact Us)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Contact Us) - Test Summary', {
