...
test.describe('CRM-1992_1.1.1.1.8 - Lead Merging: Same Company Email with Deal Registration (Trial from Free version)', () => {
  ...
  test('CRM-1992_1.1.1.1.8 [CRM-10787]: Verify merging leads with same company email (Trial from Free version, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
