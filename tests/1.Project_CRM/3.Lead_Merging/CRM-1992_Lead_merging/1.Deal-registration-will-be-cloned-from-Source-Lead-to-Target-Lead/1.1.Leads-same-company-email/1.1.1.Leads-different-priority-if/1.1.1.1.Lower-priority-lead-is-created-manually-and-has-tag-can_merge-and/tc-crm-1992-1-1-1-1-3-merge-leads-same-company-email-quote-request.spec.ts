 ...
 * Test Case ID: CRM-1992_1.1.1.1.3
 * 
 ...
 * and the higher priority lead has Lead form = Quote Request 24/7*
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.3 -" --project=chromium
 ...
 *    - Lead form textbox = Quote Request 24/7*
 * 4. Press "SAVE" button
 ...
 *    3.1. Tag field contains 2 values: "Can_Merge", "Quote request"
 ...
 *    4.1. Lead form textbox = Quote Request 24/7*
...
test.describe('CRM-1992_1.1.1.1.3 - Lead Merging: Same Company Email with Deal Registration (Quote Request 24/7*)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.3 [CRM-10787]: Verify merging leads with same company email (Quote Request 24/7*, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, Quote Request 24/7*)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, Quote Request 24/7*)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, Quote Request 24/7*) ===');
      ...
      // Fill Lead Form = Quote Request 24/7*
      await leadPage.fillLeadForm('Quote Request 24/7*');
      console.log(`  - Lead Form: Quote Request 24/7*`);
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.1: Verify Tags contain "Can_Merge", "Quote request"
      await test.step('Step 3.1: Tag field contains "Can_Merge", "Quote request"', async () => {
        const tagsText = await leadPage.getTagsText();
        
        expect(tagsText).toContain('Can_Merge');
        expect(tagsText).toContain('Quote request');
        console.log(`  ✓ Step 3.1: Tags contain "Can_Merge" and "Quote request"`);
      });
    ...
    await test.step('Step 4: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      await test.step('Step 4.1: Lead form textbox = Quote Request 24/7*', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('Quote Request 24/7*');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Quote Request 24/7*) verified successfully');
      console.log(`   Lead #1 (${lead1Id}): Active=TRUE, Is Won=Pending, Tags: Can_Merge, Quote request`);
      console.log(`   - Created Manually: FALSE`);
      console.log(`   - Lead Form: Quote Request 24/7*`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Quote Request 24/7*)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Tags:</span> Can_Merge, Quote request</div>
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Quote Request 24/7*</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Quote Request 24/7*) verified successfully<br>
        Lead #2 (Deal Registration) merged into Lead #1 (Quote Request 24/7*)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Quote Request 24/7*) - Test Summary', {
