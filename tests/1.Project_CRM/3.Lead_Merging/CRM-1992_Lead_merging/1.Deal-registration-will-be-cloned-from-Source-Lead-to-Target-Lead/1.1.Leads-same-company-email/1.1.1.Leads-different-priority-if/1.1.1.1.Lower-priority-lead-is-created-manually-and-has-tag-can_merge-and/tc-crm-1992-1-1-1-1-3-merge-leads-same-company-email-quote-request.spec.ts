...
test.describe('CRM-1992_1.1.1.1.3 - Lead Merging: Same Company Email with Deal Registration (Quote Request 24/7*)', () => {
  ...
  test('CRM-1992_1.1.1.1.3 [CRM-10787]: Verify merging leads with same company email (Quote Request 24/7*, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
