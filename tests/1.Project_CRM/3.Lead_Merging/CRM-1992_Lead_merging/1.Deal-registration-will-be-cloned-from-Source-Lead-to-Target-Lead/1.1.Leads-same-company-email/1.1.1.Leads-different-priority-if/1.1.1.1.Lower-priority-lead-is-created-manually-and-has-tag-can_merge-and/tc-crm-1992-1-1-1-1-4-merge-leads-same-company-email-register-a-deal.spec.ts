...
test.describe('CRM-1992_1.1.1.1.4 - Lead Merging: Same Company Email with Deal Registration (Register a Deal)', () => {
  ...
  test('CRM-1992_1.1.1.1.4 [CRM-10787]: Verify merging leads with same company email (Register a Deal, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
