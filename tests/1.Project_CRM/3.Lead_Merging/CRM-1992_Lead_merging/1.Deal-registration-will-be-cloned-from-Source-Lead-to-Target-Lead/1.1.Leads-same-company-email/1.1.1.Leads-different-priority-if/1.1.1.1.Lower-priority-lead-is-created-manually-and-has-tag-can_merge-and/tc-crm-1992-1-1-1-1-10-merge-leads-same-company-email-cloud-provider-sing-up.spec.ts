...
test.describe('CRM-1992_1.1.1.1.10 - Lead Merging: Same Company Email with Deal Registration (Cloud Provider Sing Up)', () => {
  ...
  test('CRM-1992_1.1.1.1.10 [CRM-10787]: Verify merging leads with same company email (Cloud Provider Sing Up, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
