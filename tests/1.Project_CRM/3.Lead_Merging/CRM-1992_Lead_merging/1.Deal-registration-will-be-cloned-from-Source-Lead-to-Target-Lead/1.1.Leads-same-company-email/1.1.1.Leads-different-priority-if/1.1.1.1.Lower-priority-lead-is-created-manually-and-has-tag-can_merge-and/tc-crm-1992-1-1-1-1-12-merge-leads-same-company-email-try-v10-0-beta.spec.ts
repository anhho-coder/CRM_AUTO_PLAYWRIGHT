...
test.describe('CRM-1992_1.1.1.1.12 - Lead Merging: Same Company Email with Deal Registration (Try v10.0 Beta)', () => {
  ...
  test('CRM-1992_1.1.1.1.12 [CRM-10787]: Verify merging leads with same company email (Try v10.0 Beta, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
