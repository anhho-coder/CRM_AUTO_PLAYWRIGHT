 ...
 * Test Case ID: CRM-1992_1.1.1.1.12
 * 
 ...
 * and the higher priority lead has Lead form = Try v10.0 Beta
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.12 -" --project=chromium
 ...
 *    - Lead form textbox = Try v10.0 Beta
 * 4. Press "SAVE" button
 ...
 *    3.1. Tag field contains 2 values: "Can_Merge", "Beta download"
 ...
 *    4.1. Lead form textbox = Try v10.0 Beta
...
test.describe('CRM-1992_1.1.1.1.12 - Lead Merging: Same Company Email with Deal Registration (Try v10.0 Beta)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.12 [CRM-10787]: Verify merging leads with same company email (Try v10.0 Beta, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    const tcId = 'CRM-1992_1.1.1.1.12';
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, Try v10.0 Beta)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, Try v10.0 Beta)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, Try v10.0 Beta) ===');
      ...
      // Fill Lead Form = Try v10.0 Beta
      await leadPage.fillLeadForm('Try v10.0 Beta');
      console.log(`  - Lead Form: Try v10.0 Beta`);
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.1: Verify Tags contain "Can_Merge", "Beta download"
      await test.step('Step 3.1: Tag field contains "Can_Merge", "Beta download"', async () => {
        const tagsText = await leadPage.getTagsText();
        
        expect(tagsText).toContain('Can_Merge');
        expect(tagsText).toContain('Beta download');
        console.log(`  ✓ Step 3.1: Tags contain "Can_Merge" and "Beta download"`);
      });
    ...
    await test.step('Step 4: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      await test.step('Step 4.1: Lead form textbox = Try v10.0 Beta', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('Try v10.0 Beta');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Try v10.0 Beta) verified successfully');
      console.log(`   Lead #1 (${lead1Id}): Active=TRUE, Is Won=Pending, Tags: Can_Merge, Beta download`);
      console.log(`   - Created Manually: FALSE`);
      console.log(`   - Lead Form: Try v10.0 Beta`);
      console.log(`   - Deal Registration: TRUE (configured on Lead#1)`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Try v10.0 Beta)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Tags:</span> Can_Merge, Beta download</div>
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Try v10.0 Beta</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Try v10.0 Beta) verified successfully<br>
        Lead #2 (Deal Registration) merged into Lead #1 (Try v10.0 Beta)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Try v10.0 Beta) - Test Summary', {
