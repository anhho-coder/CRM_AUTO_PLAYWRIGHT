 ...
 * Test Case ID: CRM-1992_1.1.1.1.6
 * 
 ...
 * and the higher priority lead has Lead form = Partner Sign Up %
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.6 -" --project=chromium
...
test.describe('CRM-1992_1.1.1.1.6 - Lead Merging: Same Company Email with Deal Registration (Partner Sign Up %)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.6 [CRM-10787]: Verify merging leads with same company email (Partner Sign Up %, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, Partner Sign Up %)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, Partner Sign Up %)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, Partner Sign Up %) ===');
    ...
    await test.step('Step 4: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      await test.step('Step 4.1: Lead form textbox = Partner Sign Up %', async () => {
        const leadForm = await leadPage.getLeadFormValue();
        
        expect(leadForm).toBe('Partner Sign Up %');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Partner Sign Up %) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Partner Sign Up %)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Partner Sign Up %</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Partner Sign Up %) verified successfully<br>
        Lead #2 (Deal Registration) merged into Lead #1 (Partner Sign Up %)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Partner Sign Up %) - Test Summary', {
