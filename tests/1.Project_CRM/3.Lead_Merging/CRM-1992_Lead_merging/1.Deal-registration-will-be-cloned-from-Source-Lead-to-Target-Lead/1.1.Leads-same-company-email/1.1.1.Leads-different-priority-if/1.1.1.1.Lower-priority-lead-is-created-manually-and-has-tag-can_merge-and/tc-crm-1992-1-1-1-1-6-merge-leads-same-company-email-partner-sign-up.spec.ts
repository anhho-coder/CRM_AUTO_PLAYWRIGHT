...
test.describe('CRM-1992_1.1.1.1.6 - Lead Merging: Same Company Email with Deal Registration (Partner Sign Up %)', () => {
  ...
  test('CRM-1992_1.1.1.1.6 [CRM-10787]: Verify merging leads with same company email (Partner Sign Up %, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
