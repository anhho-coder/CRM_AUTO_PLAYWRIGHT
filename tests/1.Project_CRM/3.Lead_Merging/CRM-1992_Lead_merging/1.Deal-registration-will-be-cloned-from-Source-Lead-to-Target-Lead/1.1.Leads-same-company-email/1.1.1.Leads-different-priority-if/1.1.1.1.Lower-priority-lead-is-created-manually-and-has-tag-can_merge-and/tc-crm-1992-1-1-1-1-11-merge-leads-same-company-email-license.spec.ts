 ...
 * Test Case ID: CRM-1992_1.1.1.1.11
 * 
 ...
 * and the higher priority lead has Lead form = License
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.11 -" --project=chromium
...
test.describe('CRM-1992_1.1.1.1.11 - Lead Merging: Same Company Email with Deal Registration (License)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.11 [CRM-10787]: Verify merging leads with same company email (License, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    const tcId = 'CRM-1992_1.1.1.1.11';
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, License)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, License)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, License) ===');
    ...
    await test.step('Final Summary', async () => {
      ...
      console.log(`   Lead #1 (${lead1Id}): Active=TRUE, Is Won=Pending, Tags: Can_Merge, Product registration`);
      console.log(`   - Created Manually: FALSE`);
      console.log(`   - Lead Form: License`);
...
<body>
  <div class="container">
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Tags:</span> Can_Merge, Product registration</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead #2 (Deal Registration) merged into Lead #1 (License)<br>
