...
test.describe('CRM-1992_1.1.1.1.7 - Lead Merging: Same Company Email with Deal Registration (Register a deal)', () => {
  ...
  test('CRM-1992_1.1.1.1.7 [CRM-10787]: Verify merging leads with same company email (Register a deal, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
