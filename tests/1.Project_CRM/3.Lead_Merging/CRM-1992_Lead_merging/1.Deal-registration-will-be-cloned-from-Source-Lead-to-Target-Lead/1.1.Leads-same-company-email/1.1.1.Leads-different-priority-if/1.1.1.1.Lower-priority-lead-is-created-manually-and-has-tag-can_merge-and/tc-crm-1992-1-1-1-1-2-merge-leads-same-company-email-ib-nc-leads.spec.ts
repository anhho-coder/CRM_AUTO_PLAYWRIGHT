...
test.describe('CRM-1992_1.1.1.1.2 - Lead Merging: Same Company Email with Deal Registration (IB NC Leads)', () => {
  ...
  test('CRM-1992_1.1.1.1.2 [CRM-10787]: Verify merging leads with same company email (IB NC Leads, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
