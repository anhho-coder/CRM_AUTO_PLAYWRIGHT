 ...
 * Test Case ID: CRM-1992_1.1.1.1.2
 * 
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.2 -" --project=chromium
...
test.describe('CRM-1992_1.1.1.1.2 - Lead Merging: Same Company Email with Deal Registration (IB NC Leads)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.2 [CRM-10787]: Verify merging leads with same company email (IB NC Leads, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, IB NC Leads)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, IB NC Leads)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, IB NC Leads) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (IB NC Leads) verified successfully');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (IB NC Leads)</h2>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (IB NC Leads) verified successfully<br>
        Lead #2 (Deal Registration) merged into Lead #1 (IB NC Leads)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (IB NC Leads) - Test Summary', {
