 ...
 * Test Case ID: CRM-1992_1.1.1.1.5
 * 
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.1\.1\.1\.5 -" --project=chromium
...
test.describe('CRM-1992_1.1.1.1.5 - Lead Merging: Same Company Email with Deal Registration (Request Demo)', () => {
  ...
  test.skip('CRM-1992_1.1.1.1.5 [CRM-10787]: Verify merging leads with same company email (Request Demo, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = FALSE, Request Demo)
    await test.step('Condition #1: Create Lead #1 (Created Manually = FALSE, Request Demo)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = FALSE, Request Demo) ===');
    ...
    await test.step('Step 3: Verify the following fields on Lead #1', async () => {
      ...
      // Step 3.1: Verify Tags contain "Can_Merge", "Demo request"
    ...
    await test.step('Step 4: Click at "CRM Developer" tab and verify the following', async () => {
      ...
      await test.step('Step 4.1: Lead form textbox = Request Demo', async () => {
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: Lead merging with Deal Registration (Request Demo) verified successfully');
      console.log(`   Lead #1 (${lead1Id}): Active=TRUE, Is Won=Pending, Tags: Can_Merge, Demo request`);
      console.log(`   - Created Manually: FALSE`);
      console.log(`   - Lead Form: Request Demo`);
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Request Demo)</h2>
    </div>
    ...
    <div class="lead-section">
      ...
      <div class="info-row"><span class="label">Tags:</span> Can_Merge, Demo request</div>
      ...
      <div class="info-row"><span class="label">Lead Form:</span> Request Demo</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        Lead merging with Deal Registration (Request Demo) verified successfully<br>
        Lead #2 (Deal Registration) merged into Lead #1 (Request Demo)<br>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Request Demo) - Test Summary', {
