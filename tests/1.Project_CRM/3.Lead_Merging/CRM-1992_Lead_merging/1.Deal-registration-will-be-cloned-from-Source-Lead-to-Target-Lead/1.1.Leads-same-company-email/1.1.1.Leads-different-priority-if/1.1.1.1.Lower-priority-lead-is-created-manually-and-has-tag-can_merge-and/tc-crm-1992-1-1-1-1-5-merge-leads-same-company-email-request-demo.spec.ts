...
test.describe('CRM-1992_1.1.1.1.5 - Lead Merging: Same Company Email with Deal Registration (Request Demo)', () => {
  ...
  test('CRM-1992_1.1.1.1.5 [CRM-10787]: Verify merging leads with same company email (Request Demo, Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
