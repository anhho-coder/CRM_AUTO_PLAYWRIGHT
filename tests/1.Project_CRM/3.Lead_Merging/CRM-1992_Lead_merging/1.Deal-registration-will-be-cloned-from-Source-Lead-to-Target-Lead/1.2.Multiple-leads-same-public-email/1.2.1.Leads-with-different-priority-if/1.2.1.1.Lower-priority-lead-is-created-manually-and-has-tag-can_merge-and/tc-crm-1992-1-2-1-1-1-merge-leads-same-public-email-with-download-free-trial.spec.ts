 ...
 * Test Case ID: CRM-1992_1.2.1.1.1
 *
...
test.describe('CRM-1992_1.2.1.1.1 - Lead Merging: Same Public Email with Deal Registration', () => {
  ...
  test('CRM-1992_1.2.1.1.1 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration)', async ({ page }, testInfo) => {
    ...
    // CONDITION #1: Create Lead #1 (Created Manually = TRUE, Download Free Trial, Deal Registration)
    await test.step('Condition #1: Create Lead #1 with Deal Registration (Created Manually = TRUE)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Deal Registration) ===');
...
<body>
  <div class="container">
    <div class="header">
      <h2><span class="icon">\u2705</span>LEAD MERGING TEST - PASSED (Deal Registration - Public Email)</h2>
    </div>
...
`;
      ...
      await testInfo.attach('\ud83d\udccb Lead Merging (Deal Registration - Public Email) - Test Summary', {
