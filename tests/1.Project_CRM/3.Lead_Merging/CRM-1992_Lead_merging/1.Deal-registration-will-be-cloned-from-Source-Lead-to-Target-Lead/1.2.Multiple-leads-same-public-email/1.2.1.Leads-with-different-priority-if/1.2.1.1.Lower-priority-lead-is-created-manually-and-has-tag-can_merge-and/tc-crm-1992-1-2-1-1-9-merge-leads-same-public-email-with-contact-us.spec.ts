 ...
 * Test Case ID: CRM-1992_1.2.1.1.9
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.9 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.9 - Lead Merging: Same Public Email with Deal Registration (Contact Us)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.9 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Contact Us)', async ({ page }, testInfo) => {
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, Contact Us)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Contact Us) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: Contact Us, Tags: Can_Merge`);
