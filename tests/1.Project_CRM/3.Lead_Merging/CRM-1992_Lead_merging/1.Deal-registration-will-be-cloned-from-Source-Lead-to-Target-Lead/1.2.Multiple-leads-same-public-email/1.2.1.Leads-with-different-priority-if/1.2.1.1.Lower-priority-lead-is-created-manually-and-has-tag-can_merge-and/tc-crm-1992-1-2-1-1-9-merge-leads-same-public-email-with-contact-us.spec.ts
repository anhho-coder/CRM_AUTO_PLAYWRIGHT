...
test.describe('CRM-1992_1.2.1.1.9 - Lead Merging: Same Public Email with Deal Registration (Contact Us)', () => {
  ...
  test('CRM-1992_1.2.1.1.9 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Contact Us)', async ({ page }, testInfo) => {
