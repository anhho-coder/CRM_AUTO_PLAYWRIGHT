 ...
 * Test Case ID: CRM-1992_1.2.1.1.4
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1.2.1.1.4" --project=chromium
 * 
 * Pre-condition:
...
test.describe('CRM-1992_1.2.1.1.4 - Lead Merging: Same Public Email with Deal Registration (Register a Deal)', () => {
  ...
  test('Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Register a Deal)', async ({ page }, testInfo) => {
