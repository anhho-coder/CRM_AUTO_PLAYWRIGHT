...
test.describe('CRM-1992_1.2.1.1.8 - Lead Merging: Same Public Email with Deal Registration (Trial from Free version)', () => {
  ...
  test('CRM-1992_1.2.1.1.8 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Trial from Free version)', async ({ page }, testInfo) => {
