...
test.describe('CRM-1992_1.2.1.1.12 - Lead Merging: Same Public Email with Deal Registration (Try v10.0 Beta)', () => {
  ...
  test('CRM-1992_1.2.1.1.12 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Try v10.0 Beta)', async ({ page }, testInfo) => {
