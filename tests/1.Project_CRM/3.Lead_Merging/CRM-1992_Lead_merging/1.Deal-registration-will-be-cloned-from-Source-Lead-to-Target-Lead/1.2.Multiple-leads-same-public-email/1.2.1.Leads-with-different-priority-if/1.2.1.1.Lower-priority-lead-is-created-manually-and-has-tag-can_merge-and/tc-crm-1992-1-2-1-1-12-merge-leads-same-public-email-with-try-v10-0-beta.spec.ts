 ...
 * Test Case ID: CRM-1992_1.2.1.1.12
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.12 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.12 - Lead Merging: Same Public Email with Deal Registration (Try v10.0 Beta)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.12 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Try v10.0 Beta)', async ({ page }, testInfo) => {
    ...
    const tcId = 'CRM-1992_1.2.1.1.12';
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, Try v10.0 Beta)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Try v10.0 Beta) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: Try v10.0 Beta, Tags: Can_Merge, Beta download`);
