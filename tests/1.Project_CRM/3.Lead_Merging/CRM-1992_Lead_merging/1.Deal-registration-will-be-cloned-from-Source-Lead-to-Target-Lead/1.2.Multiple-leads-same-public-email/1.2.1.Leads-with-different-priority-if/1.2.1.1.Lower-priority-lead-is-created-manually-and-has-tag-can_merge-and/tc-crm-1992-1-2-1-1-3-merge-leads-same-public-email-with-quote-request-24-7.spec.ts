 ...
 * Test Case ID: CRM-1992_1.2.1.1.3
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.3 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.3 - Lead Merging: Same Public Email with Deal Registration (Quote Request 24/7*)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.3 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Quote Request 24/7*)', async ({ page }, testInfo) => {
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, Quote Request 24/7*)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Quote Request 24/7*) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: Quote Request 24/7*, Tags: Can_Merge, Quote request`);
