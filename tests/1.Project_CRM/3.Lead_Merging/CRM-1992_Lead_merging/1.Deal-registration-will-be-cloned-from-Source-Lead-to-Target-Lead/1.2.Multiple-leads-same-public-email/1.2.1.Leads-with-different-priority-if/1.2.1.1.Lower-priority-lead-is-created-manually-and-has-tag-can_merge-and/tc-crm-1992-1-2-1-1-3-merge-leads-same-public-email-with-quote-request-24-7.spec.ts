...
test.describe('CRM-1992_1.2.1.1.3 - Lead Merging: Same Public Email with Deal Registration (Quote Request 24/7*)', () => {
  ...
  test('CRM-1992_1.2.1.1.3 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Quote Request 24/7*)', async ({ page }, testInfo) => {
