 ...
 * Test Case ID: CRM-1992_1.2.1.1.10
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.10 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.10 - Lead Merging: Same Public Email with Deal Registration (Cloud Provider Sing Up)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.10 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Cloud Provider Sing Up)', async ({ page }, testInfo) => {
    ...
    const tcId = 'CRM-1992_1.2.1.1.10';
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, Cloud Provider Sing Up)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Cloud Provider Sing Up) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: Cloud Provider Sing Up, Tags: Can_Merge, Partner signup`);
