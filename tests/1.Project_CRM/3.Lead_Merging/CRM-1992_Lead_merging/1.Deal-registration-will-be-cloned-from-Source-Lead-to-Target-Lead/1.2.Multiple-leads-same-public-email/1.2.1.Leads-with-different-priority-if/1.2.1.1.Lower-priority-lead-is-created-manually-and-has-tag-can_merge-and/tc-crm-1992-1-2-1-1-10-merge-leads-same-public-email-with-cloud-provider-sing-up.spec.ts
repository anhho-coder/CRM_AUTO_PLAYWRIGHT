...
test.describe('CRM-1992_1.2.1.1.10 - Lead Merging: Same Public Email with Deal Registration (Cloud Provider Sing Up)', () => {
  ...
  test('CRM-1992_1.2.1.1.10 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Cloud Provider Sing Up)', async ({ page }, testInfo) => {
