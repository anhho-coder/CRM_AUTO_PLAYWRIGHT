...
test.describe('CRM-1992_1.2.1.1.2 - Lead Merging: Same Public Email with Deal Registration (IB NC Leads)', () => {
  ...
  test('CRM-1992_1.2.1.1.2 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, IB NC Leads)', async ({ page }, testInfo) => {
