 ...
 * Test Case ID: CRM-1992_1.2.1.1.6
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.6 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.6 - Lead Merging: Same Public Email with Deal Registration (Partner Sign Up %)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.6 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Partner Sign Up %)', async ({ page }, testInfo) => {
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, Partner Sign Up %)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Partner Sign Up %) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: Partner Sign Up %, Tags: Can_Merge, Partner signup`);
