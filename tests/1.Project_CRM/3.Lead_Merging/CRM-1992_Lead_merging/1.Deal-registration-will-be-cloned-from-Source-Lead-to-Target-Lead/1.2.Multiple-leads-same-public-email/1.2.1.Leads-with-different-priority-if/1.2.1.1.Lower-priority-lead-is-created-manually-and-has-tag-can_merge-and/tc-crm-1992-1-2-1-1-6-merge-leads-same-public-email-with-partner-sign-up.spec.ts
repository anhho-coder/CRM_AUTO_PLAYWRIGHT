...
test.describe('CRM-1992_1.2.1.1.6 - Lead Merging: Same Public Email with Deal Registration (Partner Sign Up %)', () => {
  ...
  test('CRM-1992_1.2.1.1.6 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Partner Sign Up %)', async ({ page }, testInfo) => {
