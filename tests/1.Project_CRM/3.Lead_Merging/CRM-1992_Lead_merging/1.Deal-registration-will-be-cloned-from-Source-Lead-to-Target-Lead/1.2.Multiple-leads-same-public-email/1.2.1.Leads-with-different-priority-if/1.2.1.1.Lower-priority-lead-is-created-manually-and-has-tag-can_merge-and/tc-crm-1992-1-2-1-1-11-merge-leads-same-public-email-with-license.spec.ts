...
test.describe('CRM-1992_1.2.1.1.11 - Lead Merging: Same Public Email with Deal Registration (License)', () => {
  ...
  test('CRM-1992_1.2.1.1.11 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, License)', async ({ page }, testInfo) => {
