 ...
 * Test Case ID: CRM-1992_1.2.1.1.11
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.11 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.11 - Lead Merging: Same Public Email with Deal Registration (License)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.11 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, License)', async ({ page }, testInfo) => {
    ...
    const tcId = 'CRM-1992_1.2.1.1.11';
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, License)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, License) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: License, Tags: Can_Merge, Product Registration`);
