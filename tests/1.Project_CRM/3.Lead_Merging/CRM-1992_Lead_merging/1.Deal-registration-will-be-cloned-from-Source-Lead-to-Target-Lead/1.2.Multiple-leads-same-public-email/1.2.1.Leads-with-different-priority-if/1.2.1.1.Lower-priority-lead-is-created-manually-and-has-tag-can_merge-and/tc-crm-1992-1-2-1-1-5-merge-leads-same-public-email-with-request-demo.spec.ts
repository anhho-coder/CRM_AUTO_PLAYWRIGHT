...
test.describe('CRM-1992_1.2.1.1.5 - Lead Merging: Same Public Email with Deal Registration (Request Demo)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.5 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Request Demo)', async ({ page }, testInfo) => {
