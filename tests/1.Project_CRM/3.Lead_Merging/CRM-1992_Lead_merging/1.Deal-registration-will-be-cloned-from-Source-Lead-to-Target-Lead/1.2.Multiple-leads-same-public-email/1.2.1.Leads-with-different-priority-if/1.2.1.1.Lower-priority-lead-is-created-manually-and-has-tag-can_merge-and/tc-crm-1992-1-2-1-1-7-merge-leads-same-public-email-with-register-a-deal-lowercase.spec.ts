...
test.describe('CRM-1992_1.2.1.1.7 - Lead Merging: Same Public Email with Deal Registration (Register a deal)', () => {
  ...
  test('CRM-1992_1.2.1.1.7 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Register a deal)', async ({ page }, testInfo) => {
