 ...
 * Test Case ID: CRM-1992_1.2.1.1.7
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "CRM-1992_1\.2\.1\.1\.7 -" --project=chromium
...
test.describe('CRM-1992_1.2.1.1.7 - Lead Merging: Same Public Email with Deal Registration (Register a deal)', () => {
  ...
  test.skip('CRM-1992_1.2.1.1.7 [CRM-8929] [CRM-10787]: Verify merging leads with same public email (Created Manually = TRUE, Deal Registration, Register a deal)', async ({ page }, testInfo) => {
    ...
    await test.step('Condition #1: Create Lead #1 (Created Manually = TRUE, Register a deal)', async () => {
      console.log('=== CONDITION #1: CREATING LEAD #1 (Created Manually = TRUE, Register a deal) ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED');
      console.log(`   Lead #1: Register a deal, Tags: Can_Merge, Deal registration`);
