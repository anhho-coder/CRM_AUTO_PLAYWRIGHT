 ...
 * Test Case ID: TC.Performance.2.1.2
 *
 * Command to run:
 * npx playwright test --grep "TC\.Performance\.2\.1\.2:" --project=chromium
 *
...
test.describe('TC.Performance.2.1.2 - Edit CRM Opportunity Performance', () => {
  ...
  test('TC.Performance.2.1.2: Verify consumer time for editing Opp is less than 1 min', async ({ page }) => {
