 ...
 * Test Case ID: TC.Performance.2.1.1
 * 
 * Summary: Verify consumer time for creating Opp is less than 1 min
 * 
 * Command to run:
 * npx playwright test --grep "TC\.Performance\.2\.1\.1:" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.Performance.2.1.1 - Create CRM Opportunity Performance', () => {
  ...
  test('TC.Performance.2.1.1: Verify consumer time for creating Opp is less than 1 min', async ({ page }) => {
