 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.33
 ...
 *  test case owns: verify that a newly created Opportunity offers exactly the expected sub-menu buttons above the information area, in the expected left-to-right order.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.33:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.33 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.33
 ...
 *    4. Read the sub-menu (smart) buttons above the information area
 *
 *  Verification:
 *    4. The sub-menu bar shows exactly 4 buttons, in this order: Demo | Meeting | Chains | Quotation(s)
 *    - The sub-menu buttons Odoo hides while their counter is empty (Product Registrations, Orders, Similar, Merged Leads, Feature Request, Tickets, Map, Old Messages) are NOT shown on a newly created Opportunity
 *
...
const TC = 'TC.Performance.1.1.2.33';
...
const STEP = {
  ...
  s4: 'Step 4: Read the sub-menu (smart) buttons above the information area',
};
