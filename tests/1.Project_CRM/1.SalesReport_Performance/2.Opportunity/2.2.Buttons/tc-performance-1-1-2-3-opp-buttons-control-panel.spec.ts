 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.3
 ...
 *  test case owns: verify that a saved Opportunity offers exactly the expected control-panel buttons, with the expected captions, in the expected left-to-right order.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.3:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.3 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.3
 ...
 *    4. Read the control-panel buttons of the saved Opportunity
 *
 *  Verification:
...
const TC = 'TC.Performance.1.1.2.3';

/** The control-panel buttons of a saved Opportunity, left to right (pre-production, 2026-09-21). */
const EXPECTED = [
    'EDIT',
    'CREATE',
    'Print',
...
const STEP = {
  ...
  s4: 'Step 4: Read the control-panel buttons of the saved Opportunity',
};
