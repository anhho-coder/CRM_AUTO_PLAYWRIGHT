 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.7
 ...
 *  test case owns: verify that the Print menu of a saved Opportunity offers exactly the expected reports, in the expected order.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.7:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.7 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.7
 ...
 *    4. Open the Print menu of the saved Opportunity and read its entries
 *
 *  Verification:
...
const TC = 'TC.Performance.1.1.2.7';

/** The reports the Print menu of an Opportunity offers (pre-production, 2026-09-21). */
const EXPECTED = [
    'Lead Survey Report',
  ];
...
const STEP = {
  ...
  s4: 'Step 4: Open the Print menu of the saved Opportunity and read its entries',
};
