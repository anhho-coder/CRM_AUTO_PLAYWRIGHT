 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.6
 ...
 *  test case owns: verify that pressing CREATE in the control panel of a saved Opportunity opens a blank Opportunity form in edit mode, with an empty Opportunity name and an empty Email.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.6:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.6 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.6
 ...
 *    4. Press CREATE in the control panel of the saved Opportunity
 *    5. Read the form that opens
 *
 *  Verification:
 *    5. A blank Opportunity form opens:
 *    - The breadcrumb ends on "New"
 *    - The control panel shows SAVE | DISCARD
 *    - The form is in edit mode
 *    - The Opportunity name and the Email are empty (nothing is carried over from the saved record)
 *
...
const TC = 'TC.Performance.1.1.2.6';

/** The control-panel buttons a form being created offers (pre-production, 2026-09-21). */
const EXPECTED_EDIT = [
    'SAVE',
    'DISCARD',
  ];
...
const STEP = {
  ...
  s4: 'Step 4: Press CREATE in the control panel of the saved Opportunity',
  s5: 'Step 5: Read the form that opens',
};
