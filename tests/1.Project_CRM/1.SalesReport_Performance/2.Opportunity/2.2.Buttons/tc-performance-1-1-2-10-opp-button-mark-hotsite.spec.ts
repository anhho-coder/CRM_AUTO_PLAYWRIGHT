 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.10
 ...
 *  test case owns: verify that pressing MARK HOTSITE on a saved Opportunity raises a confirmation dialog, and that dismissing it with CANCEL leaves the Opportunity in its stage.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.10:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.10 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.10
 ...
 *    4. Press the MARK HOTSITE button of the saved Opportunity
 *    5. Read the dialog that opens, then dismiss it with CANCEL
 *
 *  Verification:
 *    5. A confirmation dialog opens:
 *    - Title = Confirmation
 *    - Message = Are you sure you want to mark a HOTSITE?
 *    - Buttons = OK | CANCEL
...
const TC = 'TC.Performance.1.1.2.10';
...
const STEP = {
  ...
  s4: 'Step 4: Press the MARK HOTSITE button of the saved Opportunity',
