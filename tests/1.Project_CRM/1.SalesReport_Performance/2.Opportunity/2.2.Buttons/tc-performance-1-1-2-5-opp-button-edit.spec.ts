 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.5
 ...
 *  test case owns: verify that pressing EDIT on a saved Opportunity switches the form to edit mode and replaces the control-panel buttons with SAVE and DISCARD.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.5:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.5 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.5
 ...
 *    4. Press the EDIT button of the saved Opportunity
 *    5. Read the form mode and the control-panel buttons
 *
 *  Verification:
 *    4. The saved Opportunity opens in read mode (the form is not editable)
 *    5. After EDIT the form is editable and the control panel shows exactly SAVE | DISCARD
 *
...
const TC = 'TC.Performance.1.1.2.5';

/** The control-panel buttons an Opportunity in EDIT mode offers (pre-production, 2026-09-21). */
const EXPECTED_EDIT = [
    'SAVE',
    'DISCARD',
  ];
...
const STEP = {
  ...
  s4: 'Step 4: Press the EDIT button of the saved Opportunity',
  s5: 'Step 5: Read the form mode and the control-panel buttons',
};
...
test.describe(`${TC} - Buttons`, () => {
  ...
  test(`${TC}: Verify the EDIT button puts the Opportunity form in edit mode`, async ({ page }, testInfo) => {
    ...
    let oppId = '';
    /** Read in step 4 and asserted in step 5 - the form mode BEFORE EDIT was pressed. */
