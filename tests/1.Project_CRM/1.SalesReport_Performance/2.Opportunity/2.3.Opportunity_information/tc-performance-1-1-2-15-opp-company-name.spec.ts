...
/**
 * =============================================================================================
 *  Opportunity screen verification - Company Name
 * =============================================================================================
 *  Test Case ID    : TC.Performance.1.1.2.15
 ...
 *  test case owns: verify that an Opportunity created without a Company Name gets one from the domain of the e-mail entered on the CREATE form.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.1\\.1\\.2\\.15:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.1.1.2.15 <unique>
 *       - Contact Name    = Contact Name TC.Performance.1.1.2.15
 ...
 *    4. Read the Company Name on the saved form
 *
 *  Verification:
 *    4. Company Name shows the domain of the entered e-mail, i.e. "company<unique>.com"
 *    - The field is not left empty although no Company Name was typed on the CREATE form
 *
...
const TC = 'TC.Performance.1.1.2.15';
...
const STEP = {
  ...
  s4: 'Step 4: Read the Company Name on the saved form',
};

test.describe(`${TC} - Company Name`, () => {
  let oppUrl = '';
