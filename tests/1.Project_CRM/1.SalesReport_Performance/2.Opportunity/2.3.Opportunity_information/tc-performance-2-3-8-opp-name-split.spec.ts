 ...
 * =============================================================================================
 *  Test Case ID    : TC.Performance.2.3.8
 ...
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "TC\\.Performance\\.2\\.3\\.8:" --project=SalesReport_Performance
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *       - Opportunity     = AUTO TC.Performance.2.3.8 <unique>
 *       - Contact Name    = Contact Name TC.Performance.2.3.8
 ...
 *
 *  Verification:
 *    4. The Contact Name "Contact Name TC.Performance.2.3.8" is split into:
 *    - First Name = Contact
 *    - Middle Name = Name
 *    - Last Name = TC.Performance.2.3.8
 *
