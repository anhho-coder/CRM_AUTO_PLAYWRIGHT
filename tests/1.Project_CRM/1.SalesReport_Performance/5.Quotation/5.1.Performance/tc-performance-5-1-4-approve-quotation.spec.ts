 ...
 * Test Case ID: TC.Performance.5.1.4
 * 
 * Summary: Verify consumer time for approving Quotation is less than 1 min
 *
 * Command to run:
...
test.describe('TC.Performance.5.1.4 - Approve Quotation Performance', () => {
  ...
  test('TC.Performance.5.1.4: Verify consumer time for approving Quotation is less than 1 min', async ({ page, browser }, testInfo) => {
