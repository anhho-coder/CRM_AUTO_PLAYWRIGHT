 ...
 * Test Case ID: TC.Performance.5.1.3
 * 
 * Summary: Verify consumer time for sending Quotation is less than 1 min
 *
 * Command to run:
...
test.describe('TC.Performance.5.1.3 - Send Quotation Performance', () => {
  ...
  test('TC.Performance.5.1.3: Verify consumer time for sending Quotation is less than 1 min', async ({ page }, testInfo) => {
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div style="font-size: 14px; margin-top: 5px;">TC.Performance.5.1.3 - Send Quotation Performance</div>
    </div>
