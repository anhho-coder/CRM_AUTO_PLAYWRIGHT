 ...
 * Test Case ID: TC.Performance.5.1.1
 * 
 * Summary: Verify consumer time for creating Quotation is less than 1 min
 * 
 * Command to run:
...
test.describe('TC.Performance.5.1.1 - Create Quotation Performance', () => {
  ...
  test('TC.Performance.5.1.1: Verify consumer time for creating Quotation is less than 1 min', async ({ page }) => {
