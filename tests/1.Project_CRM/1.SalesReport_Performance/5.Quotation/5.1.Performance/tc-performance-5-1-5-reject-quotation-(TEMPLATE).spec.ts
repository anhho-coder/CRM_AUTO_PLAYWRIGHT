 ...
 * Test Case ID: TC.Performance.5.1.5
 * 
 * Summary: Verify consumer time for rejecting Quotation is less than 1 min
 *
 * Command to run:
...
test.describe('TC.Performance.5.1.5 - Reject Quotation Performance', () => {
  const PERFORMANCE_THRESHOLD = 60000; // 1 minute in milliseconds
    ...
    test('TC.Performance.5.1.5: Verify consumer time for rejecting Quotation is less than 1 min', async ({ page, browser }, testInfo) => {
