 ...
 * Test Case ID: TC.Performance.5.5.3
 * Automation-Type: new
 ...
 * TC.Performance.5.5.1. "Promo Discount Amount" is developer-only and is covered by
 * TC.Performance.5.5.5.
 */
