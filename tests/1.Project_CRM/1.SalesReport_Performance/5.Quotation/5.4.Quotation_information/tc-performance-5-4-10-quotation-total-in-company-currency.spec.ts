 ...
 * Test Case ID: TC.Performance.5.4.10
 * Automation-Type: new
 ...
 *
 * Objective: Verify that "Total in Company Currency" is not a decoration: on a Quotation priced in EUR it is filled, greater than zero and DIFFERENT from the EUR Total, i.e. it really is the total converted into the company currency. The field is developer-only, so the record is re-opened with debug mode ON to read it - see TC.Performance.5.4.13.
 *
 * Pre-condition:
...
const TC = 'TC.Performance.5.4.10';
