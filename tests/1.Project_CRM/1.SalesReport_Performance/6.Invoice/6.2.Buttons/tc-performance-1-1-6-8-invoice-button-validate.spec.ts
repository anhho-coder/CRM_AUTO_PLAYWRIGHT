...
/**
 * Invoice buttons - The VALIDATE button posts the Invoice and gives it a number
 * Test Case ID: TC.Performance.1.1.6.8
 * Automation-Type: new
 * Automation-Date: 2026-09-17
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.6\\.8:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.6.8';
...
const STEP = {
  ...
  s7: 'Step 7: Pressing VALIDATE and verifying the Invoice is posted',
};

test.describe(`${TC} - The VALIDATE button posts the Invoice and gives it a number`, () => {
  let oppUrl = '';
  let dealElementUrl = '';
  let quotationUrl = '';
  let invoiceUrl = '';
  ...
  test(`${TC}: Verify the VALIDATE button posts the Invoice and gives it a number`, async ({ page }) => {
