 ...
 * Test Case ID: TC.Performance.6.1.3
 * 
 * Summary: Verify consumer time for sending Invoice is less than 1 min
 *
 * Command to run:
...
test.describe('TC.Performance.6.1.3 - Send Invoice Performance', () => {
  const PERFORMANCE_THRESHOLD = 60000; // 1 minute in milliseconds
        ...
        test('TC.Performance.6.1.3: Verify consumer time for sending Invoice is less than 1 min', async ({ page, browser }, testInfo) => {
