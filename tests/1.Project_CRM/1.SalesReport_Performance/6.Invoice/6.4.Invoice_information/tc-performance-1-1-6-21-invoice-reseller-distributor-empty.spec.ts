...
/**
 * Invoice data verification - Distributor, Reseller and their contacts are empty on an Invoice raised from a direct Opportunity
 * Test Case ID: TC.Performance.1.1.6.21
 * Automation-Type: new
 * Automation-Date: 2026-09-17
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.6\\.21:" --project=SalesReport_Performance
 *
 ...
 *
 * Steps run:
 * 1. Read the "Distributor", "Distributor contact", "Reseller" and "Reseller contact" fields
 *
 * Verification:
 * - Distributor is empty
 * - Distributor contact is empty
 * - Reseller is empty
 * - Reseller contact is empty
 *
...
const TC = 'TC.Performance.1.1.6.21';
...
const STEP = {
  ...
  s7: 'Step 7: Verifying Distributor, Reseller and their contacts are empty',
};

test.describe(`${TC} - Distributor, Reseller and their contacts are empty on an Invoice raised from a direct Opportunity`, () => {
  let oppUrl = '';
  let dealElementUrl = '';
  let quotationUrl = '';
  let invoiceUrl = '';
  ...
  test(`${TC}: Verify Distributor, Reseller and their contacts are empty on an Invoice raised from a direct Opportunity`, async ({ page }) => {
