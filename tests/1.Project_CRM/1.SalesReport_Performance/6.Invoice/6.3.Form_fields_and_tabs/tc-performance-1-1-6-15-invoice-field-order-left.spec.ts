...
/**
 * Invoice layout - The field names and their order in the LEFT column of the Invoice information area
 * Test Case ID: TC.Performance.1.1.6.15
 * Automation-Type: new
 * Automation-Date: 2026-09-17
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.6\\.15:" --project=SalesReport_Performance
 *
 * Objective: Verify the left column of the Invoice information area carries the twelve documented fields, in the documented order.
 *
 * Pre-condition:
 ...
 *
 * Steps run:
 * 1. Read the field labels of the left column of the Invoice information area, top to bottom
 *
 * Verification:
...
const TC = 'TC.Performance.1.1.6.15';
...
const STEP = {
  ...
  s7: 'Step 7: Verifying the left column of the Invoice information area',
};

test.describe(`${TC} - The field names and their order in the LEFT column of the Invoice information area`, () => {
  let oppUrl = '';
  let dealElementUrl = '';
  let quotationUrl = '';
  let invoiceUrl = '';
  ...
  test(`${TC}: Verify the field names and their order in the left column of the Invoice information area`, async ({ page }) => {
