...
/**
 * Contact screen verification - Print menu
 * Test Case ID: TC.Performance.1.1.3.7
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.7:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.7';
...
test.describe(`${TC} - Print menu`, () => {
  ...
  test(`${TC}: Verify the reports the Print menu of a Contact offers`, async ({ page }) => {
