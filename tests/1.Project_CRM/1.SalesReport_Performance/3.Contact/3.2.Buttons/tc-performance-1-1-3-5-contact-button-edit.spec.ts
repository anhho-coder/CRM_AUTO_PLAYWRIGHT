...
/**
 * Contact screen verification - EDIT button
 * Test Case ID: TC.Performance.1.1.3.5
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.5:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.5';
...
test.describe(`${TC} - EDIT button`, () => {
  ...
  test(`${TC}: Verify the EDIT button puts the Contact form in edit mode`, async ({ page }) => {
