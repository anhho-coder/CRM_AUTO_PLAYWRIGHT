...
/**
 * Contact screen verification - Control-panel buttons
 * Test Case ID: TC.Performance.1.1.3.3
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.3:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.3';
...
test.describe(`${TC} - Control-panel buttons`, () => {
  ...
  test(`${TC}: Verify the number, the names and the order of the control-panel buttons on a saved Contact`, async ({ page }) => {
