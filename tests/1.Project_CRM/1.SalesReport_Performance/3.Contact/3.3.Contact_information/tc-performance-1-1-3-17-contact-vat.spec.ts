...
/**
 * Contact screen verification - VAT
 * Test Case ID: TC.Performance.1.1.3.17
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.17:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.17';
...
test.describe(`${TC} - VAT`, () => {
  ...
  test(`${TC}: Verify the VAT on the saved Contact matches the entered value`, async ({ page }) => {
