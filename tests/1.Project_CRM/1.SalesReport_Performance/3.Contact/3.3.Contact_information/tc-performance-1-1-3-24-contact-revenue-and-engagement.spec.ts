...
/**
 * Contact screen verification - Lifetime Revenue and Recent engagement
 * Test Case ID: TC.Performance.1.1.3.24
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.24:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.24';
...
test.describe(`${TC} - Lifetime Revenue and Recent engagement`, () => {
  ...
  test(`${TC}: Verify the Lifetime Revenue and the Recent engagement of a newly created Contact are zero`, async ({ page }) => {
