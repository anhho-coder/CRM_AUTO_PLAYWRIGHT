...
/**
 * Contact screen verification - Email
 * Test Case ID: TC.Performance.1.1.3.14
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.14:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.14';
...
test.describe(`${TC} - Email`, () => {
  ...
  test(`${TC}: Verify the Email on the saved Contact matches the entered value`, async ({ page }) => {
