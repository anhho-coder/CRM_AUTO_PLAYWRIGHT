...
/**
 * Contact screen verification - Contact Name
 * Test Case ID: TC.Performance.1.1.3.12
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.12:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.12';
...
test.describe(`${TC} - Contact Name`, () => {
  ...
  test(`${TC}: Verify the Contact Name on the saved Contact matches the entered value`, async ({ page }) => {
