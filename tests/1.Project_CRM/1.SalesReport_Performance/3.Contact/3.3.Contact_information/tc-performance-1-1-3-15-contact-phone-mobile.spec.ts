...
/**
 * Contact screen verification - Phone and Mobile
 * Test Case ID: TC.Performance.1.1.3.15
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.15:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.15';
...
test.describe(`${TC} - Phone and Mobile`, () => {
  ...
  test(`${TC}: Verify the Phone and the Mobile on the saved Contact match the entered values`, async ({ page }) => {
