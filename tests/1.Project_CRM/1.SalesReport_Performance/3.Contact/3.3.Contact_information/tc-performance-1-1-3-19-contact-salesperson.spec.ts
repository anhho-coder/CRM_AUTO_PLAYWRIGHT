...
/**
 * Contact screen verification - Salesperson
 * Test Case ID: TC.Performance.1.1.3.19
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.19:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.19';
...
test.describe(`${TC} - Salesperson`, () => {
  ...
  test(`${TC}: Verify the Salesperson on the saved Contact matches the selected value`, async ({ page }) => {
