...
/**
 * Contact screen verification - Sales Team
 * Test Case ID: TC.Performance.1.1.3.20
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.20:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.20';
...
test.describe(`${TC} - Sales Team`, () => {
  ...
  test(`${TC}: Verify the Sales Team on the saved Contact matches the selected value`, async ({ page }) => {
