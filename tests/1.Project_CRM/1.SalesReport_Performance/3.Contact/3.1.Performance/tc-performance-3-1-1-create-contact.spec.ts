 ...
 * Test Case ID: TC.Performance.3.1.1
 *
 * Command to run:
 * npx playwright test --grep "TC\.Performance\.1\.1\.3\.1:" --project=chromium
 *
 * Objective: Verify consumer time for creating Contact is less than 1 minute
 * 
 * Test Steps:
 * 1. Login successful
...
test.describe('TC.Performance.3.1.1 - Create Contact Performance', () => {
  ...
  test('TC.Performance.3.1.1: Verify consumer time for creating Contact is less than 1 min', async ({ page }, testInfo) => {
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div style="font-size: 14px; margin-top: 5px;">TC.Performance.3.1.1 - Create Contact Performance</div>
    </div>
