 ...
 * Test Case ID: TC.Performance.3.1.2
 *
 * Command to run:
 * npx playwright test --grep "TC\.Performance\.1\.1\.3\.2:" --project=chromium
 *
 * Objective: Verify consumer time for editing Contact is less than 1 minute
 * 
 * Pre-condition:
 * 1. Login successful
...
test.describe('TC.Performance.3.1.2 - Edit Contact Performance', () => {
  ...
  test('TC.Performance.3.1.2: Verify consumer time for editing Contact is less than 1 min', async ({ page, context }, testInfo) => {
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div style="font-size: 14px; margin-top: 5px;">TC.Performance.3.1.2 - Edit Contact Performance</div>
    </div>
