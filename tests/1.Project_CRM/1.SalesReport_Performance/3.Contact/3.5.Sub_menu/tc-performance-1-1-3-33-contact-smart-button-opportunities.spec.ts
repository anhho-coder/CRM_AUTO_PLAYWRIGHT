...
/**
 * Contact screen verification - Sub-menu "Opportunities"
 * Test Case ID: TC.Performance.1.1.3.33
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.33:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.33';
...
test.describe(`${TC} - Sub-menu "Opportunities"`, () => {
  ...
  test(`${TC}: Verify the Opportunities sub-menu button opens the Opportunities of the Contact`, async ({ page }) => {
