...
/**
 * Contact screen verification - Sub-menu counters
 * Test Case ID: TC.Performance.1.1.3.31
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.31:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.31';
...
test.describe(`${TC} - Sub-menu counters`, () => {
  ...
  test(`${TC}: Verify every sub-menu counter of a newly created Contact reports zero`, async ({ page }) => {
