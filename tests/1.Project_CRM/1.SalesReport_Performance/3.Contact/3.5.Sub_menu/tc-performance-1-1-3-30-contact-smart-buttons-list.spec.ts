...
/**
 * Contact screen verification - Sub-menu buttons
 * Test Case ID: TC.Performance.1.1.3.30
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.30:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.30';
...
test.describe(`${TC} - Sub-menu buttons`, () => {
  ...
  test(`${TC}: Verify the number, the names and the order of the sub-menu (smart) buttons of a Contact`, async ({ page }) => {
