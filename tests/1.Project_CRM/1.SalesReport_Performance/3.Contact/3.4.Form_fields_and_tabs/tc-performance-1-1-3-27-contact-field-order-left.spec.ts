...
/**
 * Contact screen verification - Field names and order - left column
 * Test Case ID: TC.Performance.1.1.3.27
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.27:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.27';
...
test.describe(`${TC} - Field names and order - left column`, () => {
  ...
  test(`${TC}: Verify the field names and their order in the left column of the Contact information area`, async ({ page }) => {
