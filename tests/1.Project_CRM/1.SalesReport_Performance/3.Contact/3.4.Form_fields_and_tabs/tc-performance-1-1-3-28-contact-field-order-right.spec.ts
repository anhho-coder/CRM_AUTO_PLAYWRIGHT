...
/**
 * Contact screen verification - Field names and order - right column
 * Test Case ID: TC.Performance.1.1.3.28
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.3\\.28:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.3.28';
...
test.describe(`${TC} - Field names and order - right column`, () => {
  ...
  test(`${TC}: Verify the field names and their order in the right column of the Contact information area`, async ({ page }) => {
