...
/**
 * Lead data verification - Company (Customer) auto-created
 * Test Case ID: TC.Performance.1.1.1.5
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.1\\.5:" --project=SalesReport_Performance
 *
 * Objective: Verify the Company (Customer) is created automatically and carries the entered Company Name
 *
...
const TC = 'TC.Performance.1.1.1.5';
...
const STEP = {
  ...
  s5: 'Step 5: Verifying the Company (Customer) created automatically',
};

test.describe(`${TC} - Company (Customer) auto-created`, () => {
  ...
  test(`${TC}: Verify the Company (Customer) is created automatically and carries the entered Company Name`, async ({ page }) => {
    ...
    await test.step(STEP.s5, async () => {
      ...
      console.log('VERIFY - Company (Customer) created automatically');
