...
/**
 * Lead data verification - Tags
 * Test Case ID: TC.Performance.1.1.1.10
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.1\\.10:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.1.10';
...
test.describe(`${TC} - Tags`, () => {
  ...
  test(`${TC}: Verify the Tag set on the Lead is saved and logged in the chatter`, async ({ page }) => {
    ...
    await test.step(STEP.s5, async () => {
      ...
      console.log('VERIFY - Tags on the saved Lead');
