...
/**
 * Lead data verification - Contact Name
 * Test Case ID: TC.Performance.1.1.1.4
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.1\\.4:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.1.4';
...
test.describe(`${TC} - Contact Name`, () => {
  ...
  test(`${TC}: Verify the Contact Name on the saved Lead matches the entered value`, async ({ page }) => {
    ...
    await test.step(STEP.s5, async () => {
      ...
      console.log('VERIFY - Contact Name on the saved Lead');
