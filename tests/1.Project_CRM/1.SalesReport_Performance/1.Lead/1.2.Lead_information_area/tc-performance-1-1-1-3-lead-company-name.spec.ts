...
/**
 * Lead data verification - Company Name
 * Test Case ID: TC.Performance.1.1.1.3
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.1\\.3:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.1.3';
...
test.describe(`${TC} - Company Name`, () => {
  ...
  test(`${TC}: Verify the Company Name on the saved Lead matches the entered value`, async ({ page }) => {
    ...
    await test.step(STEP.s5, async () => {
      ...
      console.log('VERIFY - Company Name on the saved Lead');
