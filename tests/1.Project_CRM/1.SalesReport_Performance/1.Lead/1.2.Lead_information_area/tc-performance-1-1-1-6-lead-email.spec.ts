...
/**
 * Lead data verification - Email
 * Test Case ID: TC.Performance.1.1.1.6
 *
 * Command to run:
 * npx playwright test --grep "TC\\.Performance\\.1\\.1\\.1\\.6:" --project=SalesReport_Performance
 *
...
const TC = 'TC.Performance.1.1.1.6';
...
test.describe(`${TC} - Email`, () => {
  ...
  test(`${TC}: Verify the Email on the saved Lead matches the entered value`, async ({ page }) => {
    ...
    await test.step(STEP.s5, async () => {
      ...
      console.log('VERIFY - Email on the saved Lead');
