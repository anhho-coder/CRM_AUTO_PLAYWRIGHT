 ...
 * Test Case ID: TC.Performance.1.1.1
 *
 * Command to run:
 * npx playwright test --grep "TC\.Performance\.1\.1\.1\.1:" --project=chromium
 *
 * Objective: Verify consumer time for creating Lead is less than 1 minute
 * 
 * Test Data:
 * - Lead Name: TEST
 * - Email: Company email
...
test.describe('TC.Performance.1.1.1 - Create CRM Lead Performance', () => {
  ...
  test('TC.Performance.1.1.1: Verify consumer time for creating Lead is less than 1 min', async ({ page }) => {
