 ...
 * Test Case ID: TC.Performance.1.1.2
 *
 * Command to run:
 * npx playwright test --grep "TC\.Performance\.1\.1\.1\.2:" --project=chromium
 *
 * Objective: Verify consumer time for editing Lead is less than 1 minute
 * 
 * Pre-condition:
...
test.describe('TC.Performance.1.1.2 - Edit CRM Lead Performance', () => {
  ...
  test('TC.Performance.1.1.2: Verify consumer time for editing Lead is less than 1 min', async ({ page }) => {
