 ...
 * Test Case ID: TC.Performance.4.1.2
 * Automation-Type: refactored
 * Automation-Date: 2026-09-17
 * 
 * Summary: Verify consumer time for editing Deal Element is less than 1 min
 *
 * Command to run:
...
test.describe('TC.Performance.4.1.2 - Edit Deal Element Performance', () => {
  ...
  test('TC.Performance.4.1.2: Verify consumer time for editing Deal Element is less than 1 min', async ({ page }) => {
