 ...
 * Test Case ID: TC.Performance.4.1.1
 * Automation-Type: refactored
 * Automation-Date: 2026-09-17
 * 
 * Summary: Verify consumer time for creating Deal Element is less than 1 min
 *
 * Command to run:
...
test.describe('TC.Performance.4.1.1 - Create Deal Element Performance', () => {
  ...
  test('TC.Performance.4.1.1: Verify consumer time for creating Deal Element is less than 1 min', async ({ page }) => {
