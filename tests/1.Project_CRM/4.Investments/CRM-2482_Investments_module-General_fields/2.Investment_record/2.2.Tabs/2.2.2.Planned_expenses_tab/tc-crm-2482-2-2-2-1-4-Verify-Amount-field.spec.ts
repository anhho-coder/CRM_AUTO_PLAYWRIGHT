 ...
 * Test Case ID: CRM-2482_2.2.2.1.4
 *
 * Summary: Verify the ROI blocks of a Investment record includes "Amount" row
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.2.1.4" --project=chromium
 *
 * Pre-condition:
...
test.describe('CRM-2482_2.2.2.1.4 - Verify Planned Expenses Tab includes Amount row', () => {
  ...
  test('CRM-2482_2.2.2.1.4: Verify the ROI blocks of a Investment record includes "Amount" row', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click at "Amount" field', async () => {
      ...
      await investmentPage.clickPlannedExpensesAmountField();
    ...
    await test.step('Step 5: Verify "Amount" field is a number field', async () => {
      ...
      const isNumberFieldValid = await investmentPage.verifyPlannedExpensesAmountField();
