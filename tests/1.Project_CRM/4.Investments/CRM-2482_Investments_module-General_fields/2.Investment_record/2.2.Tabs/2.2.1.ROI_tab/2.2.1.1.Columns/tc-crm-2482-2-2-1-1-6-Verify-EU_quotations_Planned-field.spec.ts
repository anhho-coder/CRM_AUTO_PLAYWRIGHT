 ...
 * Test Case ID: CRM-2482_2.2.1.1.6
 *
 * Summary: Verify the ROI blocks of a Investment record includes "EU Quotations" column
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.1.1.6" --project=chromium
 *
 * Pre-condition:
 ...
 * 2. Click at "ROI" tab
 * 3. Verify "EU Quotations-Planned" field is a text field
 */

test.describe('CRM-2482_2.2.1.1.6 - Verify ROI Tab includes EU Quotations column', () => {
  ...
  test('CRM-2482_2.2.1.1.6: Verify the ROI blocks of a Investment record includes "EU Quotations" column', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify "EU Quotations-Planned" field is a text field
    await test.step('Step 3: Verify "EU Quotations-Planned" field is a text field', async () => {
      console.log('=== STEP 3: VERIFY "EU Quotations-Planned" FIELD ===');

      const isTextFieldValid = await investmentPage.verifyEUQuotationsPlannedField();
      expect(isTextFieldValid).toBeTruthy();

      console.log('  ✓ "EU Quotations-Planned" field exists');
      console.log('  ✓ "EU Quotations-Planned" field is a text input');
      console.log('✓ EU Quotations-Planned field verified successfully');
    });
