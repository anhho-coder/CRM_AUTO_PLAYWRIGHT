 ...
 * Test Case ID: CRM-2482_2.2.1.1.4
 *
 * Summary: Verify the ROI blocks of a Investment record includes "New company contacts" column
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.1.1.4" --project=chromium
 *
 * Pre-condition:
...
test.describe('CRM-2482_2.2.1.1.4 - Verify ROI Tab includes New company contacts column', () => {
  ...
  test('CRM-2482_2.2.1.1.4: Verify the ROI blocks of a Investment record includes "New company contacts" column', async ({ page }, testInfo) => {
