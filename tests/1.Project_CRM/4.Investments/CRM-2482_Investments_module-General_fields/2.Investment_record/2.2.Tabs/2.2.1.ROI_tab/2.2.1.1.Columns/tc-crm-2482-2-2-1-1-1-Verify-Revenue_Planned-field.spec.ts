 ...
 * Test Case ID: CRM-2482_2.2.1.1.1
 *
 * Summary: Verify the ROI blocks of a Investment record includes "Revenue" column
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.1.1.1" --project=chromium
 *
 * Pre-condition:
 ...
 * 2. Click at "ROI" tab
 * 3. Verify "Revenue-Planned" field is a text field
 */

test.describe('CRM-2482_2.2.1.1.1 - Verify ROI Tab includes Revenue column', () => {
  ...
  test('CRM-2482_2.2.1.1.1: Verify the ROI blocks of a Investment record includes "Revenue" column', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify "Revenue-Planned" field is a text field
    await test.step('Step 3: Verify "Revenue-Planned" field is a text field', async () => {
      console.log('=== STEP 3: VERIFY "Revenue-Planned" FIELD ===');

      const isTextFieldValid = await investmentPage.verifyRevenuePlannedField();
      expect(isTextFieldValid).toBeTruthy();

      console.log('  ✓ "Revenue-Planned" field exists');
      console.log('  ✓ "Revenue-Planned" field is a text input');
      console.log('✓ Revenue-Planned field verified successfully');
    });
