 ...
 * Test Case ID: CRM-2482_2.2.3.1.2
 *
 * Summary: Verify the Actual expenses tab of a Investment record includes "Description" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.3.1.2" --project=chromium
 *
 * Pre-condition:
...
test.describe('CRM-2482_2.2.3.1.2 - Verify Actual Expenses Tab includes Description field', () => {
  ...
  test('CRM-2482_2.2.3.1.2: Verify the Actual expenses tab of a Investment record includes "Description" field', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click at "Description" field', async () => {
      ...
      await investmentPage.clickActualExpensesDescriptionField();
    ...
    await test.step('Step 5: Verify "Description" field is a text field', async () => {
      ...
      const isTextFieldValid = await investmentPage.verifyActualExpensesDescriptionField();
