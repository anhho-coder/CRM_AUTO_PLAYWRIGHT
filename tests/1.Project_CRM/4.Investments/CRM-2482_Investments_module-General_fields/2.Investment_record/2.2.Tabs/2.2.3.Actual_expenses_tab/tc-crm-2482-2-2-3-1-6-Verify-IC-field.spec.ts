 ...
 * Test Case ID: CRM-2482_2.2.3.1.6
 *
 * Summary: Verify the Actual expenses tab of a Investment record includes "IC" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.3.1.6" --project=chromium
 *
 * Pre-condition:
 ...
 * 4. Click at "IC" field
 * 5. Verify "IC" field is a combobox field
 */

test.describe('CRM-2482_2.2.3.1.6 - Verify Actual Expenses Tab includes IC field', () => {
  ...
  test('CRM-2482_2.2.3.1.6: Verify the Actual expenses tab of a Investment record includes "IC" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Click at IC field
    await test.step('Step 4: Click at "IC" field', async () => {
      console.log('=== STEP 4: CLICK "IC" FIELD ===');

      await investmentPage.clickActualExpensesICField();

      console.log('\u2713 "IC" field clicked');
    });

    // Step 5: Verify IC field is a combobox field
    await test.step('Step 5: Verify "IC" field is a combobox field', async () => {
      console.log('=== STEP 5: VERIFY "IC" FIELD ===');

      const isComboboxFieldValid = await investmentPage.verifyActualExpensesICField();
      expect(isComboboxFieldValid).toBeTruthy();

      console.log('  \u2713 "IC" field exists');
      console.log('  \u2713 "IC" field is a combobox field');
      console.log('\u2713 IC field verified successfully');
    });
