 ...
 * Test Case ID: CRM-2482_2.2.4.1.6
 *
 * Summary: Verify the Audience tab of a Investment record includes "Engagement date" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.4.1.6" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Engagement date" row = BLANK
 *
...
test.describe('CRM-2482_2.2.4.1.6 - Verify the Audience tab of a Investment record includes "Engagement date" field', () => {
  ...
  test('CRM-2482_2.2.4.1.6: Verify the Audience tab of a Investment record includes "Engagement date" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Engagement date = BLANK
    await test.step('Step 3: Verify "Engagement date" value in Audience tab is BLANK', async () => {
      console.log('=== STEP 3: VERIFY ENGAGEMENT DATE ===');

      const engagementDateText = await investmentPage.getAudienceFirstRowCellText('Engagement date');
      console.log(`  3.1 Engagement date actual  : "${engagementDateText}"`);
      console.log(`  3.1 Engagement date expected: "" (BLANK)`);
      expect(engagementDateText.trim(), 'Step 3.1: Engagement date should be blank').toBe('');
      console.log('  ✓ 3.1 Engagement date verified (blank)');
    });
