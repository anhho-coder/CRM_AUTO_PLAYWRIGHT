 ...
 * Test Case ID: CRM-2482_2.2.4.1.9
 *
 * Summary: Verify the Audience tab of a Investment record includes "Qualified lead" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.4.1.9" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Qualified lead" row = Value of "0.00"
 *
...
test.describe('CRM-2482_2.2.4.1.9 - Verify the Audience tab of a Investment record includes "Qualified lead" field', () => {
  ...
  test('CRM-2482_2.2.4.1.9: Verify the Audience tab of a Investment record includes "Qualified lead" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Qualified lead = 0.00
    await test.step('Step 3: Verify "Qualified lead" value in Audience tab equals 0.00', async () => {
      console.log('=== STEP 3: VERIFY QUALIFIED LEAD ===');

      const qualifiedLeadText = await investmentPage.getAudienceFirstRowCellText('Qualified lead');
      console.log(`  3.1 Qualified lead actual  : "${qualifiedLeadText}"`);
      console.log(`  3.1 Qualified lead expected: "0.00"`);
      expect(qualifiedLeadText.trim(), 'Step 3.1: Qualified lead should equal 0.00').toBe('0.00');
      console.log('  ✓ 3.1 Qualified lead verified');
    });
