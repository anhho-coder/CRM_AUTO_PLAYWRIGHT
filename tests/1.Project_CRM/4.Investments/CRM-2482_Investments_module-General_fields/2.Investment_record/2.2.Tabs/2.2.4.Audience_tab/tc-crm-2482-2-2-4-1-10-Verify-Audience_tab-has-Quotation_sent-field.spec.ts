 ...
 * Test Case ID: CRM-2482_2.2.4.1.10
 *
 * Summary: Verify the Audience tab of a Investment record includes "Quotation sent" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.4.1.10" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Quotation sent" row = Value of "0.00"
 *
...
test.describe('CRM-2482_2.2.4.1.10 - Verify the Audience tab of a Investment record includes "Quotation sent" field', () => {
  ...
  test('CRM-2482_2.2.4.1.10: Verify the Audience tab of a Investment record includes "Quotation sent" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Quotation sent = 0.00
    await test.step('Step 3: Verify "Quotation sent" value in Audience tab equals 0.00', async () => {
      console.log('=== STEP 3: VERIFY QUOTATION SENT ===');

      const quotationSentText = await investmentPage.getAudienceFirstRowCellText('Quotation sent');
      console.log(`  3.1 Quotation sent actual  : "${quotationSentText}"`);
      console.log(`  3.1 Quotation sent expected: "0.00"`);
      expect(quotationSentText.trim(), 'Step 3.1: Quotation sent should equal 0.00').toBe('0.00');
      console.log('  ✓ 3.1 Quotation sent verified');
    });
