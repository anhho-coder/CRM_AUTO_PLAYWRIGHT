 ...
 * Test Case ID: CRM-2482_2.2.4.1.5
 *
 * Summary: Verify the Audience tab of a Investment record includes "Engagement type" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.4.1.5" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Engagement type" row = BLANK
 *
...
test.describe('CRM-2482_2.2.4.1.5 - Verify the Audience tab of a Investment record includes "Engagement type" field', () => {
  ...
  test('CRM-2482_2.2.4.1.5: Verify the Audience tab of a Investment record includes "Engagement type" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Engagement type = BLANK
    await test.step('Step 3: Verify "Engagement type" value in Audience tab is BLANK', async () => {
      console.log('=== STEP 3: VERIFY ENGAGEMENT TYPE ===');

      const engagementTypeText = await investmentPage.getAudienceFirstRowCellText('Engagement type');
      console.log(`  3.1 Engagement type actual  : "${engagementTypeText}"`);
      console.log(`  3.1 Engagement type expected: "" (BLANK)`);
      expect(engagementTypeText.trim(), 'Step 3.1: Engagement type should be blank').toBe('');
      console.log('  ✓ 3.1 Engagement type verified (blank)');
    });
