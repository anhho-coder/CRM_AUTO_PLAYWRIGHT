 ...
 * Test Case ID: CRM-2482_2.2.8.14
 *
 * Summary: Verify the Lead tab of a Investment record includes "Sales Team" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.8.14" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Sales Team" row = Sales_Team_Contact#1
 *
...
test.describe('CRM-2482_2.2.8.14 - Verify the Lead tab of a Investment record includes "Sales Team" field', () => {
  ...
  test('CRM-2482_2.2.8.14: Verify the Lead tab of a Investment record includes "Sales Team" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Sales Team = Sales_Team_Contact#1
    await test.step('Step 3: Verify "Sales Team" value in Leads tab equals Sales_Team_Contact#1', async () => {
      console.log('=== STEP 3: VERIFY SALES TEAM ===');

      const salesTeamText = await investmentPage.getLeadsFirstRowCellText('Sales Team');
      console.log(`  3.1 Sales Team actual  : "${salesTeamText}"`);
      console.log(`  3.1 Sales Team expected: "${audienceData.salesTeam}"`);
      expect(salesTeamText, 'Step 3.1: Sales Team should equal Sales_Team_Contact#1').toBe(audienceData.salesTeam);
      console.log('  ✓ 3.1 Sales Team verified');
    });
