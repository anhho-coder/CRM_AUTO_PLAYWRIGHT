 ...
 * Test Case ID: CRM-2482_2.2.8.12
 *
 * Summary: Verify the Lead tab of a Investment record includes "Expected Revenue Deal" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.8.12" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Expected Revenue Deal" row = 750.00
 *
...
test.describe('CRM-2482_2.2.8.12 - Verify the Lead tab of a Investment record includes "Expected Revenue Deal" field', () => {
  ...
  test('CRM-2482_2.2.8.12: Verify the Lead tab of a Investment record includes "Expected Revenue Deal" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Expected Revenue Deal = 750.00
    await test.step('Step 3: Verify "Expected Revenue Deal" value in Leads tab equals 750.00', async () => {
      console.log('=== STEP 3: VERIFY EXPECTED REVENUE DEAL ===');

      const expectedRevenueText = await investmentPage.getLeadsFirstRowCellText('Expected Revenue Deal');
      console.log(`  3.1 Expected Revenue Deal actual  : "${expectedRevenueText}"`);
      console.log(`  3.1 Expected Revenue Deal expected: "750.00"`);
      expect(expectedRevenueText, 'Step 3.1: Expected Revenue Deal should equal 750.00').toBe('750.00');
      console.log('  ✓ 3.1 Expected Revenue Deal verified');
    });
