 ...
 * Test Case ID: CRM-2482_2.2.8.13
 *
 * Summary: Verify the Lead tab of a Investment record includes "ER after probability" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.8.13" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "ER after probability" row = 37.50
 *
...
test.describe('CRM-2482_2.2.8.13 - Verify the Lead tab of a Investment record includes "ER after probability" field', () => {
  ...
  test('CRM-2482_2.2.8.13: Verify the Lead tab of a Investment record includes "ER after probability" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify ER after probability = 37.50
    await test.step('Step 3: Verify "ER after probability" value in Leads tab equals 37.50', async () => {
      console.log('=== STEP 3: VERIFY ER AFTER PROBABILITY ===');

      const erAfterProbText = await investmentPage.getLeadsFirstRowCellText('ER after probability');
      console.log(`  3.1 ER after probability actual  : "${erAfterProbText}"`);
      console.log(`  3.1 ER after probability expected: "37.50"`);
      expect(erAfterProbText, 'Step 3.1: ER after probability should equal 37.50').toBe('37.50');
      console.log('  ✓ 3.1 ER after probability verified');
    });
