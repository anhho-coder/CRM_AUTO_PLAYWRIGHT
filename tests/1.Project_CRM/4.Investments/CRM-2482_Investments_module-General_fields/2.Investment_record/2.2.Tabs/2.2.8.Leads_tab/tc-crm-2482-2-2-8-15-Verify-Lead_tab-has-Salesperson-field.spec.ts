 ...
 * Test Case ID: CRM-2482_2.2.8.15
 *
 * Summary: Verify the Lead tab of a Investment record includes "Salesperson" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.8.15" --project=chromium
 *
 * Pre-condition:
 ...
 *    3.1. Value at "Salesperson" row = Salesperson_Contact#1
 *
...
test.describe('CRM-2482_2.2.8.15 - Verify the Lead tab of a Investment record includes "Salesperson" field', () => {
  ...
  test('CRM-2482_2.2.8.15: Verify the Lead tab of a Investment record includes "Salesperson" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Verify Salesperson = Salesperson_Contact#1
    await test.step('Step 3: Verify "Salesperson" value in Leads tab equals Salesperson_Contact#1', async () => {
      console.log('=== STEP 3: VERIFY SALESPERSON ===');

      const salespersonText = await investmentPage.getLeadsFirstRowCellText('Salesperson');
      console.log(`  3.1 Salesperson actual  : "${salespersonText}"`);
      console.log(`  3.1 Salesperson expected: "${audienceData.salesperson}"`);
      expect(salespersonText, 'Step 3.1: Salesperson should equal Salesperson_Contact#1').toBe(audienceData.salesperson);
      console.log('  ✓ 3.1 Salesperson verified');
    });
