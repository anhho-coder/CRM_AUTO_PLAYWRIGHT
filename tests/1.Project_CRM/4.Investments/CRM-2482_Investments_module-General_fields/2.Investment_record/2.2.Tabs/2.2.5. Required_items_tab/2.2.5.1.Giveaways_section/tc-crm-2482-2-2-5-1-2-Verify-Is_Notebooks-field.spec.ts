 ...
 * Test Case ID: CRM-2482_2.2.5.1.2
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Notebooks" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.1.2" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Notebooks" field
 * 4. Verify "Is Notebooks" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.1.2 - Verify Required Items Tab includes Is Notebooks field', () => {
  ...
  test('CRM-2482_2.2.5.1.2: Verify the Required items tab of a Investment record includes "Is Notebooks" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Notebooks field
    await test.step('Step 3: Click at "Is Notebooks" field', async () => {
      console.log('=== STEP 3: CLICK "Is Notebooks" FIELD ===');

      await investmentPage.clickIsNotebooksField();

      console.log('✓ "Is Notebooks" field clicked');
    });

    // Step 4: Verify Is Notebooks field is a checkbox field
    await test.step('Step 4: Verify "Is Notebooks" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Notebooks" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsNotebooksField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Notebooks" field exists');
      console.log('  ✓ "Is Notebooks" field is a checkbox field');
      console.log('✓ Is Notebooks field verified successfully');
    });
