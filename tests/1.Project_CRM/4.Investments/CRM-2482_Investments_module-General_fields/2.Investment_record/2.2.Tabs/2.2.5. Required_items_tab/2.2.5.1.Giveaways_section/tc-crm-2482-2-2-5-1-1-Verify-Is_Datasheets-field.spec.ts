 ...
 * Test Case ID: CRM-2482_2.2.5.1.1
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Datasheets" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.1.1" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Datasheets" field
 * 4. Verify "Is Datasheets" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.1.1 - Verify Required Items Tab includes Is Datasheets field', () => {
  ...
  test('CRM-2482_2.2.5.1.1: Verify the Required items tab of a Investment record includes "Is Datasheets" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Datasheets field
    await test.step('Step 3: Click at "Is Datasheets" field', async () => {
      console.log('=== STEP 3: CLICK "Is Datasheets" FIELD ===');

      await investmentPage.clickIsDatasheetsField();

      console.log('✓ "Is Datasheets" field clicked');
    });

    // Step 4: Verify Is Datasheets field is a checkbox field
    await test.step('Step 4: Verify "Is Datasheets" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Datasheets" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsDatasheetsField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Datasheets" field exists');
      console.log('  ✓ "Is Datasheets" field is a checkbox field');
      console.log('✓ Is Datasheets field verified successfully');
    });
