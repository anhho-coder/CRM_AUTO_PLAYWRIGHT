 ...
 * Test Case ID: CRM-2482_2.2.5.1.3
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Pens" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.1.3" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Pens" field
 * 4. Verify "Is Pens" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.1.3 - Verify Required Items Tab includes Is Pens field', () => {
  ...
  test('CRM-2482_2.2.5.1.3: Verify the Required items tab of a Investment record includes "Is Pens" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Pens field
    await test.step('Step 3: Click at "Is Pens" field', async () => {
      console.log('=== STEP 3: CLICK "Is Pens" FIELD ===');

      await investmentPage.clickIsPensField();

      console.log('✓ "Is Pens" field clicked');
    });

    // Step 4: Verify Is Pens field is a checkbox field
    await test.step('Step 4: Verify "Is Pens" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Pens" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsPensField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Pens" field exists');
      console.log('  ✓ "Is Pens" field is a checkbox field');
      console.log('✓ Is Pens field verified successfully');
    });
