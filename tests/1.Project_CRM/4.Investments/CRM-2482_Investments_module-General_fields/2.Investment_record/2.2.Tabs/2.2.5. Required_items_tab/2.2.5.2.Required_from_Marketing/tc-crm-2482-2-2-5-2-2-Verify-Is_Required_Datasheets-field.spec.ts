 ...
 * Test Case ID: CRM-2482_2.2.5.2.2
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Required Datasheets" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.2.2" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Required Datasheets" field
 * 4. Verify "Is Required Datasheets" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.2.2 - Verify Required Items Tab includes Is Required Datasheets field', () => {
  ...
  test('CRM-2482_2.2.5.2.2: Verify the Required items tab of a Investment record includes "Is Required Datasheets" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Required Datasheets field
    await test.step('Step 3: Click at "Is Required Datasheets" field', async () => {
      console.log('=== STEP 3: CLICK "Is Required Datasheets" FIELD ===');

      await investmentPage.clickIsRequiredDatasheetsField();

      console.log('✓ "Is Required Datasheets" field clicked');
    });

    // Step 4: Verify Is Required Datasheets field is a checkbox field
    await test.step('Step 4: Verify "Is Required Datasheets" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Required Datasheets" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsRequiredDatasheetsField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Required Datasheets" field exists');
      console.log('  ✓ "Is Required Datasheets" field is a checkbox field');
      console.log('✓ Is Required Datasheets field verified successfully');
    });
