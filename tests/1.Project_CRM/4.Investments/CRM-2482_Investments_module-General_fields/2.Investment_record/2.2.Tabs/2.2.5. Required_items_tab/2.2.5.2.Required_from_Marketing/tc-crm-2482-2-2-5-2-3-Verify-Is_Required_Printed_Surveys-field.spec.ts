 ...
 * Test Case ID: CRM-2482_2.2.5.2.3
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Required Printed Surveys" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.2.3" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Required Printed Surveys" field
 * 4. Verify "Is Required Printed Surveys" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.2.3 - Verify Required Items Tab includes Is Required Printed Surveys field', () => {
  ...
  test('CRM-2482_2.2.5.2.3: Verify the Required items tab of a Investment record includes "Is Required Printed Surveys" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Required Printed Surveys field
    await test.step('Step 3: Click at "Is Required Printed Surveys" field', async () => {
      console.log('=== STEP 3: CLICK "Is Required Printed Surveys" FIELD ===');

      await investmentPage.clickIsRequiredPrintedSurveysField();

      console.log('✓ "Is Required Printed Surveys" field clicked');
    });

    // Step 4: Verify Is Required Printed Surveys field is a checkbox field
    await test.step('Step 4: Verify "Is Required Printed Surveys" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Required Printed Surveys" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsRequiredPrintedSurveysField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Required Printed Surveys" field exists');
      console.log('  ✓ "Is Required Printed Surveys" field is a checkbox field');
      console.log('✓ Is Required Printed Surveys field verified successfully');
    });
