 ...
 * Test Case ID: CRM-2482_2.2.5.2.1
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Required Rollup Banners" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.2.1" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Required Rollup Banners" field
 * 4. Verify "Is Required Rollup Banners" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.2.1 - Verify Required Items Tab includes Is Required Rollup Banners field', () => {
  ...
  test('CRM-2482_2.2.5.2.1: Verify the Required items tab of a Investment record includes "Is Required Rollup Banners" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Required Rollup Banners field
    await test.step('Step 3: Click at "Is Required Rollup Banners" field', async () => {
      console.log('=== STEP 3: CLICK "Is Required Rollup Banners" FIELD ===');

      await investmentPage.clickIsRequiredRollupBannersField();

      console.log('✓ "Is Required Rollup Banners" field clicked');
    });

    // Step 4: Verify Is Required Rollup Banners field is a checkbox field
    await test.step('Step 4: Verify "Is Required Rollup Banners" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Required Rollup Banners" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsRequiredRollupBannersField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Required Rollup Banners" field exists');
      console.log('  ✓ "Is Required Rollup Banners" field is a checkbox field');
      console.log('✓ Is Required Rollup Banners field verified successfully');
    });
