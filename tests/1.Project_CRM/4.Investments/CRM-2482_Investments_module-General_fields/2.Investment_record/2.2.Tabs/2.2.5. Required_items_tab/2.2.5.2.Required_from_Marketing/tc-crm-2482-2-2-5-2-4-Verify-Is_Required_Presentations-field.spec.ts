 ...
 * Test Case ID: CRM-2482_2.2.5.2.4
 *
 * Summary: Verify the Required items tab of a Investment record includes "Is Required Presentations" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.5.2.4" --project=chromium
 *
 * Pre-condition:
 ...
 * 3. Click at "Is Required Presentations" field
 * 4. Verify "Is Required Presentations" field is a checkbox field
 */

test.describe('CRM-2482_2.2.5.2.4 - Verify Required Items Tab includes Is Required Presentations field', () => {
  ...
  test('CRM-2482_2.2.5.2.4: Verify the Required items tab of a Investment record includes "Is Required Presentations" field', async ({ page }, testInfo) => {
    ...
    // Step 3: Click at Is Required Presentations field
    await test.step('Step 3: Click at "Is Required Presentations" field', async () => {
      console.log('=== STEP 3: CLICK "Is Required Presentations" FIELD ===');

      await investmentPage.clickIsRequiredPresentationsField();

      console.log('✓ "Is Required Presentations" field clicked');
    });

    // Step 4: Verify Is Required Presentations field is a checkbox field
    await test.step('Step 4: Verify "Is Required Presentations" field is a checkbox field', async () => {
      console.log('=== STEP 4: VERIFY "Is Required Presentations" FIELD ===');

      const isCheckboxFieldValid = await investmentPage.verifyIsRequiredPresentationsField();
      expect(isCheckboxFieldValid).toBeTruthy();

      console.log('  ✓ "Is Required Presentations" field exists');
      console.log('  ✓ "Is Required Presentations" field is a checkbox field');
      console.log('✓ Is Required Presentations field verified successfully');
    });
