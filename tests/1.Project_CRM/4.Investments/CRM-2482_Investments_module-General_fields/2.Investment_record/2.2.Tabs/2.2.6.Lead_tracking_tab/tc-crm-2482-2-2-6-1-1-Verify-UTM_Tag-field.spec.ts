 ...
 * Test Case ID: CRM-2482_2.2.6.1.1
 *
 * Summary: Verify the Lead tracking tab of a Investment record includes "UTM Tag" field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.2.6.1.1" --project=chromium
 *
 * Pre-condition:
 ...
 * 4. Click at "UTM Tag" field
 * 5. Verify "UTM Tag" field is a combobox field
 */

test.describe('CRM-2482_2.2.6.1.1 - Verify Lead Tracking Tab includes UTM Tag field', () => {
  ...
  test('CRM-2482_2.2.6.1.1: Verify the Lead tracking tab of a Investment record includes "UTM Tag" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Click at UTM Tag field
    await test.step('Step 4: Click at "UTM Tag" field', async () => {
      console.log('=== STEP 4: CLICK "UTM Tag" FIELD ===');

      await investmentPage.clickLeadTrackingUTMTagField();

      console.log('✓ "UTM Tag" field clicked');
    });

    // Step 5: Verify UTM Tag field is a combobox field
    await test.step('Step 5: Verify "UTM Tag" field is a combobox field', async () => {
      console.log('=== STEP 5: VERIFY "UTM Tag" FIELD ===');

      const isComboboxFieldValid = await investmentPage.verifyLeadTrackingUTMTagField();
      expect(isComboboxFieldValid).toBeTruthy();

      console.log('  ✓ "UTM Tag" field exists');
      console.log('  ✓ "UTM Tag" field is a combobox field');
      console.log('✓ UTM Tag field verified successfully');
    });
