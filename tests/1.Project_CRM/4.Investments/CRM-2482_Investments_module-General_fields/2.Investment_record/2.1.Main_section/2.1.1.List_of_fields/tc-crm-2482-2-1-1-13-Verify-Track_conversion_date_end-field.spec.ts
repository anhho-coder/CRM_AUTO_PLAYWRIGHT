 ...
 * Test Case ID: CRM-2482_2.1.1.13
 * 
 * Summary: Verify the main fields of a Investment record includes "Track conversion date end" field
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.1.1.13" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Track conversion date end" field is a Calendar field
 */

test.describe('CRM-2482_2.1.1.13 - Verify Track Conversion Date End Field', () => {
  ...
  test('CRM-2482_2.1.1.13: Verify the main fields of a Investment record includes "Track conversion date end" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Track conversion date end field
    await test.step('Step 4: Verify "Track conversion date end" field is a Calendar field', async () => {
      console.log('Step 4: Verifying "Track conversion date end" field');
      
      const isCalendarFieldValid = await investmentPage_MainSection.verifyTrackConversionDateEndField();
      expect(isCalendarFieldValid).toBeTruthy();
      
      console.log('  ✓ "Track conversion date end" field exists');
      console.log('  ✓ "Track conversion date end" field is a Calendar field');
      console.log('✓ Track conversion date end field verified successfully');
    });
