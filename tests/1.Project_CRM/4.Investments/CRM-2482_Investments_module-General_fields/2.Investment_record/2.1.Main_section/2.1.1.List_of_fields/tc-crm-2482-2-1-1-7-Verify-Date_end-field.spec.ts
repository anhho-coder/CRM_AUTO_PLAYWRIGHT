 ...
 * Test Case ID: CRM-2482_2.1.1.7
 * 
 * Summary: Verify the main fields of a Investment record includes "Date end" field
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.1.1.7" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Date end" field is a Calendar field
 */

test.describe('CRM-2482_2.1.1.7 - Verify Date end Field', () => {
  ...
  test('CRM-2482_2.1.1.7: Verify the main fields of a Investment record includes "Date end" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Date end field
    await test.step('Step 4: Verify "Date end" field is a Calendar field', async () => {
      console.log('Step 4: Verifying "Date end" field');
      
      const isCalendarFieldValid = await investmentPage_MainSection.verifyDateEndField();
      expect(isCalendarFieldValid).toBeTruthy();
      
      console.log('  ✓ "Date end" field exists');
      console.log('  ✓ "Date end" field is a Calendar field');
      console.log('✓ Date end field verified successfully');
    });
