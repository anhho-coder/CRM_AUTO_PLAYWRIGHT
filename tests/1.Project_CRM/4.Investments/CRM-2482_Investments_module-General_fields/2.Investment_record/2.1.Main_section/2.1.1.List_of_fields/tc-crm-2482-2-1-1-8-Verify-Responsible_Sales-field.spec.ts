 ...
 * Test Case ID: CRM-2482_2.1.1.8
 * 
 * Summary: Verify the main fields of a Investment record includes "Responsible - Sales" field
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.1.1.8" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Responsible - Sales" field is combobox field
 */

test.describe('CRM-2482_2.1.1.8 - Verify Responsible - Sales Field', () => {
  ...
  test('CRM-2482_2.1.1.8: Verify the main fields of a Investment record includes "Responsible - Sales" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Responsible - Sales field
    await test.step('Step 4: Verify "Responsible - Sales" field is a combobox field', async () => {
      console.log('Step 4: Verifying "Responsible - Sales" field');
      
      const isComboboxFieldValid = await investmentPage_MainSection.verifyResponsibleSalesField();
      expect(isComboboxFieldValid).toBeTruthy();
      
      console.log('  ✓ "Responsible - Sales" field exists');
      console.log('  ✓ "Responsible - Sales" field is a combobox');
      console.log('✓ Responsible - Sales field verified successfully');
    });
