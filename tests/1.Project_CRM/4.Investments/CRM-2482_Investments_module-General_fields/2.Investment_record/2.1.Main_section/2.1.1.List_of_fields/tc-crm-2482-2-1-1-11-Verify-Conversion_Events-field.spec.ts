 ...
 * Test Case ID: CRM-2482_2.1.1.11
 * 
 * Summary: Verify the main fields of a Investment record includes "Conversion Events" field
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.1.1.11" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Conversion Events" field is a multiple selections field
 */

test.describe('CRM-2482_2.1.1.11 - Verify Conversion Events Field', () => {
  ...
  test('CRM-2482_2.1.1.11: Verify the main fields of a Investment record includes "Conversion Events" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Conversion Events field
    await test.step('Step 4: Verify "Conversion Events" field is a multiple selections field', async () => {
      console.log('Step 4: Verifying "Conversion Events" field');
      
      const isMultiSelectFieldValid = await investmentPage_MainSection.verifyConversionEventsField();
      expect(isMultiSelectFieldValid).toBeTruthy();
      
      console.log('  ✓ "Conversion Events" field exists');
      console.log('  ✓ "Conversion Events" field is a multiple selections field');
      console.log('✓ Conversion Events field verified successfully');
    });
