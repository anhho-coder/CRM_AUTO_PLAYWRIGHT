 ...
 * Test Case ID: CRM-2482_2.1.1.6
 * 
 * Summary: Verify the main fields of a Investment record includes "Date start" field
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/4.Investments/CRM-2482_Investments_module-General_fields/2.Investment_record/2.1.Main_section/2.1.1.List_of_fields/tc-crm-2482-2-1-1-6-Verify-Date_start-field.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Date start" field is a Calendar field
 */

test.describe('CRM-2482_2.1.1.6 - Verify Date start Field', () => {
  ...
  test('CRM-2482_2.1.1.6: Verify the main fields of a Investment record includes "Date start" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Date start field
    await test.step('Step 4: Verify "Date start" field is a Calendar field', async () => {
      console.log('Step 4: Verifying "Date start" field');
      
      const isCalendarFieldValid = await investmentPage_MainSection.verifyDateStartField();
      expect(isCalendarFieldValid).toBeTruthy();
      
      console.log('  ✓ "Date start" field exists');
      console.log('  ✓ "Date start" field is a Calendar field');
      console.log('✓ Date start field verified successfully');
    });
