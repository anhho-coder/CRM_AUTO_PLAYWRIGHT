 ...
 * Test Case ID: CRM-2482_2.1.1.1
 * 
 * Summary: Verify the main fields of a Investment record includes "Investment Name" field
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/4.Investments/CRM-2482_Investments_module-General_fields/2.Investment_record/2.1.Main_section/2.1.1.List_of_fields/tc-crm-2482-1-1-1-create-edit-activity-type.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Investment Name" field is a text field
 */

test.describe('CRM-2482_2.1.1.1 - Verify Investment Name Field', () => {
  ...
  test('CRM-2482_2.1.1.1: Verify the main fields of a Investment record includes "Investment Name" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Investment Name field
    await test.step('Step 4: Verify "Investment Name" field is a text field', async () => {
      console.log('Step 4: Verifying "Investment Name" field');
      
      const isTextFieldValid = await investmentPage_MainSection.verifyInvestmentNameField();
      expect(isTextFieldValid).toBeTruthy();
      
      console.log('  ✓ "Investment Name" field exists');
      console.log('  ✓ "Investment Name" field is a text input');
      console.log('✓ Investment Name field verified successfully');
    });
