 ...
 * Test Case ID: CRM-2482_2.1.1.4
 * 
 * Summary: Verify the main fields of a Investment record includes "Countries" field
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/4.Investments/CRM-2482_Investments_module-General_fields/2.Investment_record/2.1.Main_section/2.1.1.List_of_fields/tc-crm-2482-2-1-1-4-Verify-Countries-field.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Countries" field is a combobox field
 */

test.describe('CRM-2482_2.1.1.4 - Verify Countries Field', () => {
  ...
  test('CRM-2482_2.1.1.4: Verify the main fields of a Investment record includes "Countries" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Countries field
    await test.step('Step 4: Verify "Countries" field is a combobox field', async () => {
      console.log('Step 4: Verifying "Countries" field');
      
      const isComboboxFieldValid = await investmentPage_MainSection.verifyCountriesField();
      expect(isComboboxFieldValid).toBeTruthy();
      
      console.log('  ✓ "Countries" field exists');
      console.log('  ✓ "Countries" field is a combobox');
      console.log('✓ Countries field verified successfully');
    });
