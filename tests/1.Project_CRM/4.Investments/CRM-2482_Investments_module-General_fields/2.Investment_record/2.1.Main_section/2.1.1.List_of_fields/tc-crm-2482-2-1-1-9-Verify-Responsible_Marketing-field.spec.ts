 ...
 * Test Case ID: CRM-2482_2.1.1.9
 * 
 * Summary: Verify the main fields of a Investment record includes "Responsible - Marketing" field
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.1.1.9" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Responsible - Marketing" field is a combobox field
 */

test.describe('CRM-2482_2.1.1.9 - Verify Responsible - Marketing Field', () => {
  ...
  test('CRM-2482_2.1.1.9: Verify the main fields of a Investment record includes "Responsible - Marketing" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Responsible - Marketing field
    await test.step('Step 4: Verify "Responsible - Marketing" field is a combobox field', async () => {
      console.log('Step 4: Verifying "Responsible - Marketing" field');
      
      const isComboboxFieldValid = await investmentPage_MainSection.verifyResponsibleMarketingField();
      expect(isComboboxFieldValid).toBeTruthy();
      
      console.log('  ✓ "Responsible - Marketing" field exists');
      console.log('  ✓ "Responsible - Marketing" field is a combobox');
      console.log('✓ Responsible - Marketing field verified successfully');
    });
