 ...
 * Test Case ID: CRM-2482_2.1.1.2
 * 
 * Summary: Verify the main fields of a Investment record includes "Investment ID" field
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/4.Investments/CRM-2482_Investments_module-General_fields/2.Investment_record/2.1.Main_section/2.1.1.List_of_fields/tc-crm-2482-2-1-1-2-Verify-Investment_ID-field.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Investment ID" field is a text field
 */

test.describe('CRM-2482_2.1.1.2 - Verify Investment ID Field', () => {
  ...
  test('CRM-2482_2.1.1.2: Verify the main fields of a Investment record includes "Investment ID" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Investment ID field
    await test.step('Step 4: Verify "Investment ID" field is a text field', async () => {
      console.log('Step 4: Verifying "Investment ID" field');
      
      const isTextFieldValid = await investmentPage_MainSection.verifyInvestmentIDField();
      expect(isTextFieldValid).toBeTruthy();
      
      console.log('  ✓ "Investment ID" field exists');
      console.log('  ✓ "Investment ID" field is a text input');
      console.log('✓ Investment ID field verified successfully');
    });
