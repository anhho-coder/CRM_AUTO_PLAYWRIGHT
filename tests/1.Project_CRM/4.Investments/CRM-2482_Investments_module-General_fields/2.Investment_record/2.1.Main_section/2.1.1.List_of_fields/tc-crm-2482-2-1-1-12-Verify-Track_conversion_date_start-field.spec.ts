 ...
 * Test Case ID: CRM-2482_2.1.1.12
 * 
 * Summary: Verify the main fields of a Investment record includes "Track conversion date start" field
 * 
 * Command to run:
 * npx playwright test --grep "CRM-2482_2.1.1.12" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Track conversion date start" field is a Calendar field
 */

test.describe('CRM-2482_2.1.1.12 - Verify Track Conversion Date Start Field', () => {
  ...
  test('CRM-2482_2.1.1.12: Verify the main fields of a Investment record includes "Track conversion date start" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Track conversion date start field
    await test.step('Step 4: Verify "Track conversion date start" field is a Calendar field', async () => {
      console.log('Step 4: Verifying "Track conversion date start" field');
      
      const isCalendarFieldValid = await investmentPage_MainSection.verifyTrackConversionDateStartField();
      expect(isCalendarFieldValid).toBeTruthy();
      
      console.log('  ✓ "Track conversion date start" field exists');
      console.log('  ✓ "Track conversion date start" field is a Calendar field');
      console.log('✓ Track conversion date start field verified successfully');
    });
