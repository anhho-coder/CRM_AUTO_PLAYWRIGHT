 ...
 * Test Case ID: CRM-2482_2.1.1.3
 * 
 * Summary: Verify the main fields of a Investment record includes "Channel" field
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/4.Investments/CRM-2482_Investments_module-General_fields/2.Investment_record/2.1.Main_section/2.1.1.List_of_fields/tc-crm-2482-2-1-1-3-Verify-Channel-field.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 * 2. Verify "Channel" field is a combobox field
 */

test.describe('CRM-2482_2.1.1.3 - Verify Channel Field', () => {
  ...
  test('CRM-2482_2.1.1.3: Verify the main fields of a Investment record includes "Channel" field', async ({ page }, testInfo) => {
    ...
    // Step 4: Verify Channel field
    await test.step('Step 4: Verify "Channel" field is a combobox field', async () => {
      console.log('Step 4: Verifying "Channel" field');
      
      const isComboboxFieldValid = await investmentPage_MainSection.verifyChannelField();
      expect(isComboboxFieldValid).toBeTruthy();
      
      console.log('  ✓ "Channel" field exists');
      console.log('  ✓ "Channel" field is a combobox');
      console.log('✓ Channel field verified successfully');
    });
