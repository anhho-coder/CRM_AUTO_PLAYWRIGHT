...
/**
 * Investments - Track Conversion Date Start Auto-update Test
 * Test Case ID: CRM-3326_2.1.1
 *
...
test.describe('CRM-3326_2.1.1 - Verify Track conversion date start equals Date start when updating Investment', () => {
  ...
  test('CRM-3326_2.1.1: Verify Track conversion date start is set equal to Date start when updating Investment', async ({ page }) => {
