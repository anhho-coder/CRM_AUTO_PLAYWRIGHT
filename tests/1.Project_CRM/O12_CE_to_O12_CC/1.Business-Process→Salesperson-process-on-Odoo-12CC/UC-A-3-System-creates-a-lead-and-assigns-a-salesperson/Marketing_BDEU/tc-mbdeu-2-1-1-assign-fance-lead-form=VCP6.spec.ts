 ...
 *    - "Lead form" textbox = VCP6.5-DCV Study Guide
 * 6. Press "SAVE" button
...
test.describe('TC.-A.3.MBDEU.1 - Marketing BDEU Team Assignment for Afghanistan with Lead Form "VCP6.5-DCV Study Guide"', () => {
  ...
  test('TC.-A.3.MBDEU.1: CRM-9305: Verify the lead is assigned to Marketing - BDEU team if Lead Form="VCP6.5-DCV Study Guide", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 5: Fill Lead Form in CRM Developer tab', async () => {
      ...
      await leadPage.fillLeadForm('VCP6.5-DCV Study Guide');
      console.log(`  - Lead Form: VCP6.5-DCV Study Guide`);
    ...
    await test.step('Verification: Confirm Sales Team is Marketing - BDEU and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - Marketing BDEU Team Assignment (Afghanistan with Lead Form "VCP6.5-DCV Study Guide")`);
      ...
      console.log('   Lead with Afghanistan, Lead Form="VCP6.5-DCV Study Guide"');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Afghanistan, Lead Form="VCP6.5-DCV Study Guide"<br>
