 ...
 * 5. Press "SAVE" button
 * 6. Wait for at least 4 minutes until "Sales Team" dropdown list and "Salesperson" dropdown list fulfilled
 * 
...
test.describe('TC.-A.3.IBSA.2 - IBSA Team Assignment for Italy with Tags "Nakivo Customer" (No Email)', () => {
  ...
  test('TC.-A.3.IBSA.2: Verify the lead is assigned to IBSA team if Tags="Nakivo Customer", no email, Country=Italy', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      console.log('Step 4.1: Clicking CREATE button');
      
      await leadPage.clickCreate();
      
      console.log('✓ Lead creation form opened');
      
      console.log('Step 4.2: Entering lead information');
    ...
    let leadId: string;
    await test.step('Step 7: Save the lead (first save)', async () => {
      console.log('Step 7: Saving the lead (first save)');
    ...
    await test.step('Verification: Confirm Sales Team is IBSA and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - IBSA Team Assignment (Italy with Tags "Nakivo Customer", No Email)`);
      ...
      console.log('   Lead with Italy, Tags="Nakivo Customer", and');
      console.log('   no email correctly assigned to IBSA team');
      console.log('==================================================\n');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Italy, Tags="Nakivo Customer", and<br>
        no email correctly assigned to IBSA team
      </div>
    </div>
  </div>
</body>
