 ...
 * 
 * Command to run:
 * npx playwright test --grep "TC\.THD_3\.2\.1\.5\.2 -" --project=chromium
 * 
 * Pre-condition:
 ...
 * 8. Wait for at least 4 minutes until "Sales Team" dropdown list and "Salesperson" dropdown list fulfilled
 * 
...
test.describe('TC.THD_3.2.1.5.2 - THD Team Assignment for India (State Blank) with Nakivo Customer = TRUE and Partner = TRUE', () => {
  ...
  test('TC.THD_3.2.1.5.2: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Partner = TRUE, Country = India and State is blank', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.2.1.5.2');
      ...
      // State is left BLANK (not selected)
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (India-State Blank with Nakivo Customer = TRUE, Partner = TRUE)`);
      ...
      console.log('   Lead with India-State Blank, Nakivo Customer = TRUE, Partner = TRUE');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.2.1.5.2</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with India-State Blank, Nakivo Customer = TRUE, Partner = TRUE<br>
