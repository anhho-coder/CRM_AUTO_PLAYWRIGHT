...
test.describe('TC.-A.3.THD.1 - THD Team Assignment for Malaysia with Nakivo Customer = NOT True', () => {
  ...
  test('TC.-A.3.THD.1: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = Malaysia', async ({ page }, testInfo) => {
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Malaysia with Nakivo Customer = NOT True)`);
      ...
      console.log('   Lead with Malaysia, Nakivo Customer = NOT True');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Malaysia, Nakivo Customer = NOT True<br>
