 ...
 *
 * Command to run:
 * npx playwright test --grep "TC\.-A\.3\.BDEU\.1:" --project=chromium
 *
 * Run all Smoke tests:
...
test.describe('TC.-A.3.BDEU.1 - Salesperson Assignment to Thomas Semerich @smoke-test', () => {
  ...
  test('TC.-A.3.BDEU.1: Verify the lead is assigned to Thomas Semerich belong to BDEU team @smoke-test', async ({ page }, testInfo) => {
    ...
    // Step 8: Wait for Salesperson auto-assignment (4 minutes)
    await test.step('Step 8: Wait for Salesperson auto-assignment (4 minutes)', async () => {
