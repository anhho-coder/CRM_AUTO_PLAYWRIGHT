 ...
 * 
 * Command to run:
 * npx playwright test --grep "TC\.-A\.3\.BDEU\.3:" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.-A.3.BDEU.3 - BDEU Team Exclusion for VCP-DCV vSphere 7 Study Guide', () => {
  ...
  test('TC.-A.3.BDEU.3: Verify the lead is NOT assigned to BDEU team if Lead form = VCP-DCV vSphere 7 Community Study Guide*', async ({ page }, testInfo) => {
