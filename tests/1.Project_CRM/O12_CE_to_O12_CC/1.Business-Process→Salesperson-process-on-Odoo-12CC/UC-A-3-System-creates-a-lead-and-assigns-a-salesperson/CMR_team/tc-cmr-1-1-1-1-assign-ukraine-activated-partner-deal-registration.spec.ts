 ...
 *    - "Lead form" textbox = NAKIVO deal registration*
 * 6. Press "SAVE" button
...
test.describe('TC.-A.3.CMR.1 - CMR Team Assignment for Ukraine with Activated Partner @smoke-test', () => {
  ...
  test('TC.-A.3.CMR.1: Verify the lead is assigned to CMR team if Country=Ukraine, Activated Partner=TRUE, Nakivo Customer=FALSE, Lead Form=NAKIVO deal registration* @smoke-test', async ({ page }, testInfo) => {
    ...
    await test.step('Step 5: Fill CRM Developer tab', async () => {
      ...
      const leadFormFilled = await leadPage.fillLeadForm('NAKIVO deal registration*');
      console.log(`  - Lead Form: ${leadFormFilled ? 'NAKIVO deal registration*' : 'Field not found in CRM Developer tab, skipping'}`);
    ...
    await test.step('Verification: Confirm Sales Team is CMR and Salesperson is assigned', async () => {
      ...
      await testInfo.attach(`Lead ${leadId} - CMR Team Assignment (Ukraine with Activated Partner)`, {
        body: screenshot,
        contentType: 'image/png'
      });
      ...
      console.log('   Lead with Ukraine, Activated Partner=TRUE, and');
      console.log('   NAKIVO deal registration* correctly assigned to CMR team');
      console.log('==================================================\n');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Ukraine, Activated Partner=TRUE, and<br>
        NAKIVO deal registration* correctly assigned to CMR team
      </div>
    </div>
  </div>
</body>
