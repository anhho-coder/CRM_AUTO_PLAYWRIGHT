...
test.describe('TC.-A.3.EAM.1 - EAM Team Assignment for End User to Bilal Saab', () => {
  ...
  test('TC.-A.3.EAM.1: Verify the lead is assigned to Bilal belong to EAM team if End User. Salesperson = Bilal', async ({ page }, testInfo) => {
    ...
    await test.step('Pre-condition Step 4: Fill contact information', async () => {
      ...
      contactName = `TEST-ContactTC.-A.3.EAM.1${year}${month}${day}${hours}${minutes}${seconds}${milliseconds}`;
