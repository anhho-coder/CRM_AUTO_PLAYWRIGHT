 ...
 * 2. Create Lead#1 and convert it to Opportunity#1 (this establishes the duplicate Opportunity):
 *       Lead#1:
 *          - name              = "TEST Lead 1 <TC ID>"
 *          - Company Name      = Company Name Lead 1
 *          - Company email     = X
 *       Opportunity#1 (conversion wizard):
 *          - Conversion Action = Convert to opportunity
 *          - Sales Team        = CMR
 *          - Salesperson       = Sergey Karachin
 *          - Customers         = Link to an existing customer
 * 3. Create Lead#2 using the SAME Company email X:
 *       - name          = "TEST Lead 2 <TC ID>"
 *       - Company Name  = Company Name Lead 2
 *       - Company email = X (same as Lead#1)
 ...
 * 9. On "Assign this opportunity to" section, set:
 *       - Sales Team  = CMR
 *       - Salesperson = Sergey Karachin
