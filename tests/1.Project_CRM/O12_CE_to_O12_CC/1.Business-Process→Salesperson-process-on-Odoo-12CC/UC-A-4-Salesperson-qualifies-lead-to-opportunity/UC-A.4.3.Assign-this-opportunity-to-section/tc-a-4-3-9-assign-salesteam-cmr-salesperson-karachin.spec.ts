...
test.describe('TC.-A.4.3.9 - Convert Lead to Opportunity assigning the CMR team Salesperson/Sales Team (salesteam.users)', () => {
  ...
  test(`TC.-A.4.3.9: Verify converting a qualified lead to Opportunity assigning Sales Team = ${sp.team} and Salesperson = ${sp.displayName} is successful`, async ({ page }, testInfo) => {
