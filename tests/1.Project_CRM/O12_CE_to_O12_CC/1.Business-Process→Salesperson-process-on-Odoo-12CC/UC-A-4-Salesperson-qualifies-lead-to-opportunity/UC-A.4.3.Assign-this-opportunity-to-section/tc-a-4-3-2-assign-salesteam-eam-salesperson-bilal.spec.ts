...
test.describe('TC.-A.4.3.2 - Convert Lead to Opportunity assigning the EAM team Salesperson/Sales Team (salesteam.users)', () => {
  ...
  test.skip(`TC.-A.4.3.2: Verify converting a qualified lead to Opportunity assigning Sales Team = ${sp.team} and Salesperson = ${sp.displayName} is successful [CRM-11410]`, async ({ page }, testInfo) => {
