 ...
 *    1-19. Login as Thomas; CRM > view list > CREATE; enter the Opportunity fields below;
 *          CRM Developer Lead form; set the Assigned Partner below; Internal Note #1; SAVE
 *          (capture Opp URL #1); refresh + verify Contact; build the DEAL ELEMENT below;
 *          SAVE; NEW QUOTATION; CONFIRM (Sales Order); CREATE INVOICE; CREATE AND VIEW
 *          INVOICES; remember Invoice Number #1; VALIDATE.
 *          Opportunity:
 *            - Opp / Contact / Company / Email / Country / State / IP
