 ...
 *          and capture Opp URL #1; build the DEAL ELEMENT below; SAVE; NEW QUOTATION; CONFIRM
 *          (Sales Order); CREATE INVOICE; CREATE AND VIEW INVOICES; remember Invoice Number #1;
 *          VALIDATE (capture the backend Invoice/Due dates).
 *          Opportunity:
