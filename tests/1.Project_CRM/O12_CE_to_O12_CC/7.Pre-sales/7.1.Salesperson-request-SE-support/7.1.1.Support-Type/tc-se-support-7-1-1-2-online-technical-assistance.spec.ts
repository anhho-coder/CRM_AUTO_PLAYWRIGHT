...
/**
 * ============================================================================================
 *  pre-sale-7.1.1.2 - Salesperson requests SE support with Support type = Online technical assistance
 * --------------------------------------------------------------------------------------------
 *  Test Case ID:    pre-sale-7.1.1.2
 *  Jira:            (none - authored from an inline manual TC)
 *  Automation-Type: new
 *  Automation-Date: 2026-07-28
 * --------------------------------------------------------------------------------------------
 *  Summary:
 *    Verify the Salesperson can select Support type = Online technical assistance when requesting SE support.
 *
 *  Command to run:
 *    npx playwright test --grep "pre-sale-7\.1\.1\.2:" --project=chromium
 * ============================================================================================
 *
...
const TC_ID = 'pre-sale-7.1.1.2';
const SUPPORT_TYPE = 'Online technical assistance';

test.describe('pre-sale-7.1.1.2 - Salesperson requests SE support (Support type = Online technical assistance)', () => {
  ...
  test('pre-sale-7.1.1.2: Verify the Salesperson can select Support type = Online technical assistance', async ({ page }, testInfo) => {
