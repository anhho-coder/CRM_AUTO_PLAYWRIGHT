...
test.describe(`${TC} - Partner discounts default`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.16');
  });

  test('CRM-12370_1.4.16: Verify both partner discount rows stay at 0.00 when the Opportunity carries no partner', async ({ page }, testInfo) => {
