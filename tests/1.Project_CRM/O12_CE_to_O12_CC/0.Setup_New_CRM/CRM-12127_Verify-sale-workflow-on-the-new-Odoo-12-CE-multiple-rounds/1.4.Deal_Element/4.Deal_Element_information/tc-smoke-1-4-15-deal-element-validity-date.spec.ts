...
test.describe(`${TC} - Validity date`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.15');
  });

  test('CRM-12370_1.4.15: Verify the Validity date is filled automatically 30 days after the creation day', async ({ page }, testInfo) => {
