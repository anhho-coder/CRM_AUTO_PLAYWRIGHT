...
test.describe(`${TC} - Payer follows the Distributor`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.12');
  });

  test('CRM-12370_1.4.12: Verify the Payer, the Invoice Address and the Delivery Address follow the Distributor', async ({ page }, testInfo) => {
