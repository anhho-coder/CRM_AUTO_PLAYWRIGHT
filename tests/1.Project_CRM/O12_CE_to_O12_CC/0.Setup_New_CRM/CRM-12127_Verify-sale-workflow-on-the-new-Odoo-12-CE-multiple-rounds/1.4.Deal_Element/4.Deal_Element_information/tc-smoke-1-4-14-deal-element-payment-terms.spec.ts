...
test.describe(`${TC} - Payment Terms`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.14');
  });

  test('CRM-12370_1.4.14: Verify the Payment Term selected before SAVE is the one the saved Deal Element carries', async ({ page }, testInfo) => {
