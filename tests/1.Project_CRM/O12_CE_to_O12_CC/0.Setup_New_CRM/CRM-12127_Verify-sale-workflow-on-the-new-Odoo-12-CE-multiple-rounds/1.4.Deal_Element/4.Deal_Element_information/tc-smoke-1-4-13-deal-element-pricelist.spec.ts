...
test.describe(`${TC} - Pricelist`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.13');
  });

  test('CRM-12370_1.4.13: Verify the Pricelist selected before SAVE is the one the saved Deal Element carries', async ({ page }, testInfo) => {
