...
test.describe(`${TC} - Total in Company Currency`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.17');
  });

  test('CRM-12370_1.4.17: Verify the Total in Company Currency matches the order line of the Deal Element', async ({ page }, testInfo) => {
