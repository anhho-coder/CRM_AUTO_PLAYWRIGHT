...
test.describe(`${TC} - Order line subtotals`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.23');
  });

  test('CRM-12370_1.4.23: Verify the three subtotal columns of the order line all report Unit Price x Ordered Qty', async ({ page }, testInfo) => {
