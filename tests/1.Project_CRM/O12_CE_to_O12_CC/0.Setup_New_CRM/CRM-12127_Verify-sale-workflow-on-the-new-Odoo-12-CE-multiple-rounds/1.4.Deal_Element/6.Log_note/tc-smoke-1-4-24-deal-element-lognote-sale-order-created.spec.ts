...
test.describe(`${TC} - Log note - Sale Order created`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.24');
  });

  test('CRM-12370_1.4.24: Verify the creation of a Deal Element writes the Sale Order created note', async ({ page }, testInfo) => {
