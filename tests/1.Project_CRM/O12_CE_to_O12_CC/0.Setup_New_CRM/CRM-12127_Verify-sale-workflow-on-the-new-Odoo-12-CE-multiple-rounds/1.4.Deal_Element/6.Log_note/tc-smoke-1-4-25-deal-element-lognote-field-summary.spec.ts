...
test.describe(`${TC} - Log note - creation summary`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.4.25');
  });

  test('CRM-12370_1.4.25: Verify the creation summary note reports the same values as the Deal Element', async ({ page }, testInfo) => {
