 ...
 *          - Opp name    = TEST CRM-12370_1.5.34 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.34:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.34';
...
test.describe(`${TC} - Summary log note of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.34');
  });
