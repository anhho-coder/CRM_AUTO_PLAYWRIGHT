 ...
 *          - Opp name    = TEST CRM-12370_1.5.35 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.5\.35:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.35';
...
test.describe(`${TC} - Stages the Quotation statusbar offers`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.35');
  });
