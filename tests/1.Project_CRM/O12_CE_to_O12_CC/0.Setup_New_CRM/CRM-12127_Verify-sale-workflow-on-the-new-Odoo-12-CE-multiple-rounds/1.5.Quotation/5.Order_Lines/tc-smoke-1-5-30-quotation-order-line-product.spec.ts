 ...
 *          - Opp name    = TEST CRM-12370_1.5.30 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.30:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.30';
...
test.describe(`${TC} - Order line of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.30');
  });
