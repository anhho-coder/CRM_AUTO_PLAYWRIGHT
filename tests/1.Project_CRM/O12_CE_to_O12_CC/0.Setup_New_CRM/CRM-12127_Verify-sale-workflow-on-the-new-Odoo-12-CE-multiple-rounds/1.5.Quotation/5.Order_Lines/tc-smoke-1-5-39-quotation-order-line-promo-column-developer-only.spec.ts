 ...
 *          - Opp name    = TEST CRM-12370_1.5.39 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.5\.39:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.39';
...
/** What a NORMAL session shows - see CRM-12370_1.5.29. */
...
test.describe(`${TC} - Promo Discount Amount is a developer-only Order Lines column`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.39');
  });
