 ...
 *          - Opp name    = TEST CRM-12370_1.5.12 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.5\.12:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.12';
...
test.describe(`${TC} - Duplicate button on the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.12');
  });
