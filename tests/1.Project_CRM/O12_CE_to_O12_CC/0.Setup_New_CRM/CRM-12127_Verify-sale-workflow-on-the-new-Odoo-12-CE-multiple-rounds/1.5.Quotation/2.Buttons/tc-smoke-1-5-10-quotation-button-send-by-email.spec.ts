 ...
 *          - Opp name    = TEST CRM-12370_1.5.10 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.10:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.10';
...
test.describe(`${TC} - SEND BY EMAIL button on the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.10');
  });
