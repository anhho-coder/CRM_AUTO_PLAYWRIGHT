 ...
 *          - Opp name    = TEST CRM-12370_1.5.38 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.5\.38:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.38';
...
test.describe(`${TC} - Addresses of a distributor deal follow the Distributor`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.38');
  });
