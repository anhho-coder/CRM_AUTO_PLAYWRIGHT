 ...
 *          - Opp name    = TEST CRM-12370_1.5.23 <timestamp>
...
test.describe(`${TC} - Payment Terms of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.23');
  });
