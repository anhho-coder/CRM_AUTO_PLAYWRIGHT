 ...
 *          - Opp name    = TEST CRM-12370_1.5.27 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.5\.27:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.27';
...
test.describe(`${TC} - Checkbox defaults of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.27');
  });
