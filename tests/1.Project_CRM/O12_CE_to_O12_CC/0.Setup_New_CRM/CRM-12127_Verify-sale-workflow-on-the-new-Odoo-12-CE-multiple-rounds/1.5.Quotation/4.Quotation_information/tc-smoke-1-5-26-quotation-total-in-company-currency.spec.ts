 ...
 *          - Opp name    = TEST CRM-12370_1.5.26 <timestamp>
 ...
 *   - Total in Company Currency is a developer-only field (see CRM-12370_1.5.37), so this TC has to
...
test.describe(`${TC} - Total in Company Currency of a foreign-currency Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.26');
  });
