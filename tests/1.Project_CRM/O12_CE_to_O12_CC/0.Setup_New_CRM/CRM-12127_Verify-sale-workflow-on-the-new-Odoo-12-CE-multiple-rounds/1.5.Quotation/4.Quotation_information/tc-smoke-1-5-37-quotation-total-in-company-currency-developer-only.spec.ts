 ...
 *          - Opp name    = TEST CRM-12370_1.5.37 <timestamp>
...
/** What a NORMAL session shows - see CRM-12370_1.5.15. */
...
test.describe(`${TC} - Total in Company Currency is a developer-only field`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.5.37');
  });
