...
test.describe(`${TC} - Log note - Sale Order created`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.6.1');
  });

  test('CRM-12370_4.6.1: Verify the creation of a Deal Element writes the Sale Order created note', async ({ page }, testInfo) => {
