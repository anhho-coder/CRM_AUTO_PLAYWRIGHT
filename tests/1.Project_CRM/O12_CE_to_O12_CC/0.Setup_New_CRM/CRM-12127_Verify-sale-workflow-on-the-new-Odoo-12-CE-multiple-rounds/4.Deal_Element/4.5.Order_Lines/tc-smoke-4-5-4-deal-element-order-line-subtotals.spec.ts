...
test.describe(`${TC} - Order line subtotals`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.5.4');
  });

  test('CRM-12370_4.5.4: Verify the three subtotal columns of the order line all report Unit Price x Ordered Qty', async ({ page }, testInfo) => {
