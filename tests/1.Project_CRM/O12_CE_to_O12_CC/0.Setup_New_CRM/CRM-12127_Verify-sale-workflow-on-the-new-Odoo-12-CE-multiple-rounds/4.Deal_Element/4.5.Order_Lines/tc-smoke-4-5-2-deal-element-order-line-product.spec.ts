...
test.describe(`${TC} - Order line product`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.5.2');
  });

  test('CRM-12370_4.5.2: Verify the single order line carries the added product, its description, Qty 1 and Socket', async ({ page }, testInfo) => {
