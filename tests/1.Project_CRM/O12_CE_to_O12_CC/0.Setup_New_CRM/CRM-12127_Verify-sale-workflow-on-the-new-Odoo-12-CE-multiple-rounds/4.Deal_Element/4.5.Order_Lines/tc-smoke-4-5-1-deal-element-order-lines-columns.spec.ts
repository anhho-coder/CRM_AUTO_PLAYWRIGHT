 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.4\.20:" --project=MigSmoke
 */

const TC = 'CRM-12370_4.5.1';
...
test.describe(`${TC} - Order Lines columns`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.5.1');
  });

  test('CRM-12370_4.5.1: Verify the columns of the Order Lines list and their order', async ({ page }, testInfo) => {
