...
test.describe(`${TC} - Order line discount columns`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.5.3');
  });

  test('CRM-12370_4.5.3: Verify every discount column of the order line reads 0.00 when no discount applies', async ({ page }, testInfo) => {
