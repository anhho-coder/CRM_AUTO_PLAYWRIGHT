...
test.describe(`${TC} - Payment Terms`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.8');
  });

  test('CRM-12370_4.4.8: Verify the Payment Term selected before SAVE is the one the saved Deal Element carries', async ({ page }, testInfo) => {
