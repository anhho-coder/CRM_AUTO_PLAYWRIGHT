...
test.describe(`${TC} - Empty fields on creation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.13');
  });

  test('CRM-12370_4.4.13: Verify the fields a newly created Deal Element leaves empty', async ({ page }, testInfo) => {
