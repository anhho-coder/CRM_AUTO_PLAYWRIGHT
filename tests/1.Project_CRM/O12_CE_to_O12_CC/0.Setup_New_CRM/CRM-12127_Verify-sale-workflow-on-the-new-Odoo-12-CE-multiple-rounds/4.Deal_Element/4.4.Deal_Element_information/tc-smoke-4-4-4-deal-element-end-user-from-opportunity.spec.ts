...
test.describe(`${TC} - End User from the Opportunity`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.4');
  });

  test('CRM-12370_4.4.4: Verify the End User is filled and matches the Company of the Opportunity', async ({ page }, testInfo) => {
