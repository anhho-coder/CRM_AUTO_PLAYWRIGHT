...
test.describe(`${TC} - Payer follows the Distributor`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.6');
  });

  test('CRM-12370_4.4.6: Verify the Payer, the Invoice Address and the Delivery Address follow the Distributor', async ({ page }, testInfo) => {
