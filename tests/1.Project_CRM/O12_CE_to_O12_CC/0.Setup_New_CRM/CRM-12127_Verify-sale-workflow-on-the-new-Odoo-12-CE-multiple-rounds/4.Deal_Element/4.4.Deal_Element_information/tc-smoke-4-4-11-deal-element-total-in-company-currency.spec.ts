...
test.describe(`${TC} - Total in Company Currency`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.11');
  });

  test('CRM-12370_4.4.11: Verify the Total in Company Currency matches the order line of the Deal Element', async ({ page }, testInfo) => {
