...
test.describe(`${TC} - Reseller and Distributor from the Opportunity`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.5');
  });

  test('CRM-12370_4.4.5: Verify the Reseller and the Distributor are filled and match the Opportunity', async ({ page }, testInfo) => {
