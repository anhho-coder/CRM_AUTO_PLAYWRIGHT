...
test.describe(`${TC} - Payer from the Opportunity`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.4.1');
  });

  test('CRM-12370_4.4.1: Verify the Payer is filled and matches the Company of the Opportunity', async ({ page }, testInfo) => {
