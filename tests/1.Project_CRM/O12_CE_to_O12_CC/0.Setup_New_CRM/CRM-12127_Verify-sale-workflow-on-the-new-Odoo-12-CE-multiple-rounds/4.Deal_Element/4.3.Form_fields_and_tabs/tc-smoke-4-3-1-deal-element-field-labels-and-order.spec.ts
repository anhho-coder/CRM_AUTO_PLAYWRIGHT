 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.4\.5:" --project=MigSmoke
 */

const TC = 'CRM-12370_4.3.1';
...
test.describe(`${TC} - Field names and order of the information area`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.3.1');
  });

  test('CRM-12370_4.3.1: Verify the field names and their order in the Deal Element information area', async ({ page }, testInfo) => {
