...
test.describe(`${TC} - Notebook tabs`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.3.2');
  });

  test('CRM-12370_4.3.2: Verify the notebook tabs of the Deal Element and their order', async ({ page }, testInfo) => {
