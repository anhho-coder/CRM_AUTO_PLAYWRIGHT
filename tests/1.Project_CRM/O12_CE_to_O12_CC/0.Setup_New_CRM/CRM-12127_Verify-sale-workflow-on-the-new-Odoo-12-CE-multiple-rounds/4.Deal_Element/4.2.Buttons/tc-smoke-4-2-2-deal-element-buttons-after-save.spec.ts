...
test.describe(`${TC} - Buttons after SAVE`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.2.2');
  });

  test('CRM-12370_4.2.2: Verify the buttons offered by a Deal Element that has been saved', async ({ page }, testInfo) => {
