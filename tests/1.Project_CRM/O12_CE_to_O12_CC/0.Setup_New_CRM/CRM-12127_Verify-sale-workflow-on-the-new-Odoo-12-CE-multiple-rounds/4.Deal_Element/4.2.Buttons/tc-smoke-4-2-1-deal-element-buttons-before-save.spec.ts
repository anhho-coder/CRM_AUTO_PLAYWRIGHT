...
test.describe(`${TC} - Buttons before SAVE`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_4.2.1');
  });

  test('CRM-12370_4.2.1: Verify the buttons offered by a Deal Element that has not been saved yet', async ({ page }, testInfo) => {
