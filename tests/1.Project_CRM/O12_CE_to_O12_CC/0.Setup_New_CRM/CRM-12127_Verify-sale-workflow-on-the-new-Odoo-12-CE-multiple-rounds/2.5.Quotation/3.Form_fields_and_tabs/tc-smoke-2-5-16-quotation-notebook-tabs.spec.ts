 ...
 *          - Opp name    = TEST CRM-12325_2.5.16 <timestamp>
...
test.describe(`${TC} - Notebook tabs of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.16');
  });
