 ...
 *          - Opp name    = TEST CRM-12325_2.5.15 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.15:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.15';
...
test.describe(`${TC} - Field names and order in the Quotation information area`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.15');
  });
