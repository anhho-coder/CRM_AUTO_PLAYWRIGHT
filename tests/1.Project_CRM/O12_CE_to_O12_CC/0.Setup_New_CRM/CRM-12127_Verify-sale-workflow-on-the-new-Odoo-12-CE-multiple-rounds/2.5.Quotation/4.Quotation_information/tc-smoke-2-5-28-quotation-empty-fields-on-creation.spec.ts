 ...
 *          - Opp name    = TEST CRM-12325_2.5.28 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.28:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.28';
...
test.describe(`${TC} - Fields left empty on a new Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.28');
  });
