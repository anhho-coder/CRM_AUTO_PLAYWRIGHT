 ...
 *          - Opp name    = TEST CRM-12325_2.5.20 <timestamp>
...
test.describe(`${TC} - End User of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.20');
  });
