 ...
 *          - Opp name    = TEST CRM-12325_2.5.19 <timestamp>
...
test.describe(`${TC} - Delivery Address of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.19');
  });
