 ...
 *          - Opp name    = TEST CRM-12325_2.5.22 <timestamp>
...
test.describe(`${TC} - Pricelist of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.22');
  });
