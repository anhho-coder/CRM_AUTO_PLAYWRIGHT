 ...
 *          - Opp name    = TEST CRM-12325_2.5.21 <timestamp>
...
test.describe(`${TC} - Reseller and Distributor of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.21');
  });
