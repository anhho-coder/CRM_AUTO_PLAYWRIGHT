 ...
 *          - Opp name    = TEST CRM-12325_2.5.25 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.25:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.25';
...
test.describe(`${TC} - Partner discounts of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.25');
  });
