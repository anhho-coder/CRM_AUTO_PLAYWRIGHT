 ...
 *          - Opp name    = TEST CRM-12325_2.5.17 <timestamp>
...
test.describe(`${TC} - Payer of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.17');
  });
