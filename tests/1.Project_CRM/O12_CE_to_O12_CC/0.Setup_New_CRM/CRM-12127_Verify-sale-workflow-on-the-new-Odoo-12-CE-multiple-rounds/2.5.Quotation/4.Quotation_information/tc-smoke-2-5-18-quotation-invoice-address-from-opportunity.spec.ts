 ...
 *          - Opp name    = TEST CRM-12325_2.5.18 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.18:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.18';
...
test.describe(`${TC} - Invoice Address of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.18');
  });
