 ...
 *          - Opp name    = TEST CRM-12325_2.5.36 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.36:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.36';
...
test.describe(`${TC} - Stage of a newly created Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.36');
  });
