 ...
 *          - Opp name    = TEST CRM-12325_2.5.31 <timestamp>
 ...
 * CRM-12325_2.5.29. "Promo Discount Amount" is developer-only and is covered by
 * CRM-12325_2.5.39.
 */
...
test.describe(`${TC} - Discount columns of the Quotation order line`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.31');
  });
