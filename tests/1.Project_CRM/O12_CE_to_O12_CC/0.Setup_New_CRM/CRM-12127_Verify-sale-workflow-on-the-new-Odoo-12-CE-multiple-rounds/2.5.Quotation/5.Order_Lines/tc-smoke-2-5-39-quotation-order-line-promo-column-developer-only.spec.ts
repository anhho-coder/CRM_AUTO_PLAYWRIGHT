 ...
 *          - Opp name    = TEST CRM-12325_2.5.39 <timestamp>
...
/** What a NORMAL session shows - see CRM-12325_2.5.29. */
...
test.describe(`${TC} - Promo Discount Amount is a developer-only Order Lines column`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.39');
  });
