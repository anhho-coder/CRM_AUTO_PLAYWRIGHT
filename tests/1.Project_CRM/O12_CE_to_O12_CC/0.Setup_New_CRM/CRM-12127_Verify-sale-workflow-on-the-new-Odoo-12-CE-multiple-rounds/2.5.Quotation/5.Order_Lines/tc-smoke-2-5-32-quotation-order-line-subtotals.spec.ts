 ...
 *          - Opp name    = TEST CRM-12325_2.5.32 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.32:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.32';
...
test.describe(`${TC} - Subtotals of the Quotation order line`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.32');
  });
