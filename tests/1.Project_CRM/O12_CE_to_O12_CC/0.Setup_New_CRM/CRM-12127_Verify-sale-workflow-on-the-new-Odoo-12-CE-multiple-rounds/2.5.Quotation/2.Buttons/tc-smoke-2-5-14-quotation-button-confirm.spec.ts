 ...
 *          - Opp name    = TEST CRM-12325_2.5.14 <timestamp>
...
test.describe(`${TC} - CONFIRM button on the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.14');
  });
