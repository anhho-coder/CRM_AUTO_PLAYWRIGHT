 ...
 *          - Opp name    = TEST CRM-12325_2.5.13 <timestamp>
...
test.describe(`${TC} - CANCEL button on the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.13');
  });
