 ...
 *          - Opp name    = TEST CRM-12325_2.5.33 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.5\.33:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.5.33';
...
test.describe(`${TC} - "Sale Order created" log note on the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.33');
  });
