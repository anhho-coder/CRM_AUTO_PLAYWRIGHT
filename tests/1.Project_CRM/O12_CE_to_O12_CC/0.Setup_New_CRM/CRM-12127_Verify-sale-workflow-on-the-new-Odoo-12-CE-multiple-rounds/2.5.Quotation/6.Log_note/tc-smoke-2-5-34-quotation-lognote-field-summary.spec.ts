 ...
 *          - Opp name    = TEST CRM-12325_2.5.34 <timestamp>
...
test.describe(`${TC} - Summary log note of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.5.34');
  });
