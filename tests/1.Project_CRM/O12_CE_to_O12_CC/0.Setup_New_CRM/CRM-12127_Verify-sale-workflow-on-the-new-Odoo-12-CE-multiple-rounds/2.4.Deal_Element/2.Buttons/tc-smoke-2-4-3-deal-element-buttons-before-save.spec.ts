...
test.describe(`${TC} - Buttons before SAVE`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.3');
  });

  test('CRM-12325_2.4.3: Verify the buttons offered by a Deal Element that has not been saved yet', async ({ page }, testInfo) => {
