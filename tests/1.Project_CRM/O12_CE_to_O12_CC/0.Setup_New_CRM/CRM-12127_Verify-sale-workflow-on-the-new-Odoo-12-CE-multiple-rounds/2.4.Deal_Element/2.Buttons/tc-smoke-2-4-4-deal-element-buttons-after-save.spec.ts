...
test.describe(`${TC} - Buttons after SAVE`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.4');
  });

  test('CRM-12325_2.4.4: Verify the buttons offered by a Deal Element that has been saved', async ({ page }, testInfo) => {
