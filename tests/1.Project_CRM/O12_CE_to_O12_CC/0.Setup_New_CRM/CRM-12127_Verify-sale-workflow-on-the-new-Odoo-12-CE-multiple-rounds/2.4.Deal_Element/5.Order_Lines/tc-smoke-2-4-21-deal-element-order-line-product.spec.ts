...
test.describe(`${TC} - Order line product`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.21');
  });

  test('CRM-12325_2.4.21: Verify the single order line carries the added product, its description, Qty 1 and Socket', async ({ page }, testInfo) => {
