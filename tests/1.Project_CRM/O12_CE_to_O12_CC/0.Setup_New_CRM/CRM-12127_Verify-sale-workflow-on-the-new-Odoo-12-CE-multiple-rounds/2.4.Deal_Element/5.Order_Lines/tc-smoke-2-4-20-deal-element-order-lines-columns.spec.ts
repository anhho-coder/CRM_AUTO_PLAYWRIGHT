...
test.describe(`${TC} - Order Lines columns`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.20');
  });

  test('CRM-12325_2.4.20: Verify the columns of the Order Lines list and their order', async ({ page }, testInfo) => {
