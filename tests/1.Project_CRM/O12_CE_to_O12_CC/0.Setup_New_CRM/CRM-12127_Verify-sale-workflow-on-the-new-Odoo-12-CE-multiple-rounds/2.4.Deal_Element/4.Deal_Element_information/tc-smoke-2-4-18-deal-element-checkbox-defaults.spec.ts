...
test.describe(`${TC} - Checkbox defaults`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.18');
  });

  test('CRM-12325_2.4.18: Verify the Send mail and Online Payment checkboxes keep their defaults', async ({ page }, testInfo) => {
