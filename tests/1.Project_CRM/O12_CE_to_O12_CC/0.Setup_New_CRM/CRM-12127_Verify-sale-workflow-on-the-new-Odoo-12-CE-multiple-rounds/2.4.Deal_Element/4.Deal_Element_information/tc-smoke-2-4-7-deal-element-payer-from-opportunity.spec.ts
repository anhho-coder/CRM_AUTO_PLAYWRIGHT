 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\.4\.7:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.4.7';
...
test.describe(`${TC} - Payer from the Opportunity`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.7');
  });

  test('CRM-12325_2.4.7: Verify the Payer is filled and matches the Company of the Opportunity', async ({ page }, testInfo) => {
