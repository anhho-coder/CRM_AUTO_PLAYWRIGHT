...
test.describe(`${TC} - End User from the Opportunity`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.10');
  });

  test('CRM-12325_2.4.10: Verify the End User is filled and matches the Company of the Opportunity', async ({ page }, testInfo) => {
