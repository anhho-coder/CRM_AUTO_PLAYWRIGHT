...
test.describe(`${TC} - Reseller and Distributor from the Opportunity`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.11');
  });

  test('CRM-12325_2.4.11: Verify the Reseller and the Distributor are filled and match the Opportunity', async ({ page }, testInfo) => {
