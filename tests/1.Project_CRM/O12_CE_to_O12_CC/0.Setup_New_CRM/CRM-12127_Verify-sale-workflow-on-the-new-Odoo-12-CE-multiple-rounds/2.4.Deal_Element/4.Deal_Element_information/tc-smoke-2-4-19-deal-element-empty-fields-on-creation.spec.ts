...
test.describe(`${TC} - Empty fields on creation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.19');
  });

  test('CRM-12325_2.4.19: Verify the fields a newly created Deal Element leaves empty', async ({ page }, testInfo) => {
