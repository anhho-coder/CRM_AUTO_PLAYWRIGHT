...
/**
 * O12 CE Main-Business Smoke - Notebook tabs of the Deal Element
 * Test Case ID: CRM-12325_2.4.6
 * Automation-Type: new
 * Automation-Date: 2026-09-17
 *
 * Summary:
 *   Verify the Deal Element carries exactly the three notebook tabs Order Lines, Optional Products
 *   and Other Information, in that order.
 *
 * Source manual TC (pre-production): TC.Performance.1.1.4.6 "Deal Element notebook tabs".
 *
 ...
 *  12. Read the notebook tab captions of the saved Deal Element.
 *
 * Verification Points:
 *   1. The notebook carries exactly three tabs.
...
test.describe(`${TC} - Notebook tabs`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.6');
  });

  test('CRM-12325_2.4.6: Verify the notebook tabs of the Deal Element and their order', async ({ page }, testInfo) => {
