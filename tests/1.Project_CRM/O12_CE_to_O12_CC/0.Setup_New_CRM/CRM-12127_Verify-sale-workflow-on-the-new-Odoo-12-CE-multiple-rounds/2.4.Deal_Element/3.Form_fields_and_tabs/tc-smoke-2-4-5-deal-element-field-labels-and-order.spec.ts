...
test.describe(`${TC} - Field names and order of the information area`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    await sweepMigLeftoversAfterAll(browser, 'CRM-12325_2.4.5');
  });

  test('CRM-12325_2.4.5: Verify the field names and their order in the Deal Element information area', async ({ page }, testInfo) => {
