 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_3\.1\.2:" --project=MigSmoke
 */
...
test.describe('CRM-12370_3.1.2 - O12 CE smoke: edit a Contact', () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_3.1.2');
  });

  test('CRM-12370_3.1.2: Verify a Contact can be edited on the O12 CE Migration server', async ({ page }, testInfo) => {
