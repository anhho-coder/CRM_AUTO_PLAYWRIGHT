...
/**
 * O12 CE Main-Business Smoke - Contact screen verification - CREATE button
 * Test Case ID: CRM-12370_3.2.4
 * Automation-Type: new
 ...
 *
 * Source manual TC (pre-production): TC.Performance.1.1.3.6
 ...
 *   4. Press "SAVE" button.
 *   5. Pressing CREATE and verifying a blank Contact form opens.
 *
 * crm-mig house rule: this spec CREATES data and removes it in teardown. The Contact it makes carries
 * the marker "TEST CRM-12370_3.2.4 <timestamp>" so the afterAll sweep can find it again even when the test dies
 * mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_3\\.2\\.4:" --project=MigSmoke
 */

const TC = 'CRM-12370_3.2.4';
...
test.describe(`${TC} - CREATE button`, () => {
  ...
  test(`${TC}: Verify the CREATE button opens a blank Contact form`, async ({ page }, testInfo) => {
