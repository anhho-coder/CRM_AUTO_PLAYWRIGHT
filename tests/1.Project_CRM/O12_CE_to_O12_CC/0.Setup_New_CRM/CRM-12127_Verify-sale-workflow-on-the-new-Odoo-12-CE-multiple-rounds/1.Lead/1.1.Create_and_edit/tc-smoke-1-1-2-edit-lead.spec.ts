 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.1\.2:" --project=chromium
 */
...
test.describe('CRM-12370_1.1.2 - O12 CE smoke: edit a CRM Lead', () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.1.2');
  });

  test('CRM-12370_1.1.2: Verify a CRM Lead can be edited on the O12 CE Migration server', async ({ page }, testInfo) => {
