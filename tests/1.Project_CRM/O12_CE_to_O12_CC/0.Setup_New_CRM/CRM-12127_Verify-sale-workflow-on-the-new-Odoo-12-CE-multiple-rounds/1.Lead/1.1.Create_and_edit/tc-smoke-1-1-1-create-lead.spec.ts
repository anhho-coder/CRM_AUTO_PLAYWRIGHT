 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\.1\.1:" --project=chromium
 */
...
test.describe('CRM-12370_1.1.1 - O12 CE smoke: create a CRM Lead', () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.1.1');
  });

  test('CRM-12370_1.1.1: Verify a CRM Lead can be created on the O12 CE Migration server', async ({ page }, testInfo) => {
