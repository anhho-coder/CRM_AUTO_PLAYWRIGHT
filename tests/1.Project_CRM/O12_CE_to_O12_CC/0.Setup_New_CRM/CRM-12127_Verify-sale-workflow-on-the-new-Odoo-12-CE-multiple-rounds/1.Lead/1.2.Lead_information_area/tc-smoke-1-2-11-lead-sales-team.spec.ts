 ...
 *   - Same cron-cadence deviation as CRM-12370_1.2.10: the O12 CE assignment job cannot be awaited inside a smoke run, so the TC verifies the Sales Team entered at creation is stored and rendered.
 ...
 * carries the marker "TEST CRM-12370_1.2.11 <timestamp>" so the afterAll sweep can find it again even when
 * the test dies mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\\.2\\.11:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.2.11';
