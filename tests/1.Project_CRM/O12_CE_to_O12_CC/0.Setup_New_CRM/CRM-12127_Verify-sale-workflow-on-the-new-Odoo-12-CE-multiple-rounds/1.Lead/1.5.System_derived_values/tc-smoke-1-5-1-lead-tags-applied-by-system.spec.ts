 ...
 * carries the marker "TEST CRM-12370_1.5.1 <timestamp>" so the afterAll sweep can find it again even when
 * the test dies mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\\.5\\.1:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.5.1';
