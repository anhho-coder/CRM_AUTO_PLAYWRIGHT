...
/**
 * O12 CE Main-Business Smoke - Contact screen verification - Notebook tabs
 * Test Case ID: CRM-12325_2.3.29
 * Automation-Type: new
 ...
 *
 * Source manual TC (pre-production): TC.Performance.1.1.3.29
 ...
 *   4. Press "SAVE" button.
 *   5. Verifying the notebook tabs of the saved Contact.
 *
 * crm-mig house rule: this spec CREATES data and removes it in teardown. The Contact it makes carries
 * the marker "TEST CRM-12325_2.3.29 <timestamp>" so the afterAll sweep can find it again even when the test dies
 * mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\\.3\\.29:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.3.29';
...
test.describe(`${TC} - Notebook tabs`, () => {
  ...
  test(`${TC}: Verify the name, the number and the order of the Contact notebook tabs`, async ({ page }, testInfo) => {
