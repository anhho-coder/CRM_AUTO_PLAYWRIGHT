 ...
 * carries the marker "TEST CRM-12325_2.1.28 <timestamp>" so the afterAll sweep can find it again even when
 * the test dies mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12325_2\\.1\\.28:" --project=MigSmoke
 */

const TC = 'CRM-12325_2.1.28';
