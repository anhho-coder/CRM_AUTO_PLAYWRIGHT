 ...
 *   - Grounded on crm-mig: `lead_source` is a selection [nakivo | partner] on crm.lead, and lead 879678 (Sales Team CMR + Salesperson Bear Lin) carries lead_source = "partner" - the same derivation as pre-production.
 *
 * Pre-conditions:
 ...
 * carries the marker "TEST CRM-12325_2.1.14 <timestamp>" so the afterAll sweep can find it again even when
