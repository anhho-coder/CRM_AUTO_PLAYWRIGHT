 ...
 *   - The pre-production TC uses Singapore. On crm-mig Singapore HAS 6 res.country.state rows, so it no longer exercises the scenario. Gibraltar is one of the 32 countries with ZERO states on crm-mig - verified over XML-RPC, 2026-09-17.
 *
 * Pre-conditions:
 ...
 * carries the marker "TEST CRM-12325_2.1.23 <timestamp>" so the afterAll sweep can find it again even when
