...
/**
 * O12 CE Main-Business Smoke - Contact screen verification - Language
 * Test Case ID: CRM-12370_1.3.22
 * Automation-Type: new
 ...
 *
 * Source manual TC (pre-production): TC.Performance.1.1.3.22
 ...
 *   4. Press "SAVE" button.
 *   5. Verifying the Language on the saved form.
 *
 * crm-mig house rule: this spec CREATES data and removes it in teardown. The Contact it makes carries
 * the marker "TEST CRM-12370_1.3.22 <timestamp>" so the afterAll sweep can find it again even when the test dies
 * mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\\.3\\.22:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.3.22';
...
test.describe(`${TC} - Language`, () => {
  ...
  test(`${TC}: Verify the Language of a newly created Contact is English`, async ({ page }, testInfo) => {
