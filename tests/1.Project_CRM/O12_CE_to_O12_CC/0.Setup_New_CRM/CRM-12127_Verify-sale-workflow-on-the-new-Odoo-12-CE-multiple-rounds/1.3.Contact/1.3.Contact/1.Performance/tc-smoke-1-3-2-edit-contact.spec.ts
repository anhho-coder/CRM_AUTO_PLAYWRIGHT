...
test.describe('CRM-12370_1.3.2 - O12 CE smoke: edit a Contact', () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_1.3.2');
  });

  test('CRM-12370_1.3.2: Verify a Contact can be edited on the O12 CE Migration server', async ({ page }, testInfo) => {
