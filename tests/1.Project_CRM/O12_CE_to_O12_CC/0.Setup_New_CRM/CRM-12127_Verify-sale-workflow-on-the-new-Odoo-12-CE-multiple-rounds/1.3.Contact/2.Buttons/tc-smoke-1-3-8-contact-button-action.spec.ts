...
/**
 * O12 CE Main-Business Smoke - Contact screen verification - Action menu
 * Test Case ID: CRM-12370_1.3.8
 * Automation-Type: new
 ...
 *
 * Source manual TC (pre-production): TC.Performance.1.1.3.8
 ...
 *   4. Press "SAVE" button.
 *   5. Opening the Action menu and verifying the actions it offers.
 *
 * crm-mig house rule: this spec CREATES data and removes it in teardown. The Contact it makes carries
 * the marker "TEST CRM-12370_1.3.8 <timestamp>" so the afterAll sweep can find it again even when the test dies
 * mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\\.3\\.8:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.3.8';
...
test.describe(`${TC} - Action menu`, () => {
  ...
  test(`${TC}: Verify the actions the Action menu of a Contact offers`, async ({ page }, testInfo) => {
