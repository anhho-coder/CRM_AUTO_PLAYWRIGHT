...
/**
 * O12 CE Main-Business Smoke - Contact screen verification - Print menu
 * Test Case ID: CRM-12370_1.3.7
 * Automation-Type: new
 * Automation-Date: 2026-09-21
 *
 * Objective: Verify the reports the Print menu of a Contact offers
 *
 ...
 *
 * Source manual TC (pre-production): TC.Performance.1.1.3.7
 ...
 *   4. Press "SAVE" button.
 *   5. Opening the Print menu and verifying the reports it offers.
 *
 * crm-mig house rule: this spec CREATES data and removes it in teardown. The Contact it makes carries
 * the marker "TEST CRM-12370_1.3.7 <timestamp>" so the afterAll sweep can find it again even when the test dies
 * mid-way.
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_1\\.3\\.7:" --project=MigSmoke
 */

const TC = 'CRM-12370_1.3.7';
...
const STEP = {
  ...
  s5: 'Step 5: Opening the Print menu and verifying the reports it offers',
};

test.describe(`${TC} - Print menu`, () => {
  let contactUrl = '';
  ...
  test(`${TC}: Verify the reports the Print menu of a Contact offers`, async ({ page }, testInfo) => {
