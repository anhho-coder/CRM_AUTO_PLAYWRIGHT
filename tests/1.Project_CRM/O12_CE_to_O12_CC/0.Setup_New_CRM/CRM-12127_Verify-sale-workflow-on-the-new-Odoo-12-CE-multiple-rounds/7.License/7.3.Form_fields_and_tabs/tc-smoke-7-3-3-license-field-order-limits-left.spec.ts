 ...
 *  =============================================================================================
 * =============================================================================================
 *  Test Case ID    : CRM-12370_7.3.3
 *  Jira            : -   (ported from pre-production TC.Performance.7.3.3; no Xray manual TC)
 ...
 * ---------------------------------------------------------------------------------------------
 *  Command to run
 *    npx playwright test --grep "CRM-12370_7\.3\.3:" --project=MigSmoke
 * ---------------------------------------------------------------------------------------------
 *  Source manual TC (pre-production): TC.Performance.7.3.3
 *    tests/1.Project_CRM/1.SalesReport_Performance/7.License/7.3.Form_fields_and_tabs
 *
 ...
 *    License, named with a fresh timestamp and the marker "TEST CRM-12370_7.3.3", so two
