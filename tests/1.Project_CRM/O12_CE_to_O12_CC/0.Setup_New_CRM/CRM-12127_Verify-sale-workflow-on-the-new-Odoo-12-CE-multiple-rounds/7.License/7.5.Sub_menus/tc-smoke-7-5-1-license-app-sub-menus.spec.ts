 ...
 *  =============================================================================================
 * =============================================================================================
 *  Test Case ID    : CRM-12370_7.5.1
 *  Jira            : -   (ported from pre-production TC.Performance.7.5.1; no Xray manual TC)
 ...
 * ---------------------------------------------------------------------------------------------
 *  Command to run
 *    npx playwright test --grep "CRM-12370_7\.5\.1:" --project=MigSmoke
 * ---------------------------------------------------------------------------------------------
 *  Source manual TC (pre-production): TC.Performance.7.5.1
 *    tests/1.Project_CRM/1.SalesReport_Performance/7.License/7.5.Sub_menus
 *
 ...
 *    License, named with a fresh timestamp and the marker "TEST CRM-12370_7.5.1", so two
