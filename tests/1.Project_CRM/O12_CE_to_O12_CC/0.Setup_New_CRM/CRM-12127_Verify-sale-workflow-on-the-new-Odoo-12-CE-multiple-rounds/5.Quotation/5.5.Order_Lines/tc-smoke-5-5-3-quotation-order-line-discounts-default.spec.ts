 ...
 *          - Opp name    = TEST CRM-12370_5.5.3 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.5\.3:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.5.3';
 ...
 * CRM-12370_5.5.1. "Promo Discount Amount" is developer-only and is covered by
 * CRM-12370_5.5.5.
 */
...
test.describe(`${TC} - Discount columns of the Quotation order line`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.5.3');
  });
