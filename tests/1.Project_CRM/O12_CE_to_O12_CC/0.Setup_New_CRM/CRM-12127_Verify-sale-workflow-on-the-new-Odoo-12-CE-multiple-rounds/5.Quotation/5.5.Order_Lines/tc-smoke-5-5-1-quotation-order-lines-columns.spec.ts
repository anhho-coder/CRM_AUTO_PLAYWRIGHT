 ...
 *          - Opp name    = TEST CRM-12370_5.5.1 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.5\.1:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.5.1';
...
test.describe(`${TC} - Order Lines columns of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.5.1');
  });
