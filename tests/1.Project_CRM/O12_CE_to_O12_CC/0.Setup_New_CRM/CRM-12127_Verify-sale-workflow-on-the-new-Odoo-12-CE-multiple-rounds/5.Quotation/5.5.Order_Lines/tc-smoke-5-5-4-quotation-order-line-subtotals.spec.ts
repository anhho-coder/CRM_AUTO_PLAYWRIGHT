 ...
 *          - Opp name    = TEST CRM-12370_5.5.4 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.5\.4:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.5.4';
...
test.describe(`${TC} - Subtotals of the Quotation order line`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.5.4');
  });
