 ...
 *          - Opp name    = TEST CRM-12370_5.2.6 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.2\.6:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.2.6';
...
test.describe(`${TC} - SEND PRO-FORMA INVOICE button on the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.2.6');
  });
