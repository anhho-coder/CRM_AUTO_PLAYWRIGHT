 ...
 *          - Opp name    = TEST CRM-12370_5.4.5 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.5:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.5';
...
test.describe(`${TC} - Reseller and Distributor of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.5');
  });
