 ...
 *          - Opp name    = TEST CRM-12370_5.4.14 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.14:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.14';
...
test.describe(`${TC} - Addresses of a distributor deal follow the Distributor`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.14');
  });
