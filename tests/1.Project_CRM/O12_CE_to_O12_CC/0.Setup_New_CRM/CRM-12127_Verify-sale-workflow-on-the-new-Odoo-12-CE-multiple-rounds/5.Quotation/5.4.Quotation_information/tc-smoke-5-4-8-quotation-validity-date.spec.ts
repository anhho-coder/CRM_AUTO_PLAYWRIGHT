 ...
 *          - Opp name    = TEST CRM-12370_5.4.8 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.8:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.8';
...
test.describe(`${TC} - Validity date of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.8');
  });
