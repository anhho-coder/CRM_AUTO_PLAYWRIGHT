 ...
 *          - Opp name    = TEST CRM-12370_5.4.6 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.6:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.6';
...
test.describe(`${TC} - Pricelist of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.6');
  });
