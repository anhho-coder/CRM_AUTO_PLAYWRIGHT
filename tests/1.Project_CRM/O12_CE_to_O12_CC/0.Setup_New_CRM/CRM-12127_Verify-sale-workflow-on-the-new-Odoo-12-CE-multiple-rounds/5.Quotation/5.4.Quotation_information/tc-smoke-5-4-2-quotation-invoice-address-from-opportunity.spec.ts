 ...
 *          - Opp name    = TEST CRM-12370_5.4.2 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.2:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.2';
...
test.describe(`${TC} - Invoice Address of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.2');
  });
