 ...
 *          - Opp name    = TEST CRM-12370_5.4.7 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.7:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.7';
...
test.describe(`${TC} - Payment Terms of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.7');
  });
