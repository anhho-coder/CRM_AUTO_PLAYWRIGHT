 ...
 *          - Opp name    = TEST CRM-12370_5.4.12 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.12:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.12';
...
test.describe(`${TC} - Fields left empty on a new Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.12');
  });
