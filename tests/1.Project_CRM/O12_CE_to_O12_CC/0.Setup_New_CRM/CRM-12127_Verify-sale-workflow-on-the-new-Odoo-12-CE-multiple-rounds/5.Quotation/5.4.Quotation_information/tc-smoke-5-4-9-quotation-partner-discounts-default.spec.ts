 ...
 *          - Opp name    = TEST CRM-12370_5.4.9 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.9:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.9';
...
test.describe(`${TC} - Partner discounts of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.9');
  });
