 ...
 *          - Opp name    = TEST CRM-12370_5.4.4 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.4:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.4';
...
test.describe(`${TC} - End User of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.4');
  });
