 ...
 *          - Opp name    = TEST CRM-12370_5.4.1 <timestamp>
 ...
 *
 * Command to run:
 *   npx playwright test --grep "CRM-12370_5\.4\.1:" --project=MigSmoke
 */

const TC = 'CRM-12370_5.4.1';
...
test.describe(`${TC} - Payer of the Quotation`, () => {
  ...
  test.afterAll(async ({ browser }) => {
    await sweepMigLeftoversAfterAll(browser, 'CRM-12370_5.4.1');
  });
