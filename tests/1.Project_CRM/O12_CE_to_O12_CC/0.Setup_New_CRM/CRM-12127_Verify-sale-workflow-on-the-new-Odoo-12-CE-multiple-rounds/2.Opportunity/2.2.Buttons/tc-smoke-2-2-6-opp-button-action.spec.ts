 ...
 * =============================================================================================
 *  Test Case ID    : CRM-12370_2.2.6
 *  Automation-Type : new
 *  Automation-Date : 2026-09-23
 *  Feature folder  : .../CRM-12127_.../2.Opportunity/2.2.Buttons
 *  Source manual TC: TC.Performance.1.1.2.8 (pre-production baseline, 37/37 PASS 2026-09-21)
 *
 *  Summary
 *  ---------------------------------------------------------------------------------------------
 *  Creates its own Opportunity on the O12 CE Migration server (crm-mig) and asserts that
 *  the Action menu of a saved Opportunity offers exactly the expected entries, in order.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "CRM-12370_2\\.2\\.6:" --project=MigSmoke
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *           - Opportunity     = TEST CRM-12370_2.2.6 <unique>
 *           - Contact Name    = TEST CRM-12370_2.2.6 <unique>
 ...
 *    4.   Open the Action menu of the saved Opportunity and read its entries  -> spec label "Step 8"
 *
 *  Verification:
 *    4. The Action menu offers exactly 14 entries, in the baseline order
 *    - No other entry is offered
 *
 *  BASELINE RULE (CLAUDE.md, crm-mig automation)
 *  ---------------------------------------------------------------------------------------------
 *  The expected values below are the PRE-PRODUCTION baseline, byte-identical to TC.Performance.1.1.2.8.
 ...
 *  `TEST CRM-12370_2.2.6 ...` - the same marker `sweepMigLeftoversOnO12CE` searches for.
 * =============================================================================================
 */

const TC = 'CRM-12370_2.2.6';

/** The entries of the Action menu of a saved Opportunity (PRE-PROD baseline, 2026-09-21). */
const EXPECTED = [
    'Delete',
    'Duplicate',
...
const STEP = {
  s8: 'Step 8: Open the Action menu of the saved Opportunity and read its entries',
};
