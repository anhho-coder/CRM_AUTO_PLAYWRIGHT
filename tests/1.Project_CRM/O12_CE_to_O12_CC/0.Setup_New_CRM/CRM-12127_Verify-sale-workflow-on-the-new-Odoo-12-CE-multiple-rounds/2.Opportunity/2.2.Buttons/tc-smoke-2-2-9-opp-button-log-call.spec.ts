 ...
 *  pressing LOG CALL opens the "Log call" dialog with the expected fields and buttons, and
 *  CANCEL leaves the Opportunity in its stage.
 *
 *  Command to run
 *  ---------------------------------------------------------------------------------------------
 *  npx playwright test --grep "CRM-12370_2\\.2\\.9:" --project=MigSmoke
 *
 *  Source manual TC
 *  ---------------------------------------------------------------------------------------------
 *  Pre-condition(s):
 ...
 *           - Opportunity     = TEST CRM-12370_2.2.9 <unique>
 *           - Contact Name    = TEST CRM-12370_2.2.9 <unique>
 ...
 *    4.   Press the LOG CALL button of the saved Opportunity  -> spec label "Step 8"
 *    5.   Read the dialog that opens, then dismiss it with CANCEL  -> spec label "Step 9"
 *
 *  Verification:
 *    5. The dialog title is "Log call" and it offers the fields
 *         Call type | Date | Quote requested | Slides requested
 ...
 *  `TEST CRM-12370_2.2.9 ...` - the same marker `sweepMigLeftoversOnO12CE` searches for.
 * =============================================================================================
 */

const TC = 'CRM-12370_2.2.9';

/** The LOG CALL dialog (PRE-PROD baseline, 2026-09-21). */
...
const STEP = {
  s8: 'Step 8: Press the LOG CALL button of the saved Opportunity',
