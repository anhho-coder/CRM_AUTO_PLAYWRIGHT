...
/**
 * CRM-12325 Part 2-A.2 - Settings app opens cleanly and within a reasonable time (crm-mig.nakivo.site)
 * Test Case ID: CRM-12325_1.1.5
 * Automation-Type: new
 * Automation-Date: 2026-08-19
 *
 * Summary:
 *   Verifies the Settings app opens on the Migration server with no server error / traceback and
 ...
 *
 * Steps to reproduce:
 *   1. Open the Settings app and let its action view render.
 *
 * Verification Points (ticket Part 2-A bullet 2, for the Settings app):
...
test.describe('CRM-12325 Part 2-A.2 - Settings opens cleanly and fast', () => {
  ...
  test('CRM-12325_1.1.5: [Part2-A] Settings app opens with no server error and within a reasonable time', async ({ page }, testInfo) => {
    ...
    await test.step('Step 1: Open the Settings app and let its action view render', async () => {
      console.log('\n--- Step 1: Open the Settings app and let its action view render ---');
