 ...
 *    5. Register a partial payment of Installment#4 with "Keep open" (Actually Received = Installment#4), then Validate
 *    6. Register a payment of Installment#5 (the remaining balance, Actually Received = Installment#5), then Validate
 *
 *  Verification Point:
