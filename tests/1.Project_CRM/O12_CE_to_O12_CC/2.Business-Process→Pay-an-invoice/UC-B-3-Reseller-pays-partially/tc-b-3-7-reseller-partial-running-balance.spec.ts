 ...
 *    2. Register a partial payment of Installment#1 ("Keep open", Actually Received = Installment#1), Validate; verify Amount Due = InvoiceTotal#1 - Installment#1 and state Open
 *    3. Register a partial payment of Installment#2 ("Keep open", Actually Received = Installment#2), Validate; verify Amount Due = InvoiceTotal#1 - Installment#1 - Installment#2 and state Open
 *    4. Register a payment of Installment#3 (remaining balance, Actually Received = Installment#3), Validate; verify Amount Due = $0 and state Paid
 *
 *  Verification Point:
