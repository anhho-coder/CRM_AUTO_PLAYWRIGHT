 ...
 *           on the invoice) open the Invoice; press REGISTER PAYMENT; read the Payment Amount; set
 *           "Actually Received($)" = Payment Amount; press VALIDATE (the invoice becomes Paid).
 *
