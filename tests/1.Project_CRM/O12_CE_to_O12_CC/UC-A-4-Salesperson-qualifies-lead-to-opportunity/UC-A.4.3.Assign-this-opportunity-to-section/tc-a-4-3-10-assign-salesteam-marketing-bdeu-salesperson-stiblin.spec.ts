...
test.describe('TC.-A.4.3.10 - Convert Lead to Opportunity assigning the Marketing - BDEU team Salesperson/Sales Team (salesteam.users)', () => {
  ...
  test(`TC.-A.4.3.10: Verify converting a qualified lead to Opportunity assigning Sales Team = ${sp.team} and Salesperson = ${sp.displayName} is successful`, async ({ page }, testInfo) => {
