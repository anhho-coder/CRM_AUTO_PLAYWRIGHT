...
test.describe('TC.THD_3.2.1.2 - THD Team Assignment for Indonesia with Nakivo Customer = TRUE and Partner = TRUE @smoke-test', () => {
  ...
  test.skip('TC.THD_3.2.1.2: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Partner = TRUE and Country = Indonesia @smoke-test', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.2.1.2');
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Indonesia with Nakivo Customer = TRUE, Partner = TRUE)`);
      ...
      console.log('   Lead with Indonesia, Nakivo Customer = TRUE, Partner = TRUE');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.2.1.2</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Indonesia, Nakivo Customer = TRUE, Partner = TRUE<br>
