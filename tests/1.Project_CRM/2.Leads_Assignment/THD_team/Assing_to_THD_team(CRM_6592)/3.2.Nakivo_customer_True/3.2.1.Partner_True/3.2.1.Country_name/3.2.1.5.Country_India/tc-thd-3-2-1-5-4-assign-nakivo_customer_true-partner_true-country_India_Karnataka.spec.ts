...
test.describe('TC.THD_3.2.1.5.4 - THD Team Assignment for India (Karnataka) with Nakivo Customer = TRUE and Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.1.5.4: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Partner = TRUE, Country = India and State = Karnataka (IN specific list)', async ({ page }, testInfo) => {
