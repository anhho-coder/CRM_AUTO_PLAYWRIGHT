...
test.describe('TC.THD_3.2.1.5.1 - THD Team Assignment for India (Delhi) with Nakivo Customer = TRUE and Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.1.5.1: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Partner = TRUE, Country = India and State = Delhi', async ({ page }, testInfo) => {
