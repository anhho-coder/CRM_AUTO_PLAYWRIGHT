...
test.describe('TC.THD_3.2.2.5.2 - THD Team Assignment for India (State Blank) with Nakivo Customer = TRUE and New Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.2.5.2: Verify the lead is assigned to THD team if Nakivo customer = TRUE, New Partner = TRUE, Country = India and State is BLANK', async ({ page }, testInfo) => {
