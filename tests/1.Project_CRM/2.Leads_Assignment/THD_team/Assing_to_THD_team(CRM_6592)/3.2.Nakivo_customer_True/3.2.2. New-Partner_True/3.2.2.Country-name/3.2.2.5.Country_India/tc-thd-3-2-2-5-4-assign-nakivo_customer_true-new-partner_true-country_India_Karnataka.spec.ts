...
test.describe('TC.THD_3.2.2.5.4 - THD Team Assignment for India (Karnataka) with Nakivo Customer = TRUE and New Partner = TRUE', () => {
  ...
  test('TC.THD_3.2.2.5.4: Verify the lead is assigned to THD team if Nakivo customer = TRUE, New Partner = TRUE, Country = India and State is Karnataka', async ({ page }, testInfo) => {
