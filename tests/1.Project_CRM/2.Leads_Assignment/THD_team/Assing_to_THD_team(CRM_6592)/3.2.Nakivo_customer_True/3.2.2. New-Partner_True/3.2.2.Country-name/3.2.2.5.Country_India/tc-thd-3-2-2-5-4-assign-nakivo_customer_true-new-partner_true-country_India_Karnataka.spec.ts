 ...
 * 
 * Command to run:
 * npx playwright test --grep "TC.THD_3.2.2.5.4" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.2.2.5.4 - THD Team Assignment for India (Karnataka) with Nakivo Customer = TRUE and New Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.2.5.4: Verify the lead is assigned to THD team if Nakivo customer = TRUE, New Partner = TRUE, Country = India and State is Karnataka', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.2.2.5.4');
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (India-Karnataka with Nakivo Customer = TRUE, New Partner = TRUE)`);
      ...
      console.log('   Lead with India-Karnataka, Nakivo Customer = TRUE, New Partner = TRUE');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.2.2.5.4</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with India-Karnataka, Nakivo Customer = TRUE, New Partner = TRUE<br>
