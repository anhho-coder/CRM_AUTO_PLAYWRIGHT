...
/**
 * Lead Assignment Test - THD Team - Malaysia with Nakivo Customer = TRUE and Activated Partner = TRUE
 * Test Case ID: TC.THD_3.2.3.1
 * 
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE and Country = Malaysia
 * 
 * Command to run:
...
test.describe('TC.THD_3.2.3.1 - THD Team Assignment for Malaysia with Nakivo Customer = TRUE and Activated Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.3.1: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE and Country = Malaysia', async ({ page }, testInfo) => {
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Malaysia with Nakivo Customer = TRUE, Activated Partner = TRUE)`);
      ...
      console.log('   Lead with Malaysia, Nakivo Customer = TRUE, Activated Partner = TRUE');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Malaysia, Nakivo Customer = TRUE, Activated Partner = TRUE<br>
