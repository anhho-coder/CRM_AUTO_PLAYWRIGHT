...
/**
 * Lead Assignment Test - THD Team - Vietnam with Nakivo Customer = TRUE and Activated Partner = TRUE
 * Test Case ID: TC.THD_3.2.3.4
 * 
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE and Country = Vietnam
 * 
 * Command to run:
...
test.describe('TC.THD_3.2.3.4 - THD Team Assignment for Vietnam with Nakivo Customer = TRUE and Activated Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.3.4: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE and Country = Vietnam', async ({ page }, testInfo) => {
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Vietnam with Nakivo Customer = TRUE, Activated Partner = TRUE)`);
      ...
      console.log('   Lead with Vietnam, Nakivo Customer = TRUE, Activated Partner = TRUE');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Vietnam, Nakivo Customer = TRUE, Activated Partner = TRUE<br>
