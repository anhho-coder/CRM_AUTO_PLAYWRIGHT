...
/**
 * Lead Assignment Test - THD Team - Indonesia with Nakivo Customer = TRUE and Activated Partner = TRUE
 * Test Case ID: TC.THD_3.2.3.2
 * 
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE and Country = Indonesia
 * 
 * Command to run:
...
test.describe('TC.THD_3.2.3.2 - THD Team Assignment for Indonesia with Nakivo Customer = TRUE and Activated Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.3.2: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE and Country = Indonesia', async ({ page }, testInfo) => {
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Indonesia with Nakivo Customer = TRUE, Activated Partner = TRUE)`);
      ...
      console.log('   Lead with Indonesia, Nakivo Customer = TRUE, Activated Partner = TRUE');
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Indonesia, Nakivo Customer = TRUE, Activated Partner = TRUE<br>
