...
test.describe('TC.THD_3.2.3.5.4 - THD Team Assignment for India (Karnataka) with Nakivo Customer = TRUE and Activated Partner = TRUE', () => {
  ...
  test.skip('TC.THD_3.2.3.5.4: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE, Country = India and State is Karnataka', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.2.3.5.4');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.2.3.5.4</div>
