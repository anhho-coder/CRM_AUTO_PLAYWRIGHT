...
/**
 * Lead Assignment Test - THD Team - India (State Blank) with Nakivo Customer = TRUE, Activated Partner = TRUE and New Partner = TRUE
 * Test Case ID: TC.THD_3.2.3.5.2
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE, New Partner = TRUE, Country = India and State is BLANK
 *
 ...
 * 
 * Command to run:
 * npx playwright test --grep "TC\.THD_3\.2\.3\.5\.2 -" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.2.3.5.2 - THD Team Assignment for India (State Blank) with Nakivo Customer = TRUE, Activated Partner = TRUE and New Partner = TRUE', () => {
  ...
  test('TC.THD_3.2.3.5.2: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE, New Partner = TRUE, Country = India and State is BLANK', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.2.3.5.2');
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.THD_3.2.3.5.2', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (India-State Blank with Nakivo Customer = TRUE, Activated Partner = TRUE, New Partner = TRUE)`);
      ...
      console.log('   Lead with India-State Blank, Nakivo Customer = TRUE, Activated Partner = TRUE, New Partner = TRUE');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.2.3.5.2</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with India-State Blank, Nakivo Customer = TRUE, Activated Partner = TRUE, New Partner = TRUE<br>
