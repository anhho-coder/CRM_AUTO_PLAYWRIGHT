...
test.describe('TC.THD_3.2.3.5.2 - THD Team Assignment for India (State Blank) with Nakivo Customer = TRUE and Activated Partner = TRUE', () => {
  ...
  test('TC.THD_3.2.3.5.2: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE, Country = India and State is BLANK', async ({ page }, testInfo) => {
