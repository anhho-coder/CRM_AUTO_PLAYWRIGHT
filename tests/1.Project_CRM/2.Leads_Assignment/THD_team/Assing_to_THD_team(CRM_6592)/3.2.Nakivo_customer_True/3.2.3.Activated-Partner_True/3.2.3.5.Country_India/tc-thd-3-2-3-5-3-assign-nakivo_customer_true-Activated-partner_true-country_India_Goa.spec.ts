...
/**
 * Lead Assignment Test - THD Team - India (Goa) with Nakivo Customer = TRUE, Activated Partner = TRUE and New Partner = TRUE
 * Test Case ID: TC.THD_3.2.3.5.3
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE, New Partner = TRUE, Country = India and State is Goa (NOT in list: Andhra Pradesh, Karnataka, Kerala, Tamil Nadu, Telangana, West Bengal)
 *
 ...
 *
 * Command to run:
 * npx playwright test --grep "TC\.THD_3\.2\.3\.5\.3 -" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.2.3.5.3 - THD Team Assignment for India (Goa) with Nakivo Customer = TRUE, Activated Partner = TRUE and New Partner = TRUE', () => {
  ...
  test('TC.THD_3.2.3.5.3: Verify the lead is assigned to THD team if Nakivo customer = TRUE, Activated Partner = TRUE, New Partner = TRUE, Country = India and State is Goa', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.2.3.5.3');
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.THD_3.2.3.5.3', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (India-Goa with Nakivo Customer = TRUE, Activated Partner = TRUE, New Partner = TRUE)`);
      ...
      console.log('   Lead with India-Goa, Nakivo Customer = TRUE, Activated Partner = TRUE, New Partner = TRUE');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.2.3.5.3</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with India-Goa, Nakivo Customer = TRUE, Activated Partner = TRUE, New Partner = TRUE<br>
