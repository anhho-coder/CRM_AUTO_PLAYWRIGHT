...
test.describe('TC.THD_3.1.1.5.2 - THD Team Assignment for India with State = BLANK and Nakivo Customer = NOT True', () => {
  ...
  test.skip('TC.THD_3.1.1.5.2: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = India and State is blank', async ({ page }, testInfo) => {
