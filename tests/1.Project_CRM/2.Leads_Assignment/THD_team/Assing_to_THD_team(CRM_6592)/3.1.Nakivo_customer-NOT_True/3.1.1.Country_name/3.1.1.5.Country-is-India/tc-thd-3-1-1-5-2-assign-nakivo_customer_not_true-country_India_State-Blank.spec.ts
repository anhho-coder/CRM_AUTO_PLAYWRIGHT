...
/**
 * Lead Assignment Test - THD Team - India with State = BLANK and Nakivo Customer = NOT True
 * Test Case ID: TC.THD_3.1.1.5.2
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = India and State is blank
 * 
 * Command to run:
 * npx playwright test --grep "TC\.THD_3\.1\.1\.5\.2 -" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.1.1.5.2 - THD Team Assignment for India with State = BLANK and Nakivo Customer = NOT True', () => {
  ...
  test('TC.THD_3.1.1.5.2: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = India and State is blank', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.1.1.5.2');
      ...
      // Leave State blank - do not select any state
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.THD_3.1.1.5.2', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (India-State Blank with Nakivo Customer = NOT True)`);
      ...
      console.log('   Lead with India-State Blank, Nakivo Customer = NOT True');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.1.1.5.2</div>
      ...
      <div class="info-row"><span class="label">State:</span> BLANK</div>
    </div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with India-State Blank, Nakivo Customer = NOT True<br>
