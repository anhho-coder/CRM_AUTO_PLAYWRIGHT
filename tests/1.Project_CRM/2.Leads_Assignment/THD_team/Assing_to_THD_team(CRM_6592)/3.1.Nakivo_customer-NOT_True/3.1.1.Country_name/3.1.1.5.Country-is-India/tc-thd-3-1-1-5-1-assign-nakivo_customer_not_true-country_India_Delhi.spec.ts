...
/**
 * Lead Assignment Test - THD Team - India with Delhi State and Nakivo Customer = NOT True
 * Test Case ID: TC.THD_3.1.1.5.1
 * 
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = India and State is in (Gujarat, Maharashtra, Delhi, Haryana, Goa, Uttar Pradesh)
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/2.Leads_Assignment/THD_team/Assing_to_THD_team(CRM_6592)/3.1.Nakivo_customer=NOT_True/3.1.1.5.Country=India/tc-thd-3-1-1-5-1-assign-nakivo_customer=not_true-country=India-state=Delhi.spec.ts" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.1.1.5.1 - THD Team Assignment for India with Delhi State and Nakivo Customer = NOT True', () => {
  ...
  test.skip('TC.THD_3.1.1.5.1: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = India and State = Delhi', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.1.1.5.1');
    ...
    await test.step('Step 7: Set Nakivo Customer checkbox to FALSE', async () => {
      ...
      console.log(`  - Nakivo Customer: ${navivoCustomerUnchecked ? 'Unchecked (FALSE)' : 'Already unchecked or field not found'}`);
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (India-Delhi with Nakivo Customer = NOT True)`);
      ...
      console.log('   Lead with India-Delhi, Nakivo Customer = NOT True');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.1.1.5.1</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with India-Delhi, Nakivo Customer = NOT True<br>
