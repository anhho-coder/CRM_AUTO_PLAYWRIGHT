...
/**
 * Lead Assignment Test - THD Team - Indonesia with Nakivo Customer = NOT True
 * Test Case ID: TC.THD_3.1.1.2
 * 
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = Indonesia
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/2.Leads_Assignment/THD_team/Assing_to_THD_team(CRM_6592)/3.1.Nakivo_customer=NOT_True/tc-thd-3-1-1-2-assign-nakivo_customer=not_true-country=Indonesia.spec.ts" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.1.1.2 - THD Team Assignment for Indonesia with Nakivo Customer = NOT True', () => {
  ...
  test.skip('TC.THD_3.1.1.2: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = Indonesia', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.1.1.2');
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Indonesia with Nakivo Customer = NOT True)`);
      ...
      console.log('   Lead with Indonesia, Nakivo Customer = NOT True');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.1.1.2</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Indonesia, Nakivo Customer = NOT True<br>
