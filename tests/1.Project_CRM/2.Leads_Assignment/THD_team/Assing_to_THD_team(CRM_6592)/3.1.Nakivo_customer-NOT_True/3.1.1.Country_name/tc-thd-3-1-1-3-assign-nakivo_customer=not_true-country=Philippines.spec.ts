...
/**
 * Lead Assignment Test - THD Team - Philippines with Nakivo Customer = NOT True
 * Test Case ID: TC.THD_3.1.1.3
 * 
 * Summary: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = Philippines
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/2.Leads_Assignment/THD_team/Assing_to_THD_team(CRM_6592)/3.1.Nakivo_customer=NOT_True/tc-thd-3-1-1-3-assign-nakivo_customer=not_true-country=Philippines.spec.ts" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.THD_3.1.1.3 - THD Team Assignment for Philippines with Nakivo Customer = NOT True', () => {
  ...
  test.skip('TC.THD_3.1.1.3: Verify the lead is assigned to THD team if Nakivo customer = NOT True and Country = Philippines', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.THD_3.1.1.3');
    ...
    await test.step('Verification: Confirm Sales Team is THD and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - THD Team Assignment (Philippines with Nakivo Customer = NOT True)`);
      ...
      console.log('   Lead with Philippines, Nakivo Customer = NOT True');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.THD_3.1.1.3</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Philippines, Nakivo Customer = NOT True<br>
