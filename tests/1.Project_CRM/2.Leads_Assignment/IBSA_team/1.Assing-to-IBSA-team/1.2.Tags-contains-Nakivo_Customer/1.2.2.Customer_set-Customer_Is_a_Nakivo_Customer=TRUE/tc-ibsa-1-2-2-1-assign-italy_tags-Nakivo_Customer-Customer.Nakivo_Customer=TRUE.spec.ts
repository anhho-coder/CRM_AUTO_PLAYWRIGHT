...
test.describe('TC.IBSA_1.2.2.1 - IBSA Team Assignment for Italy with Customer Is Nakivo Customer=TRUE and Lead Form=Nakivo Customer', () => {
  ...
  test('TC.IBSA_1.2.2.1: Verify the lead is assigned to IBSA team if Customer Is Nakivo Customer=TRUE, Country=Italy, Lead Form=Nakivo Customer', async ({ page }, testInfo) => {
