 ...
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/2.Leads_Assignment/Marketing_BDEU/2.2.Lead_Form-contain/tc-mbdeu-2-2-7-assign-france-lead-form_contains-white-paper.spec.ts" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.MBDEU_2.2.7 - Marketing BDEU Team Assignment for Afghanistan with Lead Form contains "white paper"', () => {
  ...
  test('TC.MBDEU_2.2.7: Verify the lead is assigned to Marketing - BDEU team if Lead Form="TEST white paper", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.MBDEU_2.2.7');
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.MBDEU_2.2.7', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.MBDEU_2.2.7</div>
