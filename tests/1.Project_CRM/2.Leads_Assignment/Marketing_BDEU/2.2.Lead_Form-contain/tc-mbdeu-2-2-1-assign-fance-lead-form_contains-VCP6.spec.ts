...
/**
 * Lead Assignment Test - Marketing BDEU Team - Romania with Lead Form contains "VCP6"
 * Test Case ID: TC.MBDEU_2.2.1
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to Marketing - BDEU team with Country = Romania if Lead Form contains "VCP6"
 * 
 * Command to run:
 * npx playwright test --grep "TC\.MBDEU_2\.2\.1 -" --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.MBDEU_2.2.1 - Marketing BDEU Team Assignment for Afghanistan with Lead Form contains "VCP6"', () => {
  ...
  test('TC.MBDEU_2.2.1: Verify the lead is assigned to Marketing - BDEU team if Lead Form="TEST VCP6", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.MBDEU_2.2.1');
    ...
    await test.step('Step 5: Fill Lead Form in CRM Developer tab', async () => {
      ...
      await leadPage.fillLeadForm('TEST VCP6');
      console.log(`  - Lead Form: TEST VCP6`);
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.MBDEU_2.2.1', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is Marketing - BDEU and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - Marketing BDEU Team Assignment (Afghanistan with Lead Form contains "VCP6")`);
      ...
      console.log('   Lead with Afghanistan, Lead Form contains "VCP6"');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.MBDEU_2.2.1</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Afghanistan, Lead Form contains "VCP6"<br>
