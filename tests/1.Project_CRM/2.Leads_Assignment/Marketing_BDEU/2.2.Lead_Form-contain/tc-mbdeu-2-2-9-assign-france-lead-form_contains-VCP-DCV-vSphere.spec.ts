...
/**
 * Lead Assignment Test - Marketing BDEU Team - Afghanistan with Lead Form contains "VCP-DCV vSphere"
 * Test Case ID: TC.MBDEU_2.2.9
 ...
 *    - "Lead form" textbox = VCP-DCV vSphere
 * 6. Press "SAVE" button
...
test.describe('TC.MBDEU_2.2.9 - Marketing BDEU Team Assignment for Afghanistan with Lead Form contains "VCP-DCV vSphere"', () => {
  ...
  test('TC.MBDEU_2.2.9: Verify the lead is assigned to Marketing - BDEU team if Lead Form="TEST VCP-DCV vSphere", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.MBDEU_2.2.9');
    ...
    await test.step('Step 5: Fill Lead Form in CRM Developer tab', async () => {
      ...
      await leadPage.fillLeadForm('TEST VCP-DCV vSphere');
      console.log(`  - Lead Form: TEST VCP-DCV vSphere`);
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.MBDEU_2.2.9', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is Marketing - BDEU and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - Marketing BDEU Team Assignment (Afghanistan with Lead Form contains "VCP-DCV vSphere")`);
      ...
      console.log('   Lead with Afghanistan, Lead Form contains "VCP-DCV vSphere"');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.MBDEU_2.2.9</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Afghanistan, Lead Form contains "VCP-DCV vSphere"<br>
