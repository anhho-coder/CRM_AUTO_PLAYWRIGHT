...
/**
 * Lead Assignment Test - Marketing BDEU Team - Afghanistan with Lead Form "2018 SMB Disaster Preparedness Guide*"
 * Test Case ID: TC.MBDEU_2.1.4
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to Marketing - BDEU team with Country = Afghanistan if Lead Form = "2018 SMB Disaster Preparedness Guide*"
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/2.Leads_Assignment/Marketing_BDEU/2.1.Lead_form-in/tc-mbdeu-2-1-4-assign-france-lead-form=SMB-Disaster.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 *    - "Lead form" textbox = 2018 SMB Disaster Preparedness Guide*
 * 6. Press "SAVE" button
...
test.describe('TC.MBDEU_2.1.4 - Marketing BDEU Team Assignment for Afghanistan with Lead Form "2018 SMB Disaster Preparedness Guide*"', () => {
  ...
  test('TC.MBDEU_2.1.4: Verify the lead is assigned to Marketing - BDEU team if Lead Form="2018 SMB Disaster Preparedness Guide*", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.MBDEU_2.1.4');
    ...
    await test.step('Step 5: Fill Lead Form in CRM Developer tab', async () => {
      ...
      await leadPage.fillLeadForm('2018 SMB Disaster Preparedness Guide*');
      console.log(`  - Lead Form: 2018 SMB Disaster Preparedness Guide*`);
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.MBDEU_2.1.4', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is Marketing - BDEU and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - Marketing BDEU Team Assignment (Afghanistan with Lead Form "2018 SMB Disaster Preparedness Guide*")`);
      ...
      console.log('   Lead with Afghanistan, Lead Form="2018 SMB Disaster Preparedness Guide*"');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.MBDEU_2.1.4</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Afghanistan, Lead Form="2018 SMB Disaster Preparedness Guide*"<br>
