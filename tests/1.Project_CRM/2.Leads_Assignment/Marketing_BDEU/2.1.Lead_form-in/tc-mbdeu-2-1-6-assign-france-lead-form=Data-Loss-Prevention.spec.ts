...
/**
 * Lead Assignment Test - Marketing BDEU Team - Afghanistan with Lead Form "Data Loss Prevention"
 * Test Case ID: TC.MBDEU_2.1.6
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to Marketing - BDEU team with Country = Afghanistan if Lead Form = "Data Loss Prevention"
 * 
 * Command to run:
 * npx playwright test --grep "TC\.MBDEU_2\.1\.6 -" --project=chromium
 * 
 * Pre-condition:
 ...
 *    - "Lead form" textbox = Data Loss Prevention
 * 6. Press "SAVE" button
...
test.describe('TC.MBDEU_2.1.6 - Marketing BDEU Team Assignment for Afghanistan with Lead Form "Data Loss Prevention"', () => {
  ...
  test('TC.MBDEU_2.1.6: Verify the lead is assigned to Marketing - BDEU team if Lead Form="Data Loss Prevention", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.MBDEU_2.1.6');
    ...
    await test.step('Step 5: Fill Lead Form in CRM Developer tab', async () => {
      ...
      await leadPage.fillLeadForm('Data Loss Prevention');
      console.log(`  - Lead Form: Data Loss Prevention`);
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.MBDEU_2.1.6', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is Marketing - BDEU and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - Marketing BDEU Team Assignment (Afghanistan with Lead Form "Data Loss Prevention")`);
      ...
      console.log('   Lead with Afghanistan, Lead Form="Data Loss Prevention"');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.MBDEU_2.1.6</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Afghanistan, Lead Form="Data Loss Prevention"<br>
