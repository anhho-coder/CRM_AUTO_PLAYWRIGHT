...
/**
 * Lead Assignment Test - Marketing BDEU Team - Afghanistan with Lead Form "Microsoft office 365 Backup Best Practices"
 * Test Case ID: TC.MBDEU_2.1.8
 * Automation-Type: refactored
 * Automation-Date: 2026-08-04
 *
 * Summary: Verify the lead is assigned to Marketing - BDEU team with Country = Afghanistan if Lead Form = "Microsoft office 365 Backup Best Practices"
 * 
 * Command to run:
 * npx playwright test "tests/1.Project_CRM/2.Leads_Assignment/Marketing_BDEU/2.1.Lead_form-in/tc-mbdeu-2-1-8-assign-france-lead-form=MS365-Backup-Best-Practices.spec.ts" --project=chromium
 * 
 * Pre-condition:
 ...
 *    - "Lead form" textbox = Microsoft office 365 Backup Best Practices
 * 6. Press "SAVE" button
...
test.describe('TC.MBDEU_2.1.8 - Marketing BDEU Team Assignment for Afghanistan with Lead Form "Microsoft office 365 Backup Best Practices"', () => {
  ...
  // FIXME: Test fails due to bug CRM-9305
  // The lead assignment logic for Lead Form "Microsoft office 365 Backup Best Practices" with Country=Afghanistan 
  // is not working as expected. Skipping this test until the bug is fixed.
  test('TC.MBDEU_2.1.8: Verify the lead is assigned to Marketing - BDEU team if Lead Form="Microsoft office 365 Backup Best Practices", Country=Afghanistan', async ({ page }, testInfo) => {
    ...
    await test.step('Step 4: Click CREATE button and fill lead information', async () => {
      ...
      leadName = CommonUtils.generateLeadNameWithTestCase('TC.MBDEU_2.1.8');
    ...
    await test.step('Step 5: Fill Lead Form in CRM Developer tab', async () => {
      ...
      await leadPage.fillLeadForm('Microsoft office 365 Backup Best Practices');
      console.log(`  - Lead Form: Microsoft office 365 Backup Best Practices`);
    ...
    // Declare flags for deferred verification
    ...
    if (!salesTeamAssigned || !salespersonAssigned) {
      test.skip(true, assignmentDeferSkipReason('TC.MBDEU_2.1.8', !salesTeamAssigned ? 'Sales Team' : 'Salesperson'));
    }
    ...
    await test.step('Verification: Confirm Sales Team is Marketing - BDEU and Salesperson is assigned', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, `Lead ${leadId} - Marketing BDEU Team Assignment (Afghanistan with Lead Form "Microsoft office 365 Backup Best Practices")`);
      ...
      console.log('   Lead with Afghanistan, Lead Form="Microsoft office 365 Backup Best Practices"');
...
<body>
  <div class="container">
    ...
    <div class="info-section">
      <div class="info-row"><span class="label">Test Case:</span> TC.MBDEU_2.1.8</div>
    ...
    <div class="summary">
      ...
      <div class="summary-text">
        ...
        Lead with Afghanistan, Lead Form="Microsoft office 365 Backup Best Practices"<br>
