 ...
 * 
 * Command to run:
 * npx playwright test tests/Leads_Assignment/BDR_team/1.1.Country_Group/tc-bdr-1-1-1-2-sales-team-bdr-partner-sign-up.spec.ts --project=chromium
 * 
 * Pre-condition:
...
test.describe('TC.BDR.1.1.1.2 - BDR Team Assignment for Partner Sign up Lead Form', () => {
  ...
  test('TC.BDR.1.1.1.2: Verify the lead is assigned to BDR team if Lead form = Partner Sign up', async ({ page }, testInfo) => {
