 ...
 * ===========================================================================
 *  Test Case ID    : Exchange-rate_1.7.1
 *  Automation-Type : new
 ...
 *
 *  Command to run:
 *    npx playwright test --grep "Exchange-rate_1\.7\.1:" --project=chromium
 *
 * ---------------------------------------------------------------------------
...
describeBlock('Exchange-rate_1.7.1 - US7: change the source and the frequency', () => {
  ...
  test('Exchange-rate_1.7.1: US7 - An administrator can change the rate source and the update frequency without any development work', async ({ page }, testInfo) => {
