...
/**
 * Visibility: "Mass Mark as Duplicate" IS visible for the sales director in the All leads list.
 * Test Case ID: CRM-10601_3.2.1.3   (Jira: CRM-10771 - Post-EA Test Case)
 * Automation-Type: new
 * Automation-Date: 2026-06-18
 *
 * Command to run:
 *   npx playwright test --grep "CRM-10601_3\.2\.1\.3:" --project=chromium
 *
 * Source manual TC (Jira CRM-10771)
...
test.describe('CRM-10601_3.2.1.3 - "Mass Mark as Duplicate" visible for sales director in All lead list', () => {
  ...
  test('CRM-10601_3.2.1.3: "Mass Mark as Duplicate" visible for sales director in All lead list', async ({ page }, testInfo) => {
    ...
    await test.step('Step 3: Select 1 lead and click Action dropdown', async () => {
      ...
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, 'CRM-10771 - All-leads Action menu (sales director)');
