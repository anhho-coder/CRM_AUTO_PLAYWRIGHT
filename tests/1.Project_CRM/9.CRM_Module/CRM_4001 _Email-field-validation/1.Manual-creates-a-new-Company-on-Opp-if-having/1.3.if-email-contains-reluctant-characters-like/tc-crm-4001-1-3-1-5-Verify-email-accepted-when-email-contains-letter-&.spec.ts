...
test.describe('CRM-4001_1.3.1.5 - Verify a valid email containing "&" is accepted on Opp', () => {
  ...
  test('CRM-4001_1.3.1.5: Verify a valid email containing "&" is accepted on Opp', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
