...
test.describe('CRM-4001_3.3.1.14 - Verify Error message appears when email contains "_" letter on Opp', () => {
  ...
  test.skip('CRM-4001_3.3.1.14: Verify Error message appears when email contains "_" letter on Opp @CRM-10450', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
