...
test.describe('CRM-4001_2.3.1.15 - Verify a valid email containing "=" is accepted on Lead', () => {
  ...
  test('CRM-4001_2.3.1.15: Verify a valid email containing "=" is accepted on Lead', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
