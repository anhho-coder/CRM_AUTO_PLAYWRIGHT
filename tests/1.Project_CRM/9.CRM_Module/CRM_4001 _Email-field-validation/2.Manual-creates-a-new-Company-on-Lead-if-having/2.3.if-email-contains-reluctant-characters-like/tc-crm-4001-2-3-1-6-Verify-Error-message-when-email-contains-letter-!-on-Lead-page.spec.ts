...
test.describe('CRM-4001_2.3.1.6 - Verify Error message appears when email contains "!" letter on Lead', () => {
  ...
  test.skip('CRM-4001_2.3.1.6: Verify Error message appears when email contains "!" letter on Lead @CRM-10450', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
