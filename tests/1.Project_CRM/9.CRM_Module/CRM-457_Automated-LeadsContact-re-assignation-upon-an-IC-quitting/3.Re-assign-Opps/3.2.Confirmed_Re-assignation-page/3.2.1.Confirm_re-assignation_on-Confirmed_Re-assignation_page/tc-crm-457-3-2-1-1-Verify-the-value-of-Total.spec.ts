 ...
 * Test Case ID: CRM-457_3.2.1.1
 *
 * Summary: Verify value at "Total" text = 1/1 after confirming the re-assignation
 *
 * Command to run:
 * npx playwright test --grep CRM-457_3\.2\.1\.1: --project=chromium
 *
 ...
 *    - Opp name textbox        = TEST Opp 1 CRM-457_3.2.1.1
...
test.describe('CRM-457_3.2.1.1 - Verify value at "Total" text = 1/1 after confirming the re-assignation', () => {
  ...
  test('CRM-457_3.2.1.1: Verify value at "Total" text = 1/1 after confirming the re-assignation', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n\u2705 TEST PASSED: CRM-457_3.2.1.1 verification completed successfully');
      console.log(`   Opp#1 URL    : ${url_Opp1}`);
      console.log('   III.1: Total = "1/1" - qualified Opp with Stage=New correctly re-assigned after CONFIRM');
