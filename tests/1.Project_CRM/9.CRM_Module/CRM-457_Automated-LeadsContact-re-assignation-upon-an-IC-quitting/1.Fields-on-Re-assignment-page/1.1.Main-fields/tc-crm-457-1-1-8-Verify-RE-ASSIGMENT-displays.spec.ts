 ...
 * Test Case ID: CRM-457_1.1.8
 *
 * Summary: Verify "RE-ASSIGMENT" button display on "Re-assignment" page
 *
 * Command to run:
 * npx playwright test --grep "CRM-457_1\.1\.8:" --project=chromium
 *
 * I. Pre-condition:
 ...
 * 1. The "RE-ASSIGMENT" button displays
 */

test.describe('CRM-457_1.1.8 - Verify RE-ASSIGMENT button displays on Re-assignment page', () => {
  ...
  test('CRM-457_1.1.8: Verify "RE-ASSIGMENT" button displays on Re-assignment page', async ({ page }, testInfo) => {
    ...
    await test.step('II. Verification - Step 1: Verify "RE-ASSIGMENT" button displays', async () => {
      console.log('\n=== II. VERIFICATION POINTS ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-457_1.1.8 verification completed successfully');
      console.log('   II.1: "RE-ASSIGMENT" button is displayed on Re-assignment page');
      console.log('==================================================\n');
    });
  });
});
