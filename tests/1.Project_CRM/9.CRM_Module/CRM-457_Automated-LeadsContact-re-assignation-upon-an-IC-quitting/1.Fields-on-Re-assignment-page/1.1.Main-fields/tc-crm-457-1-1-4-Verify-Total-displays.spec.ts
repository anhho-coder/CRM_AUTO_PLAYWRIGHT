 ...
 * Test Case ID: CRM-457_1.1.4
 *
 * Summary: Verify "Total" text display on "Re-assignment" page
 *
 * Command to run:
 * npx playwright test --grep "CRM-457_1\.1\.4:" --project=chromium
 *
 * I. Pre-condition:
 ...
 * 1. The "Total" text displays
 */

test.describe('CRM-457_1.1.4 - Verify Total text displays on Re-assignment page', () => {
  ...
  test('CRM-457_1.1.4: Verify "Total" text displays on Re-assignment page', async ({ page }, testInfo) => {
    ...
    await test.step('II. Verification - Step 1: Verify "Total" text displays', async () => {
      console.log('\n=== II. VERIFICATION POINTS ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-457_1.1.4 verification completed successfully');
      console.log('   II.1: "Total" text is displayed on Re-assignment page');
      console.log('==================================================\n');
    });
  });
});
