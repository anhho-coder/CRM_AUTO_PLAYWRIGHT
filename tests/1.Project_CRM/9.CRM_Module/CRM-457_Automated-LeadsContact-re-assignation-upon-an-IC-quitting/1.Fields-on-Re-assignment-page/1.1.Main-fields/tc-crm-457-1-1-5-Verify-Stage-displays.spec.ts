 ...
 * Test Case ID: CRM-457_1.1.5
 *
 * Summary: Verify "Stage" combobox display on "Re-assignment" page
 *
 * Command to run:
 * npx playwright test --grep "CRM-457_1\.1\.5:" --project=chromium
 *
 * I. Pre-condition:
 ...
 * 1. The "Stage" combobox displays
 */

test.describe('CRM-457_1.1.5 - Verify Stage combobox displays on Re-assignment page', () => {
  ...
  test('CRM-457_1.1.5: Verify "Stage" combobox displays on Re-assignment page', async ({ page }, testInfo) => {
    ...
    await test.step('Pre-condition Step 5: Set "Customer type" = "Leads/Opportunities"', async () => {
      console.log('Step 5: Setting Customer type to Leads/Opportunities');
      ...
      console.log('✓ Customer type set to "Leads/Opportunities"');
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, 'Pre-condition Step 5 - Customer type set');
    });

    // II. VERIFICATION POINTS

    await test.step('II. Verification - Step 1: Verify "Stage" combobox displays', async () => {
      console.log('\n=== II. VERIFICATION POINTS ===');
      await reAssignationPage.waitForLoadingSpinnerToHide(config.timeouts.loadingSpinner);
      await page.waitForTimeout(CommonUtils.waitTimes.standard);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-457_1.1.5 verification completed successfully');
      console.log('   II.1: "Stage" combobox is displayed on Re-assignment page');
      console.log('==================================================\n');
    });
  });
});
