...
test.describe('CRM-457_2.1.10 - Verify qualified Leads with Stage=Interested transfered to another Salesperson', () => {
  ...
  test('CRM-457_2.1.10: Verify the qualified Leads with Stage=Interested have been transfered to another Salesperson correctly', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-457_2.1.10 verification completed successfully');
