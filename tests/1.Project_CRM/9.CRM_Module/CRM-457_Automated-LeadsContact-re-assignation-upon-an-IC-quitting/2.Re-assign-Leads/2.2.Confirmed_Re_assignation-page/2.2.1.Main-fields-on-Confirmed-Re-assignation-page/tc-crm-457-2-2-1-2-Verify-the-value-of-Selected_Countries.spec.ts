 ...
 * Test Case ID: CRM-457_2.2.1.2
 *
 * Summary: Verify value of "Selected Countries" = value of "Countries" on "Confirmed Re-assignation" page correctly
 *
 * Command to run:
 * npx playwright test --grep CRM-457_2\.2\.1\.2: --project=chromium
 *
 ...
 *    - Lead name textbox        = TEST Lead 1 CRM-457_2.2.1.2
...
test.describe('CRM-457_2.2.1.2 - Verify Selected Countries = Countries on Confirmed Re-assignation page', () => {
  ...
  test('CRM-457_2.2.1.2: Verify value of "Selected Countries" = value of "Countries" on "Confirmed Re-assignation" page correctly', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('III. Verification - Step 1: Verify "Selected Countries" = selected_country#1', async () => {
      console.log('\n=== III. VERIFICATION POINTS ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-457_2.2.1.2 verification completed successfully');
      console.log(`   Lead#1 URL           : ${url_Lead1}`);
      console.log(`   selected_country#1   : ${selectedCountry1}`);
      console.log(`   III.1: "Selected Countries" = "${selectedCountry1}" - verified on Confirmed Re-assignation page`);
