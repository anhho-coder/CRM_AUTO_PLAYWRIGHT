 ...
 * Test Case ID: CRM-457_4.1.1.1
 *
 * Summary: Verify the qualified Contacts with selecting 1 Country have been transfered to another Salesperson correctly
 *
 * Command to run:
 * npx playwright test --grep "CRM-457_4\.1\.1\.1:" --project=chromium
 *
...
test.describe('CRM-457_4.1.1.1 - Verify qualified Contacts with 1 Country transfered to another Salesperson', () => {
  ...
  test('CRM-457_4.1.1.1: Verify the qualified Contacts with 1 Country have been transfered to another Salesperson correctly', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-457_4.1.1.1 verification completed successfully');
