 ...
 * Test Case ID: CRM-457_5.1.1.1
 *
 * Summary: Verify value at "Total" text = 6/6 after confirming the re-assignation
 *
 * Command to run:
 * npx playwright test --grep "CRM-457_5\.1\.1\.1:" --project=chromium
 *
 ...
 *    - Lead name textbox       = TEST Lead 1 CRM-457_5.1.1.1
 ...
 * 2. Enter the following information:
 *    - Opp name textbox        = TEST Opp 1 CRM-457_5.1.1.1
 ...
 *    - Contact name textbox    = TEST-Contact#1_CRM-457_5.1.1.1_<timestamp>
...
test.describe('CRM-457_5.1.1.1 - Verify value at "Total" text = 6/6 after confirming the re-assignation', () => {
  ...
  test('CRM-457_5.1.1.1: Verify value at "Total" text = 6/6 after confirming the re-assignation', async ({ page }, testInfo) => {
    ...
    await test.step('VII. Verification - Step 1: Verify Total text = "6/6"', async () => {
      console.log('\n=== VII. VERIFICATION POINTS ===');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n\u2705 TEST PASSED: CRM-457_5.1.1.1 verification completed successfully');
      console.log(`   Lead#1 URL    : ${url_Lead1}`);
      console.log(`   Opp#1 URL     : ${url_Opp1}`);
      console.log(`   Contact#1 URL : ${url_Contact1}`);
      console.log('   VII.1: Total = "6/6" - all 3 records correctly counted for re-assignment');
