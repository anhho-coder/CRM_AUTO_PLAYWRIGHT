 ...
 * Test Case ID: CRM-2338_1.2.3.2
 *
 * Summary: Verify that the user is able to delete the deal item at middle of list
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_1\.2\.3\.2:" --project=chromium
 *
...
test.describe('CRM-2338_1.2.3.2 - Verify that the user is able to delete the deal item at middle of list', () => {
  ...
  test('CRM-2338_1.2.3.2: Verify that the user is able to delete the deal item at middle of list', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n\u2705 TEST PASSED: CRM-2338_1.2.3.2 verification completed successfully');
      console.log(`   EndUser#1     : "${name_EndUser1}"`);
      console.log(`   URL_Opp#1     : ${url_Opp1}`);
      console.log(`   VII.6: Product line "${product_line2}" deleted via Trash Bin icon`);
