 ...
 * Test Case ID: CRM-2338_1.1.3
 *
 * Summary: Verify the Deal Element.Reseller getting from Opp.Reseller
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_1\.1\.3:" --project=chromium
 *
 ...
 *
 * VIII. Verification:
 * 1. Reseller field value = Name_Reseller#1
 *
 * IX. Tear down:
...
test.describe('CRM-2338_1.1.3 - Verify the Deal Element.Reseller getting from Opp.Reseller', () => {
  ...
  test('CRM-2338_1.1.3: Verify the Deal Element.Reseller getting from Opp.Reseller', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('VIII. Verification - Step 1: Verify Reseller = Name_Reseller#1', async () => {
      console.log(`\n=== VIII. VERIFICATION POINTS ===`);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n\u2705 TEST PASSED: CRM-2338_1.1.3 verification completed successfully');
      console.log(`   Distributor#1     : "${name_Distributor1}"`);
      console.log(`   Reseller#1        : "${name_Reseller1}"`);
      console.log(`   EndUser#1         : "${name_EndUser1}"`);
      console.log(`   URL_Opp#1         : ${url_Opp1}`);
      console.log('   VIII.1: Deal Element.Reseller = Name_Reseller#1 (from Opp.Reseller)');
