 ...
 * Test Case ID: CRM-2338_1.1.4.1
 *
 * Summary: Verify the Deal Element.Payer getting from Opp.Distributor or Opp.Reseller
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_1\.1\.4\.1:" --project=chromium
 *
...
test.describe('CRM-2338_1.1.4.1 - Verify the Deal Element.Payer getting from Opp.Distributor or Opp.Reseller', () => {
  ...
  test('CRM-2338_1.1.4.1: Verify the Deal Element.Payer getting from Opp.Distributor or Opp.Reseller', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n\u2705 TEST PASSED: CRM-2338_1.1.4.1 verification completed successfully');
