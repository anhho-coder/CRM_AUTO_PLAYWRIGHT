 ...
 * Test Case ID: CRM-2338_1.1.6.4
 *
 * Summary: Verify the Deal Element.Delivery Address is a required field
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_1\.1\.6\.4:" --project=chromium
 *
 ...
 * 2. Set Delivery Address field = [BLANK]
 * 3. Set Payment Terms = Immediate Payment
 * 4. Press SAVE button
 *
 * VIII. Verification:
 * 1. Error message: "The following fields are invalid: Delivery Address"
 *
 * IX. Tear down:
...
test.describe('CRM-2338_1.1.6.4 - Verify the Deal Element.Delivery Address is a required field', () => {
  ...
  test('CRM-2338_1.1.6.4: Verify the Deal Element.Delivery Address is a required field', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Step VII.2: Set Delivery Address field = [BLANK]', async () => {
      console.log('Step VII.2: Clearing Delivery Address field');
      await dealElementPage.clearDeliveryAddressField();
      console.log('\u2713 Delivery Address field cleared (set to blank)');
      await CommonUtils.captureAndAttachScreenshot(page, testInfo, 'VII.2 - Delivery Address cleared');
    });
    ...
    await test.step('VIII.1: Verify error message "The following fields are invalid: Delivery Address"', async () => {
      console.log(`\n=== VIII. VERIFICATION POINTS ===`);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n\u2705 TEST PASSED: CRM-2338_1.1.6.4 verification completed successfully');
      console.log(`   EndUser#1         : "${name_EndUser1}"`);
      console.log(`   URL_Opp#1         : ${url_Opp1}`);
      console.log('   VIII.1: Error message "The following fields are invalid: Delivery Address" confirmed');
