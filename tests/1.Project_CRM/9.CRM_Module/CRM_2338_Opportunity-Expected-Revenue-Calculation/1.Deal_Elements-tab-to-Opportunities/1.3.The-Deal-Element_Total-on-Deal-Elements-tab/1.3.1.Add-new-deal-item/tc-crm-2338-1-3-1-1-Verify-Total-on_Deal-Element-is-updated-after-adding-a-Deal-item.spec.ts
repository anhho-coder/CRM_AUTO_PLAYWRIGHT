 ...
 * Test Case ID: CRM-2338_1.3.1.1
 *
 * Summary: Verify the Deal Element.Total is updated automatically after adding Deal Items
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_1\.3\.1\.1:" --project=chromium
 *
 ...
 * 6. Sum Sub Totals on every Order Line = Sum_Sub_Totals
 *
 * VIII. Verification:
 * 1. The Total number at bottom of "Order Lines" tab = Sum_Sub_Totals
 *
 * IX. Tear down:
...
test.describe('CRM-2338_1.3.1.1 - Verify the Deal Element Total is updated automatically after adding Deal Items', () => {
  ...
  test('CRM-2338_1.3.1.1: Verify the Deal Element Total is updated automatically after adding Deal Items', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Step VII.6: Press SAVE and sum Sub Totals = Sum_Sub_Totals', async () => {
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-2338_1.3.1.1 verification completed successfully');
