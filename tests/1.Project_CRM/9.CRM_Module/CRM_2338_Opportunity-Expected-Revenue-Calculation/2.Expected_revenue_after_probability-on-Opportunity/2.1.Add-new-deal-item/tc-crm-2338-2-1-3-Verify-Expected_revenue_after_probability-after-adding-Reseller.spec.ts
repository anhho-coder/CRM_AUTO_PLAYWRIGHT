 ...
 * Test Case ID: CRM-2338_2.1.3
 *
 * Summary: Verify the "Expected revenue after probability" on Opportunity is re-calculating correctly
 *          after updating Reseller
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_2\.1\.3:" --project=chromium
 *
...
test.describe('CRM-2338_2.1.3 - Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Reseller', () => {
  ...
  test('CRM-2338_2.1.3: Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Reseller', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-2338_2.1.3 verification completed successfully');
