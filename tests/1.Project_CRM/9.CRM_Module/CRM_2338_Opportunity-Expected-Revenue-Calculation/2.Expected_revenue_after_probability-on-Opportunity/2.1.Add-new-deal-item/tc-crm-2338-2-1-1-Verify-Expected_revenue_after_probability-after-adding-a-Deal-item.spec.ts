 ...
 * Test Case ID: CRM-2338_2.1.1
 *
 * Summary: Verify the "Expected revenue after probability" on Opportunity is re-calculating correctly
 *          after updating Deal Items
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_2\.1\.1:" --project=chromium
 *
...
test.describe('CRM-2338_2.1.1 - Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Deal Items', () => {
  ...
  test('CRM-2338_2.1.1: Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Deal Items', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-2338_2.1.1 verification completed successfully');
