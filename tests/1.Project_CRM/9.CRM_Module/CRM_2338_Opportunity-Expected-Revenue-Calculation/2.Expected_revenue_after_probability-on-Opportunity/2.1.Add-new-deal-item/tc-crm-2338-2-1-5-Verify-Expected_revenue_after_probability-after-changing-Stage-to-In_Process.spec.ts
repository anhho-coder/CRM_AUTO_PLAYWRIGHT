 ...
 * Test Case ID: CRM-2338_2.1.5
 *
 * Summary: Verify the "Expected revenue after probability" on Opportunity is re-calculating correctly
 *          after updating Opp.Stage from New to In Process
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_2\.1\.5:" --project=chromium
 *
 ...
 * VI. Pre-condition#4 - Create Opp#1 (NO Reseller, NO Distributor, Stage = In Process):
 *     - VI.4: On Stage, select Stage = In Process
 *
...
test.describe('CRM-2338_2.1.5 - Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Opp.Stage from New to In Process', () => {
  ...
  test('CRM-2338_2.1.5: Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Opp.Stage from New to In Process', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Pre-condition VI.5: Select Stage = In Process', async () => {
      console.log('Step VI.5: Selecting Stage = In Process');
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-2338_2.1.5 verification completed successfully');
