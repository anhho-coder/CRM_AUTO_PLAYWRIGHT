 ...
 * Test Case ID: CRM-2338_2.1.2
 *
 * Summary: Verify the "Expected revenue after probability" on Opportunity is re-calculating correctly
 *          after updating Distributor
 *
 * Command to run:
 * npx playwright test --grep "CRM-2338_2\.1\.2:" --project=chromium
 *
...
test.describe('CRM-2338_2.1.2 - Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Distributor', () => {
  ...
  test('CRM-2338_2.1.2: Verify the Expected revenue after probability on Opportunity is re-calculating correctly after updating Distributor', async ({ page }, testInfo) => {
    test.setTimeout(config.timeouts.test);
    ...
    await test.step('Final Summary', async () => {
      console.log('\n✅ TEST PASSED: CRM-2338_2.1.2 verification completed successfully');
