...
/**
 * ============================================================================================
 *  pre-sale-7.1.1.1 - Salesperson requests SE support with Support type = Online deployment session
 * --------------------------------------------------------------------------------------------
 *  Test Case ID:    pre-sale-7.1.1.1
 *  Jira:            (none - authored from an inline manual TC)
 *  Automation-Type: refactored
 *  Automation-Date: 2026-07-28
 * --------------------------------------------------------------------------------------------
 *  Summary:
 *    Verify the Salesperson can select Support type = Online deployment session when requesting SE support.
 *
 *  Command to run:
 *    npx playwright test --grep "pre-sale-7\.1\.1\.1:" --project=chromium
 * ============================================================================================
 *
...
const TC_ID = 'pre-sale-7.1.1.1';
const SUPPORT_TYPE = 'Online deployment session';

test.describe('pre-sale-7.1.1.1 - Salesperson requests SE support (Support type = Online deployment session)', () => {
  ...
  test('pre-sale-7.1.1.1: Verify the Salesperson can select Support type = Online deployment session', async ({ page }, testInfo) => {
