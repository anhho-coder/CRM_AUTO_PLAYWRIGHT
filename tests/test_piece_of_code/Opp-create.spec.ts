...
test.describe('Verify-Merge-Log-message-Target-Opportunity', () => {
  ...
  test('Verify that log area contains merge message for Opportunity #740449', async ({ page }, testInfo) => {
    ...
    const OpportunityId = '740449';
    const OpportunityUrl = 'http://pre-production.nakivo.site/web?#id=979220&action=152&model=crm.Opportunity&view_type=form&menu_id=111';
