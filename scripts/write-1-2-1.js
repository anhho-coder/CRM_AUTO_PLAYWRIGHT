const fs = require('fs');
const dest = 'D:\\II. Automation\\CRM_AUTO\\tests\\1.Project_CRM\\9.CRM_Module\\CRM_2338_Opportunity-Expected-Revenue-Calculation\\1.Deal_Elements-tab-to-Opportunities\\1.2.Deal-items-on-Deal_Elements-tab\\tc-crm-2338-1-2-1-Verify-user-is-able-to-add-new-deal-item.spec.ts';
...
const lines = [
  ...
  ` * 4. Add product [A2145B] via "Add a product" link`,
  ` * 5. Press SAVE button`,
  ` *`,
  ` * VIII. Verification:`,
  ...
  `    });`,
  ``,
  `    await test.step('Step VII.3a: Add product [A2144B]', async () => {`,
  `      console.log('Step VII.3a: Adding product [A2144B]');`,
  ...
  `    });`,
  ``,
  `    await test.step('Step VII.3b: Add product [A2145B]', async () => {`,
  `      console.log('Step VII.3b: Adding product [A2145B]');`,
